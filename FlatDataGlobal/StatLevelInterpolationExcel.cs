...
public struct StatLevelInterpolationExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.StatLevelInterpolationExcel> CreateStatLevelInterpolationExcel(FlatBufferBuilder builder,
      long Level = 0,
  ...
  public static Offset<FlatDataGlobal.StatLevelInterpolationExcel> EndStatLevelInterpolationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.StatLevelInterpolationExcel>(o);
  }
}
