...
public struct ConquestUnexpectedEventExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.ParcelType UnexpectedEventConditionType { get { int o = __p.__offset(6); return o != 0 ? (FlatDataGlobal.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ParcelType.None; } }
  ...
  public static void AddUnexpectedEventConditionType(FlatBufferBuilder builder, FlatDataGlobal.ParcelType UnexpectedEventConditionType) { builder.AddInt(1, (int)UnexpectedEventConditionType, 0); }
