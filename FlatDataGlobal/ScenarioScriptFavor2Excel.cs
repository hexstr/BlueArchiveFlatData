...
public struct ScenarioScriptFavor2Excel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptFavor2Excel> CreateScenarioScriptFavor2Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptFavor2Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptFavor2Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptFavor2Excel.AddTextTh(builder, TextThOffset);
    ...
    ScenarioScriptFavor2Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptFavor2Excel.EndScenarioScriptFavor2Excel(builder);
  }

  public static void StartScenarioScriptFavor2Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptFavor2Excel> EndScenarioScriptFavor2Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptFavor2Excel>(o);
  }
}
