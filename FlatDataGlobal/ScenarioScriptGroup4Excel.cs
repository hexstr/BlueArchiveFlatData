...
public struct ScenarioScriptGroup4Excel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_3_3(); }
  public static ScenarioScriptGroup4Excel GetRootAsScenarioScriptGroup4Excel(ByteBuffer _bb) { return GetRootAsScenarioScriptGroup4Excel(_bb, new ScenarioScriptGroup4Excel()); }
  public static ScenarioScriptGroup4Excel GetRootAsScenarioScriptGroup4Excel(ByteBuffer _bb, ScenarioScriptGroup4Excel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ScenarioScriptGroup4Excel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptGroup4Excel> CreateScenarioScriptGroup4Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptGroup4Excel.AddBGMId(builder, BGMId);
    ScenarioScriptGroup4Excel.AddSelectionGroup(builder, SelectionGroup);
    ScenarioScriptGroup4Excel.AddGroupId(builder, GroupId);
    ScenarioScriptGroup4Excel.AddVoiceJp(builder, VoiceJpOffset);
    ScenarioScriptGroup4Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptGroup4Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptGroup4Excel.AddTextTh(builder, TextThOffset);
    ScenarioScriptGroup4Excel.AddTextJp(builder, TextJpOffset);
    ScenarioScriptGroup4Excel.AddScriptKr(builder, ScriptKrOffset);
    ScenarioScriptGroup4Excel.AddPopupFileName(builder, PopupFileNameOffset);
    ScenarioScriptGroup4Excel.AddBGEffect(builder, BGEffect);
    ScenarioScriptGroup4Excel.AddBGName(builder, BGName);
    ScenarioScriptGroup4Excel.AddTransition(builder, Transition);
    ScenarioScriptGroup4Excel.AddSound(builder, SoundOffset);
    ScenarioScriptGroup4Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptGroup4Excel.EndScenarioScriptGroup4Excel(builder);
  }

  public static void StartScenarioScriptGroup4Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptGroup4Excel> EndScenarioScriptGroup4Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptGroup4Excel>(o);
  }
}
