...
public struct TutorialExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.TutorialExcel> CreateTutorialExcel(FlatBufferBuilder builder,
      long ID = 0,
  ...
  public static Offset<FlatDataGlobal.TutorialExcel> EndTutorialExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.TutorialExcel>(o);
  }
}
