...
public struct FurnitureGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.FurnitureGroupExcel> CreateFurnitureGroupExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataGlobal.FurnitureGroupExcel> EndFurnitureGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.FurnitureGroupExcel>(o);
  }
}
