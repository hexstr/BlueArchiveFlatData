...
public struct FieldMasteryLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.FieldMasteryLevelExcel> CreateFieldMasteryLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
  ...
  public static Offset<FlatDataGlobal.FieldMasteryLevelExcel> EndFieldMasteryLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.FieldMasteryLevelExcel>(o);
  }
}
