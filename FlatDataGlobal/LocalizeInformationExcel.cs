...
public struct LocalizeInformationExcel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_3_3(); }
  public static LocalizeInformationExcel GetRootAsLocalizeInformationExcel(ByteBuffer _bb) { return GetRootAsLocalizeInformationExcel(_bb, new LocalizeInformationExcel()); }
  public static LocalizeInformationExcel GetRootAsLocalizeInformationExcel(ByteBuffer _bb, LocalizeInformationExcel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public LocalizeInformationExcel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.LocalizeInformationExcel> CreateLocalizeInformationExcel(FlatBufferBuilder builder,
      uint Key = 0,
    ...
    LocalizeInformationExcel.AddEn(builder, EnOffset);
    LocalizeInformationExcel.AddTw(builder, TwOffset);
    LocalizeInformationExcel.AddTh(builder, ThOffset);
    LocalizeInformationExcel.AddJp(builder, JpOffset);
    LocalizeInformationExcel.AddKr(builder, KrOffset);
    LocalizeInformationExcel.AddKey(builder, Key);
    return LocalizeInformationExcel.EndLocalizeInformationExcel(builder);
  }

  public static void StartLocalizeInformationExcel(FlatBufferBuilder builder) { builder.StartTable(6); }
  ...
  public static Offset<FlatDataGlobal.LocalizeInformationExcel> EndLocalizeInformationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.LocalizeInformationExcel>(o);
  }
}
