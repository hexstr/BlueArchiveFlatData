...
public struct ConstConquestExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.ConstConquestExcel> CreateConstConquestExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataGlobal.ConstConquestExcel> EndConstConquestExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ConstConquestExcel>(o);
  }
}
