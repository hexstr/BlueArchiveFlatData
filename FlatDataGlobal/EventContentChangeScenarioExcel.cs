...
public struct EventContentChangeScenarioExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.EventChangeType ChangeType { get { int o = __p.__offset(6); return o != 0 ? (FlatDataGlobal.EventChangeType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.EventChangeType.MainSub; } }
  ...
  public static Offset<FlatDataGlobal.EventContentChangeScenarioExcel> CreateEventContentChangeScenarioExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      FlatDataGlobal.EventChangeType ChangeType = FlatDataGlobal.EventChangeType.MainSub,
      long ChangeCount = 0,
  ...
  public static void AddChangeType(FlatBufferBuilder builder, FlatDataGlobal.EventChangeType ChangeType) { builder.AddInt(1, (int)ChangeType, 0); }
  ...
  public static Offset<FlatDataGlobal.EventContentChangeScenarioExcel> EndEventContentChangeScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.EventContentChangeScenarioExcel>(o);
  }
}
