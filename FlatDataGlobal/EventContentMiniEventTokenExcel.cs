...
public struct EventContentMiniEventTokenExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.EventContentMiniEventTokenExcel> CreateEventContentMiniEventTokenExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataGlobal.EventContentMiniEventTokenExcel> EndEventContentMiniEventTokenExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.EventContentMiniEventTokenExcel>(o);
  }
}
