...
public struct AcademyLocationExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.School OpenCondition(int j) { int o = __p.__offset(12); return o != 0 ? (FlatDataGlobal.School)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataGlobal.School)0; }
  public int OpenConditionLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataGlobal.School> GetOpenConditionBytes() { return __p.__vector_as_span<FlatDataGlobal.School>(12, 4); }
#else
  public ArraySegment<byte>? GetOpenConditionBytes() { return __p.__vector_as_arraysegment(12); }
#endif
  public FlatDataGlobal.School[] GetOpenConditionArray() { int o = __p.__offset(12); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataGlobal.School[] a = new FlatDataGlobal.School[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataGlobal.School)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public FlatDataGlobal.ParcelType RewardParcelType { get { int o = __p.__offset(16); return o != 0 ? (FlatDataGlobal.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ParcelType.None; } }
  ...
  public static Offset<FlatDataGlobal.AcademyLocationExcel> CreateAcademyLocationExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static VectorOffset CreateOpenConditionVector(FlatBufferBuilder builder, FlatDataGlobal.School[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateOpenConditionVectorBlock(FlatBufferBuilder builder, FlatDataGlobal.School[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateOpenConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatDataGlobal.School> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateOpenConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatDataGlobal.School>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddRewardParcelType(FlatBufferBuilder builder, FlatDataGlobal.ParcelType RewardParcelType) { builder.AddInt(6, (int)RewardParcelType, 0); }
  ...
  public static Offset<FlatDataGlobal.AcademyLocationExcel> EndAcademyLocationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.AcademyLocationExcel>(o);
  }
}
