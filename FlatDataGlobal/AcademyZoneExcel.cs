...
public struct AcademyZoneExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.Tag Tags(int j) { int o = __p.__offset(16); return o != 0 ? (FlatDataGlobal.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataGlobal.Tag)0; }
  public int TagsLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataGlobal.Tag> GetTagsBytes() { return __p.__vector_as_span<FlatDataGlobal.Tag>(16, 4); }
#else
  public ArraySegment<byte>? GetTagsBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public FlatDataGlobal.Tag[] GetTagsArray() { int o = __p.__offset(16); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataGlobal.Tag[] a = new FlatDataGlobal.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataGlobal.Tag)__p.bb.GetInt(p + i * 4); } return a; }

  public static Offset<FlatDataGlobal.AcademyZoneExcel> CreateAcademyZoneExcel(FlatBufferBuilder builder,
      long Id = 0,
      long LocationId = 0,
  ...
  public static Offset<FlatDataGlobal.AcademyZoneExcel> EndAcademyZoneExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.AcademyZoneExcel>(o);
  }
}
