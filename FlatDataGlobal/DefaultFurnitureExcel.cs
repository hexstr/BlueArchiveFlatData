...
public struct DefaultFurnitureExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.FurnitureLocation Location { get { int o = __p.__offset(6); return o != 0 ? (FlatDataGlobal.FurnitureLocation)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.FurnitureLocation.None; } }
  ...
  public static Offset<FlatDataGlobal.DefaultFurnitureExcel> CreateDefaultFurnitureExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddLocation(FlatBufferBuilder builder, FlatDataGlobal.FurnitureLocation Location) { builder.AddInt(1, (int)Location, 0); }
  ...
  public static Offset<FlatDataGlobal.DefaultFurnitureExcel> EndDefaultFurnitureExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.DefaultFurnitureExcel>(o);
  }
}
