...
public struct ScenarioScriptMain5Excel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_3_3(); }
  public static ScenarioScriptMain5Excel GetRootAsScenarioScriptMain5Excel(ByteBuffer _bb) { return GetRootAsScenarioScriptMain5Excel(_bb, new ScenarioScriptMain5Excel()); }
  public static ScenarioScriptMain5Excel GetRootAsScenarioScriptMain5Excel(ByteBuffer _bb, ScenarioScriptMain5Excel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ScenarioScriptMain5Excel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptMain5Excel> CreateScenarioScriptMain5Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptMain5Excel.AddBGMId(builder, BGMId);
    ScenarioScriptMain5Excel.AddSelectionGroup(builder, SelectionGroup);
    ScenarioScriptMain5Excel.AddGroupId(builder, GroupId);
    ScenarioScriptMain5Excel.AddVoiceJp(builder, VoiceJpOffset);
    ScenarioScriptMain5Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptMain5Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptMain5Excel.AddTextTh(builder, TextThOffset);
    ScenarioScriptMain5Excel.AddTextJp(builder, TextJpOffset);
    ScenarioScriptMain5Excel.AddScriptKr(builder, ScriptKrOffset);
    ScenarioScriptMain5Excel.AddPopupFileName(builder, PopupFileNameOffset);
    ScenarioScriptMain5Excel.AddBGEffect(builder, BGEffect);
    ScenarioScriptMain5Excel.AddBGName(builder, BGName);
    ScenarioScriptMain5Excel.AddTransition(builder, Transition);
    ScenarioScriptMain5Excel.AddSound(builder, SoundOffset);
    ScenarioScriptMain5Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptMain5Excel.EndScenarioScriptMain5Excel(builder);
  }

  public static void StartScenarioScriptMain5Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptMain5Excel> EndScenarioScriptMain5Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptMain5Excel>(o);
  }
}
