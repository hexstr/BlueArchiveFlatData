...
public struct EquipmentLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.EquipmentLevelExcel> CreateEquipmentLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
  ...
  public static Offset<FlatDataGlobal.EquipmentLevelExcel> EndEquipmentLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.EquipmentLevelExcel>(o);
  }
}
