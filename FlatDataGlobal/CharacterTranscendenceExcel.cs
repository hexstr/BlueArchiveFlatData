...
public struct CharacterTranscendenceExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.CharacterTranscendenceExcel> EndCharacterTranscendenceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.CharacterTranscendenceExcel>(o);
  }
}
