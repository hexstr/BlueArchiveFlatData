...
public struct EventContentTreasureRoundExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.EventContentTreasureRoundExcel> CreateEventContentTreasureRoundExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataGlobal.EventContentTreasureRoundExcel> EndEventContentTreasureRoundExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.EventContentTreasureRoundExcel>(o);
  }
}
