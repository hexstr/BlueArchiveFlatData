...
public struct EventContentStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.EventContentStageRewardExcel> CreateEventContentStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<FlatDataGlobal.EventContentStageRewardExcel> EndEventContentStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.EventContentStageRewardExcel>(o);
  }
}
