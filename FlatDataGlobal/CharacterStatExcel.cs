...
public struct CharacterStatExcel : IFlatbufferObject
{
  ...
  public long EnhanceLightArmorRate { get { int o = __p.__offset(60); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long EnhanceHeavyArmorRate { get { int o = __p.__offset(62); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long EnhanceUnarmedRate { get { int o = __p.__offset(64); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long ExtendBuffDuration { get { int o = __p.__offset(66); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long ExtendDebuffDuration { get { int o = __p.__offset(68); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long ExtendCrowdControlDuration { get { int o = __p.__offset(70); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long AmmoCount { get { int o = __p.__offset(72); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long AmmoCost { get { int o = __p.__offset(74); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long IgnoreDelayCount { get { int o = __p.__offset(76); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long NormalAttackSpeed { get { int o = __p.__offset(78); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long Range { get { int o = __p.__offset(80); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long InitialRangeRate { get { int o = __p.__offset(82); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long MoveSpeed { get { int o = __p.__offset(84); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long SightPoint { get { int o = __p.__offset(86); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long ActiveGauge { get { int o = __p.__offset(88); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public int GroggyGauge { get { int o = __p.__offset(90); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public int GroggyTime { get { int o = __p.__offset(92); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public long StrategyMobility { get { int o = __p.__offset(94); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long ActionCount { get { int o = __p.__offset(96); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long StrategySightRange { get { int o = __p.__offset(98); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long DamageRatio { get { int o = __p.__offset(100); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long DamagedRatio { get { int o = __p.__offset(102); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public FlatDataGlobal.TerrainAdaptationStat StreetBattleAdaptation { get { int o = __p.__offset(104); return o != 0 ? (FlatDataGlobal.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.TerrainAdaptationStat.D; } }
  public FlatDataGlobal.TerrainAdaptationStat OutdoorBattleAdaptation { get { int o = __p.__offset(106); return o != 0 ? (FlatDataGlobal.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.TerrainAdaptationStat.D; } }
  public FlatDataGlobal.TerrainAdaptationStat IndoorBattleAdaptation { get { int o = __p.__offset(108); return o != 0 ? (FlatDataGlobal.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.TerrainAdaptationStat.D; } }
  public long RegenCost { get { int o = __p.__offset(110); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  ...
  public static void StartCharacterStatExcel(FlatBufferBuilder builder) { builder.StartTable(54); }
  ...
  public static void AddEnhanceLightArmorRate(FlatBufferBuilder builder, long EnhanceLightArmorRate) { builder.AddLong(28, EnhanceLightArmorRate, 0); }
  public static void AddEnhanceHeavyArmorRate(FlatBufferBuilder builder, long EnhanceHeavyArmorRate) { builder.AddLong(29, EnhanceHeavyArmorRate, 0); }
  public static void AddEnhanceUnarmedRate(FlatBufferBuilder builder, long EnhanceUnarmedRate) { builder.AddLong(30, EnhanceUnarmedRate, 0); }
  public static void AddExtendBuffDuration(FlatBufferBuilder builder, long ExtendBuffDuration) { builder.AddLong(31, ExtendBuffDuration, 0); }
  public static void AddExtendDebuffDuration(FlatBufferBuilder builder, long ExtendDebuffDuration) { builder.AddLong(32, ExtendDebuffDuration, 0); }
  public static void AddExtendCrowdControlDuration(FlatBufferBuilder builder, long ExtendCrowdControlDuration) { builder.AddLong(33, ExtendCrowdControlDuration, 0); }
  public static void AddAmmoCount(FlatBufferBuilder builder, long AmmoCount) { builder.AddLong(34, AmmoCount, 0); }
  public static void AddAmmoCost(FlatBufferBuilder builder, long AmmoCost) { builder.AddLong(35, AmmoCost, 0); }
  public static void AddIgnoreDelayCount(FlatBufferBuilder builder, long IgnoreDelayCount) { builder.AddLong(36, IgnoreDelayCount, 0); }
  public static void AddNormalAttackSpeed(FlatBufferBuilder builder, long NormalAttackSpeed) { builder.AddLong(37, NormalAttackSpeed, 0); }
  public static void AddRange(FlatBufferBuilder builder, long Range) { builder.AddLong(38, Range, 0); }
  public static void AddInitialRangeRate(FlatBufferBuilder builder, long InitialRangeRate) { builder.AddLong(39, InitialRangeRate, 0); }
  public static void AddMoveSpeed(FlatBufferBuilder builder, long MoveSpeed) { builder.AddLong(40, MoveSpeed, 0); }
  public static void AddSightPoint(FlatBufferBuilder builder, long SightPoint) { builder.AddLong(41, SightPoint, 0); }
  public static void AddActiveGauge(FlatBufferBuilder builder, long ActiveGauge) { builder.AddLong(42, ActiveGauge, 0); }
  public static void AddGroggyGauge(FlatBufferBuilder builder, int GroggyGauge) { builder.AddInt(43, GroggyGauge, 0); }
  public static void AddGroggyTime(FlatBufferBuilder builder, int GroggyTime) { builder.AddInt(44, GroggyTime, 0); }
  public static void AddStrategyMobility(FlatBufferBuilder builder, long StrategyMobility) { builder.AddLong(45, StrategyMobility, 0); }
  public static void AddActionCount(FlatBufferBuilder builder, long ActionCount) { builder.AddLong(46, ActionCount, 0); }
  public static void AddStrategySightRange(FlatBufferBuilder builder, long StrategySightRange) { builder.AddLong(47, StrategySightRange, 0); }
  public static void AddDamageRatio(FlatBufferBuilder builder, long DamageRatio) { builder.AddLong(48, DamageRatio, 0); }
  public static void AddDamagedRatio(FlatBufferBuilder builder, long DamagedRatio) { builder.AddLong(49, DamagedRatio, 0); }
  public static void AddStreetBattleAdaptation(FlatBufferBuilder builder, FlatDataGlobal.TerrainAdaptationStat StreetBattleAdaptation) { builder.AddInt(50, (int)StreetBattleAdaptation, 0); }
  public static void AddOutdoorBattleAdaptation(FlatBufferBuilder builder, FlatDataGlobal.TerrainAdaptationStat OutdoorBattleAdaptation) { builder.AddInt(51, (int)OutdoorBattleAdaptation, 0); }
  public static void AddIndoorBattleAdaptation(FlatBufferBuilder builder, FlatDataGlobal.TerrainAdaptationStat IndoorBattleAdaptation) { builder.AddInt(52, (int)IndoorBattleAdaptation, 0); }
  public static void AddRegenCost(FlatBufferBuilder builder, long RegenCost) { builder.AddLong(53, RegenCost, 0); }
