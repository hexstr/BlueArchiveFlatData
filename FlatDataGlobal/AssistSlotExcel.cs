...
public struct AssistSlotExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.AssistSlotExcel> CreateAssistSlotExcel(FlatBufferBuilder builder,
      long SlotId = 0,
  ...
  public static Offset<FlatDataGlobal.AssistSlotExcel> EndAssistSlotExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.AssistSlotExcel>(o);
  }
}
