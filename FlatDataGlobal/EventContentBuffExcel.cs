...
public struct EventContentBuffExcel : IFlatbufferObject
{
  ...
  public static void AddCharacterTag(FlatBufferBuilder builder, FlatDataGlobal.Tag CharacterTag) { builder.AddInt(2, (int)CharacterTag, 0); }
  public static void AddEnumType(FlatBufferBuilder builder, FlatDataGlobal.EventContentBuffFindRule EnumType) { builder.AddInt(3, (int)EnumType, 0); }
  ...
  public static Offset<FlatDataGlobal.EventContentBuffExcel> EndEventContentBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.EventContentBuffExcel>(o);
  }
}
