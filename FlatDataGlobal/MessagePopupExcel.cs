...
public struct MessagePopupExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.MessagePopupButtonType Button(int j) { int o = __p.__offset(22); return o != 0 ? (FlatDataGlobal.MessagePopupButtonType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataGlobal.MessagePopupButtonType)0; }
  public int ButtonLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataGlobal.MessagePopupButtonType> GetButtonBytes() { return __p.__vector_as_span<FlatDataGlobal.MessagePopupButtonType>(22, 4); }
#else
  public ArraySegment<byte>? GetButtonBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public FlatDataGlobal.MessagePopupButtonType[] GetButtonArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataGlobal.MessagePopupButtonType[] a = new FlatDataGlobal.MessagePopupButtonType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataGlobal.MessagePopupButtonType)__p.bb.GetInt(p + i * 4); } return a; }
