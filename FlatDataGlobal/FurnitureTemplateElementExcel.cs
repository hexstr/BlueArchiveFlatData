...
public struct FurnitureTemplateElementExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.FurnitureLocation Location { get { int o = __p.__offset(8); return o != 0 ? (FlatDataGlobal.FurnitureLocation)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.FurnitureLocation.None; } }
  ...
  public static Offset<FlatDataGlobal.FurnitureTemplateElementExcel> CreateFurnitureTemplateElementExcel(FlatBufferBuilder builder,
      long FurnitureTemplateId = 0,
      long FurnitureId = 0,
      FlatDataGlobal.FurnitureLocation Location = FlatDataGlobal.FurnitureLocation.None,
  ...
  public static void AddLocation(FlatBufferBuilder builder, FlatDataGlobal.FurnitureLocation Location) { builder.AddInt(2, (int)Location, 0); }
  ...
  public static Offset<FlatDataGlobal.FurnitureTemplateElementExcel> EndFurnitureTemplateElementExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.FurnitureTemplateElementExcel>(o);
  }
}
