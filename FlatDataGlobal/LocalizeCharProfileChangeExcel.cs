...
public struct LocalizeCharProfileChangeExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.LocalizeCharProfileChangeExcel> CreateLocalizeCharProfileChangeExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<FlatDataGlobal.LocalizeCharProfileChangeExcel> EndLocalizeCharProfileChangeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.LocalizeCharProfileChangeExcel>(o);
  }
}
