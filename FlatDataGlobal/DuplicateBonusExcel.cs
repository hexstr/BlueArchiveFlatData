...
public struct DuplicateBonusExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.ItemCategory ItemCategory { get { int o = __p.__offset(6); return o != 0 ? (FlatDataGlobal.ItemCategory)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ItemCategory.Coin; } }
  ...
  public static Offset<FlatDataGlobal.DuplicateBonusExcel> CreateDuplicateBonusExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddItemCategory(FlatBufferBuilder builder, FlatDataGlobal.ItemCategory itemCategory) { builder.AddInt(1, (int)itemCategory, 0); }
  ...
  public static Offset<FlatDataGlobal.DuplicateBonusExcel> EndDuplicateBonusExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.DuplicateBonusExcel>(o);
  }
}
