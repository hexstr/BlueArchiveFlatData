...
public struct GroundGridFlat : IFlatbufferObject
{
  ...
  public FlatDataGlobal.GroundNodeFlat? Nodes(int j) { int o = __p.__offset(14); return o != 0 ? (FlatDataGlobal.GroundNodeFlat?)(new FlatDataGlobal.GroundNodeFlat()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  ...
  public static Offset<FlatDataGlobal.GroundGridFlat> CreateGroundGridFlat(FlatBufferBuilder builder,
      int X = 0,
      int Y = 0,
      float StartX = 0.0f,
      float StartY = 0.0f,
  ...
  public static VectorOffset CreateNodesVector(FlatBufferBuilder builder, Offset<FlatDataGlobal.GroundNodeFlat>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateNodesVectorBlock(FlatBufferBuilder builder, Offset<FlatDataGlobal.GroundNodeFlat>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateNodesVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<FlatDataGlobal.GroundNodeFlat>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateNodesVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<FlatDataGlobal.GroundNodeFlat>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatDataGlobal.GroundGridFlat> EndGroundGridFlat(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.GroundGridFlat>(o);
  }
}
