...
public struct ShopCashExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.PurchaseSourceType PackageType { get { int o = __p.__offset(8); return o != 0 ? (FlatDataGlobal.PurchaseSourceType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.PurchaseSourceType.None; } }
  ...
  public static Offset<FlatDataGlobal.ShopCashExcel> CreateShopCashExcel(FlatBufferBuilder builder,
      ...
      FlatDataGlobal.PurchaseSourceType PackageType = FlatDataGlobal.PurchaseSourceType.None,
