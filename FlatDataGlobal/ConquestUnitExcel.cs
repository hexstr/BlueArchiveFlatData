...
public struct ConquestUnitExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.ConquestEnemyType EnemyType { get { int o = __p.__offset(22); return o != 0 ? (FlatDataGlobal.ConquestEnemyType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ConquestEnemyType.None; } }
  public FlatDataGlobal.ConquestTeamType Team { get { int o = __p.__offset(24); return o != 0 ? (FlatDataGlobal.ConquestTeamType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ConquestTeamType.None; } }
  ...
  public FlatDataGlobal.StarGoalType StarGoal(int j) { int o = __p.__offset(34); return o != 0 ? (FlatDataGlobal.StarGoalType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataGlobal.StarGoalType)0; }
  public int StarGoalLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataGlobal.StarGoalType> GetStarGoalBytes() { return __p.__vector_as_span<FlatDataGlobal.StarGoalType>(34, 4); }
#else
  public ArraySegment<byte>? GetStarGoalBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public FlatDataGlobal.StarGoalType[] GetStarGoalArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataGlobal.StarGoalType[] a = new FlatDataGlobal.StarGoalType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataGlobal.StarGoalType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public FlatDataGlobal.ParcelType StageEnterCostType { get { int o = __p.__offset(40); return o != 0 ? (FlatDataGlobal.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ParcelType.None; } }
  ...
  public FlatDataGlobal.ParcelType ManageEchelonStageEnterCostType { get { int o = __p.__offset(46); return o != 0 ? (FlatDataGlobal.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ParcelType.None; } }
  ...
  public FlatDataGlobal.StageTopography StageTopography { get { int o = __p.__offset(58); return o != 0 ? (FlatDataGlobal.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.StageTopography.Street; } }
  ...
  public FlatDataGlobal.EchelonExtensionType EchelonExtensionType { get { int o = __p.__offset(66); return o != 0 ? (FlatDataGlobal.EchelonExtensionType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.EchelonExtensionType.Base; } }
  ...
  public static void AddEnemyType(FlatBufferBuilder builder, FlatDataGlobal.ConquestEnemyType EnemyType) { builder.AddInt(9, (int)EnemyType, 0); }
  public static void AddTeam(FlatBufferBuilder builder, FlatDataGlobal.ConquestTeamType Team) { builder.AddInt(10, (int)Team, 0); }
  ...
  public static void AddStageEnterCostType(FlatBufferBuilder builder, FlatDataGlobal.ParcelType StageEnterCostType) { builder.AddInt(18, (int)StageEnterCostType, 0); }
  ...
  public static void AddManageEchelonStageEnterCostType(FlatBufferBuilder builder, FlatDataGlobal.ParcelType ManageEchelonStageEnterCostType) { builder.AddInt(21, (int)ManageEchelonStageEnterCostType, 0); }
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, FlatDataGlobal.StageTopography stageTopography) { builder.AddInt(27, (int)stageTopography, 0); }
  ...
  public static void AddEchelonExtensionType(FlatBufferBuilder builder, FlatDataGlobal.EchelonExtensionType echelonExtensionType) { builder.AddInt(31, (int)echelonExtensionType, 0); }
