...
public struct CampaignChapterExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.CampaignChapterExcel> CreateCampaignChapterExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataGlobal.CampaignChapterExcel> EndCampaignChapterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.CampaignChapterExcel>(o);
  }
}
