...
public struct ScenarioTransitionExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.ScenarioTransitionExcel> CreateScenarioTransitionExcel(FlatBufferBuilder builder,
      uint Name = 0,
  ...
  public static Offset<FlatDataGlobal.ScenarioTransitionExcel> EndScenarioTransitionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioTransitionExcel>(o);
  }
}
