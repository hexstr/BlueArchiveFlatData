...
public struct EventContentLocationRewardExcel : IFlatbufferObject
{
  ...
  public string VoiceClipsEn(int j) { int o = __p.__offset(18); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int VoiceClipsEnLength { get { int o = __p.__offset(18); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string VoiceClipsTw(int j) { int o = __p.__offset(20); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int VoiceClipsTwLength { get { int o = __p.__offset(20); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string VoiceClipsTh(int j) { int o = __p.__offset(22); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int VoiceClipsThLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
  public uint LocalizeEtcId { get { int o = __p.__offset(24); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }
  public long LocationRank { get { int o = __p.__offset(26); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long FavorExp { get { int o = __p.__offset(28); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long SecretStoneAmount { get { int o = __p.__offset(30); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long SecretStoneProb { get { int o = __p.__offset(32); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long ExtraFavorExp { get { int o = __p.__offset(34); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long ExtraFavorExpProb { get { int o = __p.__offset(36); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public FlatDataGlobal.ParcelType ExtraRewardParcelType(int j) { int o = __p.__offset(38); return o != 0 ? (FlatDataGlobal.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataGlobal.ParcelType)0; }
  public int ExtraRewardParcelTypeLength { get { int o = __p.__offset(38); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataGlobal.ParcelType> GetExtraRewardParcelTypeBytes() { return __p.__vector_as_span<FlatDataGlobal.ParcelType>(38, 4); }
#else
  public ArraySegment<byte>? GetExtraRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(38); }
#endif
  public FlatDataGlobal.ParcelType[] GetExtraRewardParcelTypeArray() { int o = __p.__offset(38); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataGlobal.ParcelType[] a = new FlatDataGlobal.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataGlobal.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  public long ExtraRewardParcelId(int j) { int o = __p.__offset(40); return o != 0 ? __p.bb.GetLong(__p.__vector(o) + j * 8) : (long)0; }
  public int ExtraRewardParcelIdLength { get { int o = __p.__offset(40); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<long> GetExtraRewardParcelIdBytes() { return __p.__vector_as_span<long>(40, 8); }
#else
  public ArraySegment<byte>? GetExtraRewardParcelIdBytes() { return __p.__vector_as_arraysegment(40); }
#endif
  public long[] GetExtraRewardParcelIdArray() { return __p.__vector_as_array<long>(40); }
  public long ExtraRewardAmount(int j) { int o = __p.__offset(42); return o != 0 ? __p.bb.GetLong(__p.__vector(o) + j * 8) : (long)0; }
  public int ExtraRewardAmountLength { get { int o = __p.__offset(42); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<long> GetExtraRewardAmountBytes() { return __p.__vector_as_span<long>(42, 8); }
#else
  public ArraySegment<byte>? GetExtraRewardAmountBytes() { return __p.__vector_as_arraysegment(42); }
#endif
  public long[] GetExtraRewardAmountArray() { return __p.__vector_as_array<long>(42); }
  public long ExtraRewardProb(int j) { int o = __p.__offset(44); return o != 0 ? __p.bb.GetLong(__p.__vector(o) + j * 8) : (long)0; }
  public int ExtraRewardProbLength { get { int o = __p.__offset(44); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<long> GetExtraRewardProbBytes() { return __p.__vector_as_span<long>(44, 8); }
#else
  public ArraySegment<byte>? GetExtraRewardProbBytes() { return __p.__vector_as_arraysegment(44); }
#endif
  public long[] GetExtraRewardProbArray() { return __p.__vector_as_array<long>(44); }
  public bool IsExtraRewardDisplayed(int j) { int o = __p.__offset(46); return o != 0 ? 0!=__p.bb.Get(__p.__vector(o) + j * 1) : false; }
  public int IsExtraRewardDisplayedLength { get { int o = __p.__offset(46); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<bool> GetIsExtraRewardDisplayedBytes() { return __p.__vector_as_span<bool>(46, 1); }
#else
  public ArraySegment<byte>? GetIsExtraRewardDisplayedBytes() { return __p.__vector_as_arraysegment(46); }
#endif
  public bool[] GetIsExtraRewardDisplayedArray() { return __p.__vector_as_array<bool>(46); }
  public FlatDataGlobal.ParcelType RewardParcelType(int j) { int o = __p.__offset(48); return o != 0 ? (FlatDataGlobal.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataGlobal.ParcelType)0; }
  public int RewardParcelTypeLength { get { int o = __p.__offset(48); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataGlobal.ParcelType> GetRewardParcelTypeBytes() { return __p.__vector_as_span<FlatDataGlobal.ParcelType>(48, 4); }
#else
  public ArraySegment<byte>? GetRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(48); }
#endif
  public FlatDataGlobal.ParcelType[] GetRewardParcelTypeArray() { int o = __p.__offset(48); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataGlobal.ParcelType[] a = new FlatDataGlobal.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataGlobal.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  public long RewardParcelId(int j) { int o = __p.__offset(50); return o != 0 ? __p.bb.GetLong(__p.__vector(o) + j * 8) : (long)0; }
  public int RewardParcelIdLength { get { int o = __p.__offset(50); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<long> GetRewardParcelIdBytes() { return __p.__vector_as_span<long>(50, 8); }
#else
  public ArraySegment<byte>? GetRewardParcelIdBytes() { return __p.__vector_as_arraysegment(50); }
#endif
  public long[] GetRewardParcelIdArray() { return __p.__vector_as_array<long>(50); }
  public long RewardAmount(int j) { int o = __p.__offset(52); return o != 0 ? __p.bb.GetLong(__p.__vector(o) + j * 8) : (long)0; }
  public int RewardAmountLength { get { int o = __p.__offset(52); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<long> GetRewardAmountBytes() { return __p.__vector_as_span<long>(52, 8); }
#else
  public ArraySegment<byte>? GetRewardAmountBytes() { return __p.__vector_as_arraysegment(52); }
#endif
  public long[] GetRewardAmountArray() { return __p.__vector_as_array<long>(52); }
  ...
  public static Offset<FlatDataGlobal.EventContentLocationRewardExcel> CreateEventContentLocationRewardExcel(FlatBufferBuilder builder,
    ...
    EventContentLocationRewardExcel.AddVoiceClipsTh(builder, VoiceClipsThOffset);
    EventContentLocationRewardExcel.AddVoiceClipsTw(builder, VoiceClipsTwOffset);
    EventContentLocationRewardExcel.AddVoiceClipsEn(builder, VoiceClipsEnOffset);
  ...
  public static void StartEventContentLocationRewardExcel(FlatBufferBuilder builder) { builder.StartTable(25); }
  ...
  public static void AddVoiceClipsEn(FlatBufferBuilder builder, VectorOffset VoiceClipsEnOffset) { builder.AddOffset(7, VoiceClipsEnOffset.Value, 0); }
  ...
  public static void AddVoiceClipsTw(FlatBufferBuilder builder, VectorOffset VoiceClipsTwOffset) { builder.AddOffset(8, VoiceClipsTwOffset.Value, 0); }
  ...
  public static void AddVoiceClipsTh(FlatBufferBuilder builder, VectorOffset VoiceClipsThOffset) { builder.AddOffset(9, VoiceClipsThOffset.Value, 0); }
  ...
  public static void AddLocationRank(FlatBufferBuilder builder, long LocationRank) { builder.AddLong(11, LocationRank, 0); }
  public static void AddFavorExp(FlatBufferBuilder builder, long FavorExp) { builder.AddLong(12, FavorExp, 0); }
  public static void AddSecretStoneAmount(FlatBufferBuilder builder, long SecretStoneAmount) { builder.AddLong(13, SecretStoneAmount, 0); }
  public static void AddSecretStoneProb(FlatBufferBuilder builder, long SecretStoneProb) { builder.AddLong(14, SecretStoneProb, 0); }
  public static void AddExtraFavorExp(FlatBufferBuilder builder, long ExtraFavorExp) { builder.AddLong(15, ExtraFavorExp, 0); }
  public static void AddExtraFavorExpProb(FlatBufferBuilder builder, long ExtraFavorExpProb) { builder.AddLong(16, ExtraFavorExpProb, 0); }
  public static void AddExtraRewardParcelType(FlatBufferBuilder builder, VectorOffset ExtraRewardParcelTypeOffset) { builder.AddOffset(17, ExtraRewardParcelTypeOffset.Value, 0); }
  ...
  public static void AddExtraRewardParcelId(FlatBufferBuilder builder, VectorOffset ExtraRewardParcelIdOffset) { builder.AddOffset(18, ExtraRewardParcelIdOffset.Value, 0); }
  ...
  public static void AddExtraRewardAmount(FlatBufferBuilder builder, VectorOffset ExtraRewardAmountOffset) { builder.AddOffset(19, ExtraRewardAmountOffset.Value, 0); }
  ...
  public static void AddExtraRewardProb(FlatBufferBuilder builder, VectorOffset ExtraRewardProbOffset) { builder.AddOffset(20, ExtraRewardProbOffset.Value, 0); }
  ...
  public static void AddIsExtraRewardDisplayed(FlatBufferBuilder builder, VectorOffset IsExtraRewardDisplayedOffset) { builder.AddOffset(21, IsExtraRewardDisplayedOffset.Value, 0); }
  ...
  public static void AddRewardParcelType(FlatBufferBuilder builder, VectorOffset RewardParcelTypeOffset) { builder.AddOffset(22, RewardParcelTypeOffset.Value, 0); }
  ...
  public static void AddRewardParcelId(FlatBufferBuilder builder, VectorOffset RewardParcelIdOffset) { builder.AddOffset(23, RewardParcelIdOffset.Value, 0); }
  ...
  public static void AddRewardAmount(FlatBufferBuilder builder, VectorOffset RewardAmountOffset) { builder.AddOffset(24, RewardAmountOffset.Value, 0); }
