...
public struct VoiceSpineExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.VoiceSpineExcel> CreateVoiceSpineExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      uint Id = 0,
  ...
  public static Offset<FlatDataGlobal.VoiceSpineExcel> EndVoiceSpineExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.VoiceSpineExcel>(o);
  }
}
