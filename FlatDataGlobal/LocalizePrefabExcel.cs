...
public struct LocalizePrefabExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.LocalizePrefabExcel> CreateLocalizePrefabExcel(FlatBufferBuilder builder,
      uint Key = 0,
    ...
    LocalizePrefabExcel.AddEn(builder, EnOffset);
    LocalizePrefabExcel.AddTw(builder, TwOffset);
    LocalizePrefabExcel.AddTh(builder, ThOffset);
  ...
  public static void StartLocalizePrefabExcel(FlatBufferBuilder builder) { builder.StartTable(6); }
  ...
  public static Offset<FlatDataGlobal.LocalizePrefabExcel> EndLocalizePrefabExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.LocalizePrefabExcel>(o);
  }
}
