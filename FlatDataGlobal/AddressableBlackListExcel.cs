...
public struct AddressableBlackListExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.AddressableBlackListExcel> CreateAddressableBlackListExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataGlobal.AddressableBlackListExcel> EndAddressableBlackListExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.AddressableBlackListExcel>(o);
  }
}
