...
public struct EventContentCharacterBonusExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.EventContentItemType EventContentItemType(int j) { int o = __p.__offset(8); return o != 0 ? (FlatDataGlobal.EventContentItemType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataGlobal.EventContentItemType)0; }
  public int EventContentItemTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataGlobal.EventContentItemType> GetEventContentItemTypeBytes() { return __p.__vector_as_span<FlatDataGlobal.EventContentItemType>(8, 4); }
#else
  ...
  public static VectorOffset CreateEventContentItemTypeVector(FlatBufferBuilder builder, FlatDataGlobal.EventContentItemType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateEventContentItemTypeVectorBlock(FlatBufferBuilder builder, FlatDataGlobal.EventContentItemType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEventContentItemTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatDataGlobal.EventContentItemType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEventContentItemTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatDataGlobal.EventContentItemType>(dataPtr, sizeInBytes); return builder.EndVector(); }
