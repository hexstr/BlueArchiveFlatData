...
public struct CharacterVoiceSubtitleExcel : IFlatbufferObject
{
  ...
  public string LocalizeTW { get { int o = __p.__offset(18); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetLocalizeTWBytes() { return __p.__vector_as_span<byte>(18, 1); }
#else
  public ArraySegment<byte>? GetLocalizeTWBytes() { return __p.__vector_as_arraysegment(18); }
#endif
  public byte[] GetLocalizeTWArray() { return __p.__vector_as_array<byte>(18); }
  ...
  public static Offset<FlatDataGlobal.CharacterVoiceSubtitleExcel> CreateCharacterVoiceSubtitleExcel(FlatBufferBuilder builder,
  ...
  public static void StartCharacterVoiceSubtitleExcel(FlatBufferBuilder builder) { builder.StartTable(10); }
  ...
  public static void AddLocalizeTW(FlatBufferBuilder builder, StringOffset LocalizeTWOffset) { builder.AddOffset(7, LocalizeTWOffset.Value, 0); }
  ...
  public static Offset<FlatDataGlobal.CharacterVoiceSubtitleExcel> EndCharacterVoiceSubtitleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.CharacterVoiceSubtitleExcel>(o);
  }
}
