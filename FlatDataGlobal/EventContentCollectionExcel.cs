...
public struct EventContentCollectionExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.CollectionUnlockType UnlockConditionType { get { int o = __p.__offset(10); return o != 0 ? (FlatDataGlobal.CollectionUnlockType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.CollectionUnlockType.None; } }
  ...
  public static void AddUnlockConditionType(FlatBufferBuilder builder, FlatDataGlobal.CollectionUnlockType UnlockConditionType) { builder.AddInt(3, (int)UnlockConditionType, 0); }
