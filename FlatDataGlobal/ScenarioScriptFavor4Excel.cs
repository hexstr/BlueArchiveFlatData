...
public struct ScenarioScriptFavor4Excel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_3_3(); }
  public static ScenarioScriptFavor4Excel GetRootAsScenarioScriptFavor4Excel(ByteBuffer _bb) { return GetRootAsScenarioScriptFavor4Excel(_bb, new ScenarioScriptFavor4Excel()); }
  public static ScenarioScriptFavor4Excel GetRootAsScenarioScriptFavor4Excel(ByteBuffer _bb, ScenarioScriptFavor4Excel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ScenarioScriptFavor4Excel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptFavor4Excel> CreateScenarioScriptFavor4Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptFavor4Excel.AddBGMId(builder, BGMId);
    ScenarioScriptFavor4Excel.AddSelectionGroup(builder, SelectionGroup);
    ScenarioScriptFavor4Excel.AddGroupId(builder, GroupId);
    ScenarioScriptFavor4Excel.AddVoiceJp(builder, VoiceJpOffset);
    ScenarioScriptFavor4Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptFavor4Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptFavor4Excel.AddTextTh(builder, TextThOffset);
    ScenarioScriptFavor4Excel.AddTextJp(builder, TextJpOffset);
    ScenarioScriptFavor4Excel.AddScriptKr(builder, ScriptKrOffset);
    ScenarioScriptFavor4Excel.AddPopupFileName(builder, PopupFileNameOffset);
    ScenarioScriptFavor4Excel.AddBGEffect(builder, BGEffect);
    ScenarioScriptFavor4Excel.AddBGName(builder, BGName);
    ScenarioScriptFavor4Excel.AddTransition(builder, Transition);
    ScenarioScriptFavor4Excel.AddSound(builder, SoundOffset);
    ScenarioScriptFavor4Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptFavor4Excel.EndScenarioScriptFavor4Excel(builder);
  }

  public static void StartScenarioScriptFavor4Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptFavor4Excel> EndScenarioScriptFavor4Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptFavor4Excel>(o);
  }
}
