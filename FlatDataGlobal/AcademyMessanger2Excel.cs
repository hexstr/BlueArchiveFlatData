...
public struct AcademyMessanger2Excel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.AcademyMessanger2Excel> CreateAcademyMessanger2Excel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataGlobal.AcademyMessanger2Excel> EndAcademyMessanger2Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.AcademyMessanger2Excel>(o);
  }
}
