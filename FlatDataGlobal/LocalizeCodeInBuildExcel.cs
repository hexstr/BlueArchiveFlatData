...
public struct LocalizeCodeInBuildExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.LocalizeCodeInBuildExcel> CreateLocalizeCodeInBuildExcel(FlatBufferBuilder builder,
      uint Key = 0,
  ...
  public static Offset<FlatDataGlobal.LocalizeCodeInBuildExcel> EndLocalizeCodeInBuildExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.LocalizeCodeInBuildExcel>(o);
  }
}
