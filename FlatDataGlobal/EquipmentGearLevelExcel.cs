...
public struct EquipmentGearLevelExcel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_3_3(); }
  public static EquipmentGearLevelExcel GetRootAsEquipmentGearLevelExcel(ByteBuffer _bb) { return GetRootAsEquipmentGearLevelExcel(_bb, new EquipmentGearLevelExcel()); }
  public static EquipmentGearLevelExcel GetRootAsEquipmentGearLevelExcel(ByteBuffer _bb, EquipmentGearLevelExcel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EquipmentGearLevelExcel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.EquipmentGearLevelExcel> CreateEquipmentGearLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
      VectorOffset TierLevelExpOffset = default(VectorOffset),
      VectorOffset TotalExpOffset = default(VectorOffset)) {
    builder.StartTable(3);
    EquipmentGearLevelExcel.AddTotalExp(builder, TotalExpOffset);
    EquipmentGearLevelExcel.AddTierLevelExp(builder, TierLevelExpOffset);
    EquipmentGearLevelExcel.AddLevel(builder, Level);
    return EquipmentGearLevelExcel.EndEquipmentGearLevelExcel(builder);
  }

  public static void StartEquipmentGearLevelExcel(FlatBufferBuilder builder) { builder.StartTable(3); }
  ...
  public static Offset<FlatDataGlobal.EquipmentGearLevelExcel> EndEquipmentGearLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.EquipmentGearLevelExcel>(o);
  }
}
