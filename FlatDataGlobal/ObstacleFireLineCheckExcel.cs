...
public struct ObstacleFireLineCheckExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.ObstacleFireLineCheckExcel> CreateObstacleFireLineCheckExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataGlobal.ObstacleFireLineCheckExcel> EndObstacleFireLineCheckExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ObstacleFireLineCheckExcel>(o);
  }
}
