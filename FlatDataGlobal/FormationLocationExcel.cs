...
public struct FormationLocationExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.FormationLocationExcel> CreateFormationLocationExcel(FlatBufferBuilder builder,
      long Id = 0,
      long GroupID = 0,
  ...
  public static Offset<FlatDataGlobal.FormationLocationExcel> EndFormationLocationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.FormationLocationExcel>(o);
  }
}
