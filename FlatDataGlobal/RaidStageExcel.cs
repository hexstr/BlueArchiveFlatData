...
public struct RaidStageExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.Difficulty Difficulty { get { int o = __p.__offset(20); return o != 0 ? (FlatDataGlobal.Difficulty)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.Difficulty.Normal; } }
  ...
  public long RaidRewardGroupId { get { int o = __p.__offset(48); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public string RaidRewardDevName { get { int o = __p.__offset(50); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetRaidRewardDevNameBytes() { return __p.__vector_as_span<byte>(50, 1); }
#else
  public ArraySegment<byte>? GetRaidRewardDevNameBytes() { return __p.__vector_as_arraysegment(50); }
#endif
  public byte[] GetRaidRewardDevNameArray() { return __p.__vector_as_array<byte>(50); }
  ...
  public int InitSupplyCount { get { int o = __p.__offset(68); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public bool ShowSkillCard { get { int o = __p.__offset(70); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public uint BossBGInfoKey { get { int o = __p.__offset(72); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }
  ...
  public static void AddDifficulty(FlatBufferBuilder builder, FlatDataGlobal.Difficulty Difficulty) { builder.AddInt(8, (int)Difficulty, 0); }
  ...
  public static void AddRaidRewardGroupId(FlatBufferBuilder builder, long RaidRewardGroupId) { builder.AddLong(22, RaidRewardGroupId, 0); }
  public static void AddRaidRewardDevName(FlatBufferBuilder builder, StringOffset RaidRewardDevNameOffset) { builder.AddOffset(23, RaidRewardDevNameOffset.Value, 0); }
  ...
  public static void AddInitSupplyCount(FlatBufferBuilder builder, int InitSupplyCount) { builder.AddInt(32, InitSupplyCount, 0); }
  public static void AddShowSkillCard(FlatBufferBuilder builder, bool ShowSkillCard) { builder.AddBool(33, ShowSkillCard, false); }
  public static void AddBossBGInfoKey(FlatBufferBuilder builder, uint BossBGInfoKey) { builder.AddUint(34, BossBGInfoKey, 0); }
