...
public struct EventContentLocationExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.ParcelType ScheduleEventPointCostParcelType { get { int o = __p.__offset(14); return o != 0 ? (FlatDataGlobal.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ParcelType.None; } }
  ...
  public static Offset<FlatDataGlobal.EventContentLocationExcel> CreateEventContentLocationExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long Id = 0,
      uint LocalizeEtcId = 0,
      StringOffset PrefabPathOffset = default(StringOffset),
      int LocationResetScheduleCount = 0,
      FlatDataGlobal.ParcelType ScheduleEventPointCostParcelType = FlatDataGlobal.ParcelType.None,
  ...
  public static void AddScheduleEventPointCostParcelType(FlatBufferBuilder builder, FlatDataGlobal.ParcelType ScheduleEventPointCostParcelType) { builder.AddInt(5, (int)ScheduleEventPointCostParcelType, 0); }
  ...
  public static Offset<FlatDataGlobal.EventContentLocationExcel> EndEventContentLocationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.EventContentLocationExcel>(o);
  }
}
