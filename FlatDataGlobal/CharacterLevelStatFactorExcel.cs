...
public struct CharacterLevelStatFactorExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.CharacterLevelStatFactorExcel> CreateCharacterLevelStatFactorExcel(FlatBufferBuilder builder,
      long Level = 0,
  ...
  public static Offset<FlatDataGlobal.CharacterLevelStatFactorExcel> EndCharacterLevelStatFactorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.CharacterLevelStatFactorExcel>(o);
  }
}
