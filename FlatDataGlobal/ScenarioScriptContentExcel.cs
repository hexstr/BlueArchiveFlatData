...
public struct ScenarioScriptContentExcel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_3_3(); }
  public static ScenarioScriptContentExcel GetRootAsScenarioScriptContentExcel(ByteBuffer _bb) { return GetRootAsScenarioScriptContentExcel(_bb, new ScenarioScriptContentExcel()); }
  public static ScenarioScriptContentExcel GetRootAsScenarioScriptContentExcel(ByteBuffer _bb, ScenarioScriptContentExcel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ScenarioScriptContentExcel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptContentExcel> CreateScenarioScriptContentExcel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptContentExcel.AddBGMId(builder, BGMId);
    ScenarioScriptContentExcel.AddSelectionGroup(builder, SelectionGroup);
    ScenarioScriptContentExcel.AddGroupId(builder, GroupId);
    ScenarioScriptContentExcel.AddVoiceJp(builder, VoiceJpOffset);
    ScenarioScriptContentExcel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptContentExcel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptContentExcel.AddTextTh(builder, TextThOffset);
    ScenarioScriptContentExcel.AddTextJp(builder, TextJpOffset);
    ScenarioScriptContentExcel.AddScriptKr(builder, ScriptKrOffset);
    ScenarioScriptContentExcel.AddPopupFileName(builder, PopupFileNameOffset);
    ScenarioScriptContentExcel.AddBGEffect(builder, BGEffect);
    ScenarioScriptContentExcel.AddBGName(builder, BGName);
    ScenarioScriptContentExcel.AddTransition(builder, Transition);
    ScenarioScriptContentExcel.AddSound(builder, SoundOffset);
    ScenarioScriptContentExcel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptContentExcel.EndScenarioScriptContentExcel(builder);
  }

  public static void StartScenarioScriptContentExcel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptContentExcel> EndScenarioScriptContentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptContentExcel>(o);
  }
}
