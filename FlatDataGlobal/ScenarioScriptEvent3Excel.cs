...
public struct ScenarioScriptEvent3Excel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_1_21(); }
  public static ScenarioScriptEvent3Excel GetRootAsScenarioScriptEvent3Excel(ByteBuffer _bb) { return GetRootAsScenarioScriptEvent3Excel(_bb, new ScenarioScriptEvent3Excel()); }
  public static ScenarioScriptEvent3Excel GetRootAsScenarioScriptEvent3Excel(ByteBuffer _bb, ScenarioScriptEvent3Excel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ScenarioScriptEvent3Excel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptEvent3Excel> CreateScenarioScriptEvent3Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptEvent3Excel.AddBGMId(builder, BGMId);
    ScenarioScriptEvent3Excel.AddSelectionGroup(builder, SelectionGroup);
    ScenarioScriptEvent3Excel.AddGroupId(builder, GroupId);
    ScenarioScriptEvent3Excel.AddVoiceJp(builder, VoiceJpOffset);
    ScenarioScriptEvent3Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptEvent3Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptEvent3Excel.AddTextTh(builder, TextThOffset);
    ScenarioScriptEvent3Excel.AddTextJp(builder, TextJpOffset);
    ScenarioScriptEvent3Excel.AddScriptKr(builder, ScriptKrOffset);
    ScenarioScriptEvent3Excel.AddPopupFileName(builder, PopupFileNameOffset);
    ScenarioScriptEvent3Excel.AddBGEffect(builder, BGEffect);
    ScenarioScriptEvent3Excel.AddBGName(builder, BGName);
    ScenarioScriptEvent3Excel.AddTransition(builder, Transition);
    ScenarioScriptEvent3Excel.AddSound(builder, SoundOffset);
    ScenarioScriptEvent3Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptEvent3Excel.EndScenarioScriptEvent3Excel(builder);
  }

  public static void StartScenarioScriptEvent3Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptEvent3Excel> EndScenarioScriptEvent3Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptEvent3Excel>(o);
  }
}
