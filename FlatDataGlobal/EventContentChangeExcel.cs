...
public struct EventContentChangeExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.ParcelType ChangeCostType { get { int o = __p.__offset(16); return o != 0 ? (FlatDataGlobal.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ParcelType.None; } }
  ...
  public static Offset<FlatDataGlobal.EventContentChangeExcel> CreateEventContentChangeExcel(FlatBufferBuilder builder,
      ...
      long RewardId = 0,
      int RewardAmount = 0,
      FlatDataGlobal.ParcelType ChangeCostType = FlatDataGlobal.ParcelType.None,
      long ChangeCostId = 0,
  ...
  public static void AddChangeCostType(FlatBufferBuilder builder, FlatDataGlobal.ParcelType ChangeCostType) { builder.AddInt(6, (int)ChangeCostType, 0); }
  ...
  public static Offset<FlatDataGlobal.EventContentChangeExcel> EndEventContentChangeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.EventContentChangeExcel>(o);
  }
}
