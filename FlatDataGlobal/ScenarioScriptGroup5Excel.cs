...
public struct ScenarioScriptGroup5Excel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_3_3(); }
  public static ScenarioScriptGroup5Excel GetRootAsScenarioScriptGroup5Excel(ByteBuffer _bb) { return GetRootAsScenarioScriptGroup5Excel(_bb, new ScenarioScriptGroup5Excel()); }
  public static ScenarioScriptGroup5Excel GetRootAsScenarioScriptGroup5Excel(ByteBuffer _bb, ScenarioScriptGroup5Excel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ScenarioScriptGroup5Excel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptGroup5Excel> CreateScenarioScriptGroup5Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptGroup5Excel.AddBGMId(builder, BGMId);
    ScenarioScriptGroup5Excel.AddSelectionGroup(builder, SelectionGroup);
    ScenarioScriptGroup5Excel.AddGroupId(builder, GroupId);
    ScenarioScriptGroup5Excel.AddVoiceJp(builder, VoiceJpOffset);
    ScenarioScriptGroup5Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptGroup5Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptGroup5Excel.AddTextTh(builder, TextThOffset);
    ScenarioScriptGroup5Excel.AddTextJp(builder, TextJpOffset);
    ScenarioScriptGroup5Excel.AddScriptKr(builder, ScriptKrOffset);
    ScenarioScriptGroup5Excel.AddPopupFileName(builder, PopupFileNameOffset);
    ScenarioScriptGroup5Excel.AddBGEffect(builder, BGEffect);
    ScenarioScriptGroup5Excel.AddBGName(builder, BGName);
    ScenarioScriptGroup5Excel.AddTransition(builder, Transition);
    ScenarioScriptGroup5Excel.AddSound(builder, SoundOffset);
    ScenarioScriptGroup5Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptGroup5Excel.EndScenarioScriptGroup5Excel(builder);
  }

  public static void StartScenarioScriptGroup5Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptGroup5Excel> EndScenarioScriptGroup5Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptGroup5Excel>(o);
  }
}
