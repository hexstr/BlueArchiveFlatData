...
public struct TacticSkipExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.TacticSkipExcel> CreateTacticSkipExcel(FlatBufferBuilder builder,
      int LevelDiff = 0,
      long HPResult = 0) {
  ...
  public static Offset<FlatDataGlobal.TacticSkipExcel> EndTacticSkipExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.TacticSkipExcel>(o);
  }
}
