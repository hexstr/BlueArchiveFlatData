...
public struct LocalizeCodeExcel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_1_21(); }
  public static LocalizeCodeExcel GetRootAsLocalizeCodeExcel(ByteBuffer _bb) { return GetRootAsLocalizeCodeExcel(_bb, new LocalizeCodeExcel()); }
  public static LocalizeCodeExcel GetRootAsLocalizeCodeExcel(ByteBuffer _bb, LocalizeCodeExcel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public LocalizeCodeExcel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.LocalizeCodeExcel> CreateLocalizeCodeExcel(FlatBufferBuilder builder,
      uint Key = 0,
    ...
    LocalizeCodeExcel.AddEn(builder, EnOffset);
    LocalizeCodeExcel.AddTw(builder, TwOffset);
    LocalizeCodeExcel.AddTh(builder, ThOffset);
    LocalizeCodeExcel.AddJp(builder, JpOffset);
    LocalizeCodeExcel.AddKr(builder, KrOffset);
    LocalizeCodeExcel.AddKey(builder, Key);
    return LocalizeCodeExcel.EndLocalizeCodeExcel(builder);
  }

  public static void StartLocalizeCodeExcel(FlatBufferBuilder builder) { builder.StartTable(6); }
  ...
  public static Offset<FlatDataGlobal.LocalizeCodeExcel> EndLocalizeCodeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.LocalizeCodeExcel>(o);
  }
}
