...
public struct DefaultCharacterExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.DefaultCharacterExcel> CreateDefaultCharacterExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<FlatDataGlobal.DefaultCharacterExcel> EndDefaultCharacterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.DefaultCharacterExcel>(o);
  }
}
