...
public struct ScenarioScriptGroup1Excel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptGroup1Excel> CreateScenarioScriptGroup1Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptGroup1Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptGroup1Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptGroup1Excel.AddTextTh(builder, TextThOffset);
    ...
    ScenarioScriptGroup1Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptGroup1Excel.EndScenarioScriptGroup1Excel(builder);
  }

  public static void StartScenarioScriptGroup1Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptGroup1Excel> EndScenarioScriptGroup1Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptGroup1Excel>(o);
  }
}
