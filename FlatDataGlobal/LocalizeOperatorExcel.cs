...
public struct LocalizeOperatorExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.LocalizeOperatorExcel> CreateLocalizeOperatorExcel(FlatBufferBuilder builder,
      uint Key = 0,
    ...
    LocalizeOperatorExcel.AddEn(builder, EnOffset);
    LocalizeOperatorExcel.AddTw(builder, TwOffset);
    LocalizeOperatorExcel.AddTh(builder, ThOffset);
  ...
  public static void StartLocalizeOperatorExcel(FlatBufferBuilder builder) { builder.StartTable(6); }
  ...
  public static Offset<FlatDataGlobal.LocalizeOperatorExcel> EndLocalizeOperatorExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.LocalizeOperatorExcel>(o);
  }
}
