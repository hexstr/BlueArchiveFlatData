...
public struct ScenarioScriptEvent4Excel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_3_3(); }
  public static ScenarioScriptEvent4Excel GetRootAsScenarioScriptEvent4Excel(ByteBuffer _bb) { return GetRootAsScenarioScriptEvent4Excel(_bb, new ScenarioScriptEvent4Excel()); }
  public static ScenarioScriptEvent4Excel GetRootAsScenarioScriptEvent4Excel(ByteBuffer _bb, ScenarioScriptEvent4Excel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ScenarioScriptEvent4Excel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptEvent4Excel> CreateScenarioScriptEvent4Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptEvent4Excel.AddBGMId(builder, BGMId);
    ScenarioScriptEvent4Excel.AddSelectionGroup(builder, SelectionGroup);
    ScenarioScriptEvent4Excel.AddGroupId(builder, GroupId);
    ScenarioScriptEvent4Excel.AddVoiceJp(builder, VoiceJpOffset);
    ScenarioScriptEvent4Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptEvent4Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptEvent4Excel.AddTextTh(builder, TextThOffset);
    ScenarioScriptEvent4Excel.AddTextJp(builder, TextJpOffset);
    ScenarioScriptEvent4Excel.AddScriptKr(builder, ScriptKrOffset);
    ScenarioScriptEvent4Excel.AddPopupFileName(builder, PopupFileNameOffset);
    ScenarioScriptEvent4Excel.AddBGEffect(builder, BGEffect);
    ScenarioScriptEvent4Excel.AddBGName(builder, BGName);
    ScenarioScriptEvent4Excel.AddTransition(builder, Transition);
    ScenarioScriptEvent4Excel.AddSound(builder, SoundOffset);
    ScenarioScriptEvent4Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptEvent4Excel.EndScenarioScriptEvent4Excel(builder);
  }

  public static void StartScenarioScriptEvent4Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptEvent4Excel> EndScenarioScriptEvent4Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptEvent4Excel>(o);
  }
}
