...
public struct BGMRaidExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.BGMRaidExcel> CreateBGMRaidExcel(FlatBufferBuilder builder,
      long StageId = 0,
      long PhaseIndex = 0,
      long BGMId = 0) {
  ...
  public static Offset<FlatDataGlobal.BGMRaidExcel> EndBGMRaidExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.BGMRaidExcel>(o);
  }
}
