...
public struct LogicEffectCommonVisualExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.EffectBone ParticleEnterSocket { get { int o = __p.__offset(12); return o != 0 ? (FlatDataGlobal.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.EffectBone.None; } }
  ...
  public FlatDataGlobal.EffectBone ParticleLoopSocket { get { int o = __p.__offset(16); return o != 0 ? (FlatDataGlobal.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.EffectBone.None; } }
  ...
  public FlatDataGlobal.EffectBone ParticleEndSocket { get { int o = __p.__offset(20); return o != 0 ? (FlatDataGlobal.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.EffectBone.None; } }
  ...
  public FlatDataGlobal.EffectBone ParticleApplySocket { get { int o = __p.__offset(24); return o != 0 ? (FlatDataGlobal.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.EffectBone.None; } }
  ...
  public FlatDataGlobal.EffectBone ParticleRemovedSocket { get { int o = __p.__offset(28); return o != 0 ? (FlatDataGlobal.EffectBone)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.EffectBone.None; } }

  public static Offset<FlatDataGlobal.LogicEffectCommonVisualExcel> CreateLogicEffectCommonVisualExcel(FlatBufferBuilder builder,
      uint StringID = 0,
      ...
      FlatDataGlobal.EffectBone ParticleEnterSocket = FlatDataGlobal.EffectBone.None,
      StringOffset ParticleLoopPathOffset = default(StringOffset),
      FlatDataGlobal.EffectBone ParticleLoopSocket = FlatDataGlobal.EffectBone.None,
      StringOffset ParticleEndPathOffset = default(StringOffset),
      FlatDataGlobal.EffectBone ParticleEndSocket = FlatDataGlobal.EffectBone.None,
      StringOffset ParticleApplyPathOffset = default(StringOffset),
      FlatDataGlobal.EffectBone ParticleApplySocket = FlatDataGlobal.EffectBone.None,
      StringOffset ParticleRemovedPathOffset = default(StringOffset),
      FlatDataGlobal.EffectBone ParticleRemovedSocket = FlatDataGlobal.EffectBone.None) {
  ...
  public static void AddParticleEnterSocket(FlatBufferBuilder builder, FlatDataGlobal.EffectBone ParticleEnterSocket) { builder.AddInt(4, (int)ParticleEnterSocket, 0); }
  ...
  public static void AddParticleLoopSocket(FlatBufferBuilder builder, FlatDataGlobal.EffectBone ParticleLoopSocket) { builder.AddInt(6, (int)ParticleLoopSocket, 0); }
  ...
  public static void AddParticleEndSocket(FlatBufferBuilder builder, FlatDataGlobal.EffectBone ParticleEndSocket) { builder.AddInt(8, (int)ParticleEndSocket, 0); }
  ...
  public static void AddParticleApplySocket(FlatBufferBuilder builder, FlatDataGlobal.EffectBone ParticleApplySocket) { builder.AddInt(10, (int)ParticleApplySocket, 0); }
  ...
  public static void AddParticleRemovedSocket(FlatBufferBuilder builder, FlatDataGlobal.EffectBone ParticleRemovedSocket) { builder.AddInt(12, (int)ParticleRemovedSocket, 0); }
  public static Offset<FlatDataGlobal.LogicEffectCommonVisualExcel> EndLogicEffectCommonVisualExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.LogicEffectCommonVisualExcel>(o);
  }
}
