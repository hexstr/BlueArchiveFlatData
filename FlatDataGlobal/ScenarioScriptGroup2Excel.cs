...
public struct ScenarioScriptGroup2Excel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_1_21(); }
  public static ScenarioScriptGroup2Excel GetRootAsScenarioScriptGroup2Excel(ByteBuffer _bb) { return GetRootAsScenarioScriptGroup2Excel(_bb, new ScenarioScriptGroup2Excel()); }
  public static ScenarioScriptGroup2Excel GetRootAsScenarioScriptGroup2Excel(ByteBuffer _bb, ScenarioScriptGroup2Excel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ScenarioScriptGroup2Excel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptGroup2Excel> CreateScenarioScriptGroup2Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptGroup2Excel.AddBGMId(builder, BGMId);
    ScenarioScriptGroup2Excel.AddSelectionGroup(builder, SelectionGroup);
    ScenarioScriptGroup2Excel.AddGroupId(builder, GroupId);
    ScenarioScriptGroup2Excel.AddVoiceJp(builder, VoiceJpOffset);
    ScenarioScriptGroup2Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptGroup2Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptGroup2Excel.AddTextTh(builder, TextThOffset);
    ScenarioScriptGroup2Excel.AddTextJp(builder, TextJpOffset);
    ScenarioScriptGroup2Excel.AddScriptKr(builder, ScriptKrOffset);
    ScenarioScriptGroup2Excel.AddPopupFileName(builder, PopupFileNameOffset);
    ScenarioScriptGroup2Excel.AddBGEffect(builder, BGEffect);
    ScenarioScriptGroup2Excel.AddBGName(builder, BGName);
    ScenarioScriptGroup2Excel.AddTransition(builder, Transition);
    ScenarioScriptGroup2Excel.AddSound(builder, SoundOffset);
    ScenarioScriptGroup2Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptGroup2Excel.EndScenarioScriptGroup2Excel(builder);
  }

  public static void StartScenarioScriptGroup2Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptGroup2Excel> EndScenarioScriptGroup2Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptGroup2Excel>(o);
  }
}
