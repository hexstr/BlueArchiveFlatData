...
public struct EventContentScenarioExcel : IFlatbufferObject
{
  ...
  public long ClearedScenarioGroupId { get { int o = __p.__offset(22); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public uint RecollectionSummaryLocalizeScenarioId { get { int o = __p.__offset(24); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }
  public string RecollectionResource { get { int o = __p.__offset(26); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetRecollectionResourceBytes() { return __p.__vector_as_span<byte>(26, 1); }
#else
  public ArraySegment<byte>? GetRecollectionResourceBytes() { return __p.__vector_as_arraysegment(26); }
#endif
  public byte[] GetRecollectionResourceArray() { return __p.__vector_as_array<byte>(26); }
  public bool IsRecollectionHorizon { get { int o = __p.__offset(28); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public FlatDataGlobal.ParcelType CostParcelType { get { int o = __p.__offset(30); return o != 0 ? (FlatDataGlobal.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ParcelType.None; } }
  public long CostId { get { int o = __p.__offset(32); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public int CostAmount { get { int o = __p.__offset(34); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  public static void AddClearedScenarioGroupId(FlatBufferBuilder builder, long ClearedScenarioGroupId) { builder.AddLong(9, ClearedScenarioGroupId, 0); }
  public static void AddRecollectionSummaryLocalizeScenarioId(FlatBufferBuilder builder, uint RecollectionSummaryLocalizeScenarioId) { builder.AddUint(10, RecollectionSummaryLocalizeScenarioId, 0); }
  public static void AddRecollectionResource(FlatBufferBuilder builder, StringOffset RecollectionResourceOffset) { builder.AddOffset(11, RecollectionResourceOffset.Value, 0); }
  public static void AddIsRecollectionHorizon(FlatBufferBuilder builder, bool IsRecollectionHorizon) { builder.AddBool(12, IsRecollectionHorizon, false); }
  public static void AddCostParcelType(FlatBufferBuilder builder, FlatDataGlobal.ParcelType CostParcelType) { builder.AddInt(13, (int)CostParcelType, 0); }
  public static void AddCostId(FlatBufferBuilder builder, long CostId) { builder.AddLong(14, CostId, 0); }
  public static void AddCostAmount(FlatBufferBuilder builder, int CostAmount) { builder.AddInt(15, CostAmount, 0); }
