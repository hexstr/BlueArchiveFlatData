...
public struct LocalizeExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.LocalizeExcel> CreateLocalizeExcel(FlatBufferBuilder builder,
      uint Key = 0,
  ...
  public static Offset<FlatDataGlobal.LocalizeExcel> EndLocalizeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.LocalizeExcel>(o);
  }
}
