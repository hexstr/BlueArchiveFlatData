...
public struct AttendanceRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.AttendanceRewardExcel> CreateAttendanceRewardExcel(FlatBufferBuilder builder,
      long AttendanceId = 0,
      long Day = 0,
  ...
  public static Offset<FlatDataGlobal.AttendanceRewardExcel> EndAttendanceRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.AttendanceRewardExcel>(o);
  }
}
