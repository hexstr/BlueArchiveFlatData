...
public struct ConquestErosionUnitExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.ConquestErosionUnitExcel> CreateConquestErosionUnitExcel(FlatBufferBuilder builder,
      long TilePrefabId = 0,
  ...
  public static Offset<FlatDataGlobal.ConquestErosionUnitExcel> EndConquestErosionUnitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ConquestErosionUnitExcel>(o);
  }
}
