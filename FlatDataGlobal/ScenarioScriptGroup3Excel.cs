...
public struct ScenarioScriptGroup3Excel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptGroup3Excel> CreateScenarioScriptGroup3Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptGroup3Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptGroup3Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptGroup3Excel.AddTextTh(builder, TextThOffset);
    ...
    ScenarioScriptGroup3Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptGroup3Excel.EndScenarioScriptGroup3Excel(builder);
  }

  public static void StartScenarioScriptGroup3Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptGroup3Excel> EndScenarioScriptGroup3Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptGroup3Excel>(o);
  }
}
