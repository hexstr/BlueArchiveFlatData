...
public struct InformationStrategyObjectExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.InformationStrategyObjectExcel> CreateInformationStrategyObjectExcel(FlatBufferBuilder builder,
      long Id = 0,
      long StageId = 0,
  ...
  public static Offset<FlatDataGlobal.InformationStrategyObjectExcel> EndInformationStrategyObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.InformationStrategyObjectExcel>(o);
  }
}
