...
public struct ShopFreeRecruitExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.ShopFreeRecruitType FreeRecruitType { get { int o = __p.__offset(10); return o != 0 ? (FlatDataGlobal.ShopFreeRecruitType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ShopFreeRecruitType.None; } }
  ...
  public static Offset<FlatDataGlobal.ShopFreeRecruitExcel> CreateShopFreeRecruitExcel(FlatBufferBuilder builder,
      long Id = 0,
      StringOffset FreeRecruitPeriodFromOffset = default(StringOffset),
      StringOffset FreeRecruitPeriodToOffset = default(StringOffset),
      FlatDataGlobal.ShopFreeRecruitType FreeRecruitType = FlatDataGlobal.ShopFreeRecruitType.None,
  ...
  public static void AddFreeRecruitType(FlatBufferBuilder builder, FlatDataGlobal.ShopFreeRecruitType FreeRecruitType) { builder.AddInt(3, (int)FreeRecruitType, 0); }
  ...
  public static Offset<FlatDataGlobal.ShopFreeRecruitExcel> EndShopFreeRecruitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ShopFreeRecruitExcel>(o);
  }
}
