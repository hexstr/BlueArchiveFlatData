...
public struct EventContentPlayGuideExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.EventContentPlayGuideExcel> CreateEventContentPlayGuideExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataGlobal.EventContentPlayGuideExcel> EndEventContentPlayGuideExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.EventContentPlayGuideExcel>(o);
  }
}
