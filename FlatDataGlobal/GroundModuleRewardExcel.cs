...
public struct GroundModuleRewardExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.ParcelType RewardParcelType { get { int o = __p.__offset(6); return o != 0 ? (FlatDataGlobal.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ParcelType.None; } }
  ...
  public static Offset<FlatDataGlobal.GroundModuleRewardExcel> CreateGroundModuleRewardExcel(FlatBufferBuilder builder,
      uint GroupId = 0,
  ...
  public static void AddRewardParcelType(FlatBufferBuilder builder, FlatDataGlobal.ParcelType RewardParcelType) { builder.AddInt(1, (int)RewardParcelType, 0); }
  ...
  public static Offset<FlatDataGlobal.GroundModuleRewardExcel> EndGroundModuleRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.GroundModuleRewardExcel>(o);
  }
}
