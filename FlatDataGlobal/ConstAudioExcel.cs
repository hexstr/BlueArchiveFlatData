...
public struct ConstAudioExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.ConstAudioExcel> CreateConstAudioExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataGlobal.ConstAudioExcel> EndConstAudioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ConstAudioExcel>(o);
  }
}
