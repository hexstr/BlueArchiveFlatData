...
public struct FixedStrategyExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.FixedStrategyExcel> CreateFixedStrategyExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataGlobal.FixedStrategyExcel> EndFixedStrategyExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.FixedStrategyExcel>(o);
  }
}
