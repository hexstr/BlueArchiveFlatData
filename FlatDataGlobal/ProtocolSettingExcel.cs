...
public struct ProtocolSettingExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.ContentLockType Contentlocktype { get { int o = __p.__offset(6); return o != 0 ? (FlatDataGlobal.ContentLockType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ContentLockType.None; } }
  public FlatDataGlobal.OpenConditionContent Openconditioncontent { get { int o = __p.__offset(8); return o != 0 ? (FlatDataGlobal.OpenConditionContent)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.OpenConditionContent.Shop; } }
  ...
  public static void AddContentlocktype(FlatBufferBuilder builder, FlatDataGlobal.ContentLockType contentlocktype) { builder.AddInt(1, (int)contentlocktype, 0); }
  public static void AddOpenconditioncontent(FlatBufferBuilder builder, FlatDataGlobal.OpenConditionContent openconditioncontent) { builder.AddInt(2, (int)openconditioncontent, 0); }
