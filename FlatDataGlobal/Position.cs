...
public struct Position : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.Position> CreatePosition(FlatBufferBuilder builder,
      float X = 0.0f,
      float Z = 0.0f) {
  ...
  public static Offset<FlatDataGlobal.Position> EndPosition(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.Position>(o);
  }
}
