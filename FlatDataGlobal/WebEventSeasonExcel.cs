...
public struct WebEventSeasonExcel : IFlatbufferObject
{
  ...
  public bool IsFull { get { int o = __p.__offset(8); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public bool UseExternalBrowser { get { int o = __p.__offset(10); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  ...
  public string LobbyBannerImage { get { int o = __p.__offset(16); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetLobbyBannerImageBytes() { return __p.__vector_as_span<byte>(16, 1); }
#else
  public ArraySegment<byte>? GetLobbyBannerImageBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public byte[] GetLobbyBannerImageArray() { return __p.__vector_as_array<byte>(16); }
  public string PopupTitleLocalizeKey { get { int o = __p.__offset(18); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetPopupTitleLocalizeKeyBytes() { return __p.__vector_as_span<byte>(18, 1); }
#else
  public ArraySegment<byte>? GetPopupTitleLocalizeKeyBytes() { return __p.__vector_as_arraysegment(18); }
#endif
  public byte[] GetPopupTitleLocalizeKeyArray() { return __p.__vector_as_array<byte>(18); }
  public string StageEventUrl { get { int o = __p.__offset(20); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetStageEventUrlBytes() { return __p.__vector_as_span<byte>(20, 1); }
#else
  public ArraySegment<byte>? GetStageEventUrlBytes() { return __p.__vector_as_arraysegment(20); }
#endif
  public byte[] GetStageEventUrlArray() { return __p.__vector_as_array<byte>(20); }
  public string LiveEventUrl { get { int o = __p.__offset(22); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetLiveEventUrlBytes() { return __p.__vector_as_span<byte>(22, 1); }
#else
  public ArraySegment<byte>? GetLiveEventUrlBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public byte[] GetLiveEventUrlArray() { return __p.__vector_as_array<byte>(22); }
  ...
  public static void StartWebEventSeasonExcel(FlatBufferBuilder builder) { builder.StartTable(10); }
  public static void AddId(FlatBufferBuilder builder, long Id) { builder.AddLong(0, Id, 0); }
  public static void AddEnabled(FlatBufferBuilder builder, bool Enabled) { builder.AddBool(1, Enabled, false); }
  public static void AddIsFull(FlatBufferBuilder builder, bool IsFull) { builder.AddBool(2, IsFull, false); }
  public static void AddUseExternalBrowser(FlatBufferBuilder builder, bool UseExternalBrowser) { builder.AddBool(3, UseExternalBrowser, false); }
  ...
  public static void AddLobbyBannerImage(FlatBufferBuilder builder, StringOffset LobbyBannerImageOffset) { builder.AddOffset(6, LobbyBannerImageOffset.Value, 0); }
  public static void AddPopupTitleLocalizeKey(FlatBufferBuilder builder, StringOffset PopupTitleLocalizeKeyOffset) { builder.AddOffset(7, PopupTitleLocalizeKeyOffset.Value, 0); }
  public static void AddStageEventUrl(FlatBufferBuilder builder, StringOffset StageEventUrlOffset) { builder.AddOffset(8, StageEventUrlOffset.Value, 0); }
  public static void AddLiveEventUrl(FlatBufferBuilder builder, StringOffset LiveEventUrlOffset) { builder.AddOffset(9, LiveEventUrlOffset.Value, 0); }
