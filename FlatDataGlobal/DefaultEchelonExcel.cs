...
public struct DefaultEchelonExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.DefaultEchelonExcel> CreateDefaultEchelonExcel(FlatBufferBuilder builder,
      int EchlonId = 0,
      long LeaderId = 0,
  ...
  public static Offset<FlatDataGlobal.DefaultEchelonExcel> EndDefaultEchelonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.DefaultEchelonExcel>(o);
  }
}
