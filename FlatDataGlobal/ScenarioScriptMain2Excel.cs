...
public struct ScenarioScriptMain2Excel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_3_3(); }
  public static ScenarioScriptMain2Excel GetRootAsScenarioScriptMain2Excel(ByteBuffer _bb) { return GetRootAsScenarioScriptMain2Excel(_bb, new ScenarioScriptMain2Excel()); }
  public static ScenarioScriptMain2Excel GetRootAsScenarioScriptMain2Excel(ByteBuffer _bb, ScenarioScriptMain2Excel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ScenarioScriptMain2Excel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptMain2Excel> CreateScenarioScriptMain2Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptMain2Excel.AddBGMId(builder, BGMId);
    ScenarioScriptMain2Excel.AddSelectionGroup(builder, SelectionGroup);
    ScenarioScriptMain2Excel.AddGroupId(builder, GroupId);
    ScenarioScriptMain2Excel.AddVoiceJp(builder, VoiceJpOffset);
    ScenarioScriptMain2Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptMain2Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptMain2Excel.AddTextTh(builder, TextThOffset);
    ScenarioScriptMain2Excel.AddTextJp(builder, TextJpOffset);
    ScenarioScriptMain2Excel.AddScriptKr(builder, ScriptKrOffset);
    ScenarioScriptMain2Excel.AddPopupFileName(builder, PopupFileNameOffset);
    ScenarioScriptMain2Excel.AddBGEffect(builder, BGEffect);
    ScenarioScriptMain2Excel.AddBGName(builder, BGName);
    ScenarioScriptMain2Excel.AddTransition(builder, Transition);
    ScenarioScriptMain2Excel.AddSound(builder, SoundOffset);
    ScenarioScriptMain2Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptMain2Excel.EndScenarioScriptMain2Excel(builder);
  }

  public static void StartScenarioScriptMain2Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptMain2Excel> EndScenarioScriptMain2Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptMain2Excel>(o);
  }
}
