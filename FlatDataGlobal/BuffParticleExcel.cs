...
public struct BuffParticleExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.BuffParticleExcel> CreateBuffParticleExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<FlatDataGlobal.BuffParticleExcel> EndBuffParticleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.BuffParticleExcel>(o);
  }
}
