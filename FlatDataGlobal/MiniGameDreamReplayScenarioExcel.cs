...
public struct MiniGameDreamReplayScenarioExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.MiniGameDreamReplayScenarioExcel> CreateMiniGameDreamReplayScenarioExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataGlobal.MiniGameDreamReplayScenarioExcel> EndMiniGameDreamReplayScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.MiniGameDreamReplayScenarioExcel>(o);
  }
}
