...
public struct VoiceTimelineExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.VoiceTimelineExcel> CreateVoiceTimelineExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      uint Id = 0,
  ...
  public static Offset<FlatDataGlobal.VoiceTimelineExcel> EndVoiceTimelineExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.VoiceTimelineExcel>(o);
  }
}
