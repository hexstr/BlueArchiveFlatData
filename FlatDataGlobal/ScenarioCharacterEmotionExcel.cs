...
public struct ScenarioCharacterEmotionExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.ScenarioCharacterEmotionExcel> CreateScenarioCharacterEmotionExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataGlobal.ScenarioCharacterEmotionExcel> EndScenarioCharacterEmotionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioCharacterEmotionExcel>(o);
  }
}
