...
public struct EventContentLobbyMenuExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.EventContentLobbyMenuExcel> EndEventContentLobbyMenuExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.EventContentLobbyMenuExcel>(o);
  }
}
