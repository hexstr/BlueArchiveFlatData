...
public struct EventContentSeasonExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.EventContentReleaseType EventContentReleaseType { get { int o = __p.__offset(70); return o != 0 ? (FlatDataGlobal.EventContentReleaseType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.EventContentReleaseType.None; } }
  public long EventContentStageRewardIdPermanent { get { int o = __p.__offset(72); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public FlatDataGlobal.RewardTag RewardTagPermanent { get { int o = __p.__offset(74); return o != 0 ? (FlatDataGlobal.RewardTag)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.RewardTag.Default; } }
  ...
  public static void AddEventContentReleaseType(FlatBufferBuilder builder, FlatDataGlobal.EventContentReleaseType eventContentReleaseType) { builder.AddInt(33, (int)eventContentReleaseType, 0); }
  ...
  public static void AddRewardTagPermanent(FlatBufferBuilder builder, FlatDataGlobal.RewardTag RewardTagPermanent) { builder.AddInt(35, (int)RewardTagPermanent, 0); }
