...
public struct FieldInteractionExcel : IFlatbufferObject
{
...
#if ENABLE_SPAN_T
  public Span<FlatDataGlobal.FieldInteractionType> GetInteractionTypeBytes() { return __p.__vector_as_span<FlatDataGlobal.FieldInteractionType>(14, 4); }
#else
  public ArraySegment<byte>? GetInteractionTypeBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public FlatDataGlobal.FieldInteractionType[] GetInteractionTypeArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataGlobal.FieldInteractionType[] a = new FlatDataGlobal.FieldInteractionType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataGlobal.FieldInteractionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public FlatDataGlobal.FieldConditionClass ConditionClass { get { int o = __p.__offset(18); return o != 0 ? (FlatDataGlobal.FieldConditionClass)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.FieldConditionClass.AndOr; } }
  ...
  public FlatDataGlobal.FieldConditionType ConditionType(int j) { int o = __p.__offset(26); return o != 0 ? (FlatDataGlobal.FieldConditionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataGlobal.FieldConditionType)0; }
  public int ConditionTypeLength { get { int o = __p.__offset(26); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataGlobal.FieldConditionType> GetConditionTypeBytes() { return __p.__vector_as_span<FlatDataGlobal.FieldConditionType>(26, 4); }
#else
  ...
  public static VectorOffset CreateInteractionTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatDataGlobal.FieldInteractionType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateInteractionTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatDataGlobal.FieldInteractionType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddConditionClass(FlatBufferBuilder builder, FlatDataGlobal.FieldConditionClass ConditionClass) { builder.AddInt(7, (int)ConditionClass, 0); }
  ...
  public static Offset<FlatDataGlobal.FieldInteractionExcel> EndFieldInteractionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.FieldInteractionExcel>(o);
  }
}
