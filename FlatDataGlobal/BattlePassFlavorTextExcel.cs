...
public struct BattlePassFlavorTextExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.BattlePassFlavorTextExcel> CreateBattlePassFlavorTextExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      long Id = 0,
  ...
  public static Offset<FlatDataGlobal.BattlePassFlavorTextExcel> EndBattlePassFlavorTextExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.BattlePassFlavorTextExcel>(o);
  }
}
