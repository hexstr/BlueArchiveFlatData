...
public struct ScenarioScriptFavor5Excel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_3_3(); }
  public static ScenarioScriptFavor5Excel GetRootAsScenarioScriptFavor5Excel(ByteBuffer _bb) { return GetRootAsScenarioScriptFavor5Excel(_bb, new ScenarioScriptFavor5Excel()); }
  public static ScenarioScriptFavor5Excel GetRootAsScenarioScriptFavor5Excel(ByteBuffer _bb, ScenarioScriptFavor5Excel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ScenarioScriptFavor5Excel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptFavor5Excel> CreateScenarioScriptFavor5Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptFavor5Excel.AddBGMId(builder, BGMId);
    ScenarioScriptFavor5Excel.AddSelectionGroup(builder, SelectionGroup);
    ScenarioScriptFavor5Excel.AddGroupId(builder, GroupId);
    ScenarioScriptFavor5Excel.AddVoiceJp(builder, VoiceJpOffset);
    ScenarioScriptFavor5Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptFavor5Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptFavor5Excel.AddTextTh(builder, TextThOffset);
    ScenarioScriptFavor5Excel.AddTextJp(builder, TextJpOffset);
    ScenarioScriptFavor5Excel.AddScriptKr(builder, ScriptKrOffset);
    ScenarioScriptFavor5Excel.AddPopupFileName(builder, PopupFileNameOffset);
    ScenarioScriptFavor5Excel.AddBGEffect(builder, BGEffect);
    ScenarioScriptFavor5Excel.AddBGName(builder, BGName);
    ScenarioScriptFavor5Excel.AddTransition(builder, Transition);
    ScenarioScriptFavor5Excel.AddSound(builder, SoundOffset);
    ScenarioScriptFavor5Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptFavor5Excel.EndScenarioScriptFavor5Excel(builder);
  }

  public static void StartScenarioScriptFavor5Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptFavor5Excel> EndScenarioScriptFavor5Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptFavor5Excel>(o);
  }
}
