...
public struct CharacterDialogEmojiExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.CharacterDialogEmojiExcel> CreateCharacterDialogEmojiExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      int TargetIndex = 0,
  ...
  public static Offset<FlatDataGlobal.CharacterDialogEmojiExcel> EndCharacterDialogEmojiExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.CharacterDialogEmojiExcel>(o);
  }
}
