...
public struct EventContentExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.EventContentExcel> CreateEventContentExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataGlobal.EventContentExcel> EndEventContentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.EventContentExcel>(o);
  }
}
