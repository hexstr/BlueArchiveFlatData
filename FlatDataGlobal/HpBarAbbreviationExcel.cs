...
public struct HpBarAbbreviationExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.HpBarAbbreviationExcel> CreateHpBarAbbreviationExcel(FlatBufferBuilder builder,
      int MonsterLv = 0,
      int StandardHpBar = 0,
      int RaidBossHpBar = 0) {
  ...
  public static Offset<FlatDataGlobal.HpBarAbbreviationExcel> EndHpBarAbbreviationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.HpBarAbbreviationExcel>(o);
  }
}
