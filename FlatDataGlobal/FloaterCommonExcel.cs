...
public struct FloaterCommonExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.FloaterCommonExcel> EndFloaterCommonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.FloaterCommonExcel>(o);
  }
}
