...
public struct MiniGameDreamCollectionScenarioExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.DreamMakerParameterType Parameter(int j) { int o = __p.__offset(10); return o != 0 ? (FlatDataGlobal.DreamMakerParameterType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataGlobal.DreamMakerParameterType)0; }
  public int ParameterLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataGlobal.DreamMakerParameterType> GetParameterBytes() { return __p.__vector_as_span<FlatDataGlobal.DreamMakerParameterType>(10, 4); }
#else
  ...
  public static Offset<FlatDataGlobal.MiniGameDreamCollectionScenarioExcel> CreateMiniGameDreamCollectionScenarioExcel(FlatBufferBuilder builder,
      long Id = 0,
      bool IsSkip = false,
  ...
  public static VectorOffset CreateParameterVector(FlatBufferBuilder builder, FlatDataGlobal.DreamMakerParameterType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateParameterVectorBlock(FlatBufferBuilder builder, FlatDataGlobal.DreamMakerParameterType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateParameterVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatDataGlobal.DreamMakerParameterType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateParameterVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatDataGlobal.DreamMakerParameterType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatDataGlobal.MiniGameDreamCollectionScenarioExcel> EndMiniGameDreamCollectionScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.MiniGameDreamCollectionScenarioExcel>(o);
  }
}
