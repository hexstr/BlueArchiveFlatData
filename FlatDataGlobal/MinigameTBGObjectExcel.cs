...
public struct MinigameTBGObjectExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.TBGObjectType ObjectType { get { int o = __p.__offset(10); return o != 0 ? (FlatDataGlobal.TBGObjectType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.TBGObjectType.None; } }
  public FlatDataGlobal.ParcelType ObjectCostType { get { int o = __p.__offset(12); return o != 0 ? (FlatDataGlobal.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ParcelType.None; } }
  ...
  public static Offset<FlatDataGlobal.MinigameTBGObjectExcel> CreateMinigameTBGObjectExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      ...
      FlatDataGlobal.ParcelType ObjectCostType = FlatDataGlobal.ParcelType.None,
      long ObjectCostId = 0,
  ...
  public static void AddObjectType(FlatBufferBuilder builder, FlatDataGlobal.TBGObjectType ObjectType) { builder.AddInt(3, (int)ObjectType, 0); }
  public static void AddObjectCostType(FlatBufferBuilder builder, FlatDataGlobal.ParcelType ObjectCostType) { builder.AddInt(4, (int)ObjectCostType, 0); }
  ...
  public static Offset<FlatDataGlobal.MinigameTBGObjectExcel> EndMinigameTBGObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.MinigameTBGObjectExcel>(o);
  }
}
