...
public struct ScenarioBGNameExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.ScenarioBGType BGType { get { int o = __p.__offset(10); return o != 0 ? (FlatDataGlobal.ScenarioBGType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ScenarioBGType.None; } }
  ...
  public static Offset<FlatDataGlobal.ScenarioBGNameExcel> CreateScenarioBGNameExcel(FlatBufferBuilder builder,
      uint Name = 0,
      ...
      FlatDataGlobal.ScenarioBGType BGType = FlatDataGlobal.ScenarioBGType.None,
  ...
  public static void AddBGType(FlatBufferBuilder builder, FlatDataGlobal.ScenarioBGType BGType) { builder.AddInt(3, (int)BGType, 0); }
  ...
  public static Offset<FlatDataGlobal.ScenarioBGNameExcel> EndScenarioBGNameExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioBGNameExcel>(o);
  }
}
