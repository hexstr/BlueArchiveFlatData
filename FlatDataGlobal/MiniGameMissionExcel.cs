...
public struct MiniGameMissionExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.Tag CompleteConditionParameterTag(int j) { int o = __p.__offset(42); return o != 0 ? (FlatDataGlobal.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataGlobal.Tag)0; }
  public int CompleteConditionParameterTagLength { get { int o = __p.__offset(42); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataGlobal.Tag> GetCompleteConditionParameterTagBytes() { return __p.__vector_as_span<FlatDataGlobal.Tag>(42, 4); }
#else
  public ArraySegment<byte>? GetCompleteConditionParameterTagBytes() { return __p.__vector_as_arraysegment(42); }
#endif
  public FlatDataGlobal.Tag[] GetCompleteConditionParameterTagArray() { int o = __p.__offset(42); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataGlobal.Tag[] a = new FlatDataGlobal.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataGlobal.Tag)__p.bb.GetInt(p + i * 4); } return a; }
