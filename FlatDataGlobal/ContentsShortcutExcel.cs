...
public struct ContentsShortcutExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.StageDifficulty ConquestMapDifficulty { get { int o = __p.__offset(20); return o != 0 ? (FlatDataGlobal.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.StageDifficulty.None; } }
  ...
  public static Offset<FlatDataGlobal.ContentsShortcutExcel> CreateContentsShortcutExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      ...
      FlatDataGlobal.StageDifficulty ConquestMapDifficulty = FlatDataGlobal.StageDifficulty.None,
  ...
  public static void AddConquestMapDifficulty(FlatBufferBuilder builder, FlatDataGlobal.StageDifficulty ConquestMapDifficulty) { builder.AddInt(8, (int)ConquestMapDifficulty, 0); }
  ...
  public static Offset<FlatDataGlobal.ContentsShortcutExcel> EndContentsShortcutExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ContentsShortcutExcel>(o);
  }
}
