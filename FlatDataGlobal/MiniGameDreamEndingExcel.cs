...
public struct MiniGameDreamEndingExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.DreamMakerEndingType DreamMakerEndingType { get { int o = __p.__offset(8); return o != 0 ? (FlatDataGlobal.DreamMakerEndingType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.DreamMakerEndingType.None; } }
  ...
  public FlatDataGlobal.DreamMakerEndingCondition EndingCondition(int j) { int o = __p.__offset(14); return o != 0 ? (FlatDataGlobal.DreamMakerEndingCondition)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataGlobal.DreamMakerEndingCondition)0; }
  public int EndingConditionLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataGlobal.DreamMakerEndingCondition> GetEndingConditionBytes() { return __p.__vector_as_span<FlatDataGlobal.DreamMakerEndingCondition>(14, 4); }
#else
  public ArraySegment<byte>? GetEndingConditionBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public FlatDataGlobal.DreamMakerEndingCondition[] GetEndingConditionArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataGlobal.DreamMakerEndingCondition[] a = new FlatDataGlobal.DreamMakerEndingCondition[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataGlobal.DreamMakerEndingCondition)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatDataGlobal.MiniGameDreamEndingExcel> CreateMiniGameDreamEndingExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long EndingId = 0,
      FlatDataGlobal.DreamMakerEndingType dreamMakerEndingType = FlatDataGlobal.DreamMakerEndingType.None,
      int Order = 0,
  ...
  public static void AddDreamMakerEndingType(FlatBufferBuilder builder, FlatDataGlobal.DreamMakerEndingType dreamMakerEndingType) { builder.AddInt(2, (int)dreamMakerEndingType, 0); }
  ...
  public static VectorOffset CreateEndingConditionVector(FlatBufferBuilder builder, FlatDataGlobal.DreamMakerEndingCondition[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateEndingConditionVectorBlock(FlatBufferBuilder builder, FlatDataGlobal.DreamMakerEndingCondition[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEndingConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatDataGlobal.DreamMakerEndingCondition> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEndingConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatDataGlobal.DreamMakerEndingCondition>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatDataGlobal.MiniGameDreamEndingExcel> EndMiniGameDreamEndingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.MiniGameDreamEndingExcel>(o);
  }
}
