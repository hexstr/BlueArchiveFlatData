...
public struct MiniGameDreamInfoExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.DreamMakerMultiplierCondition DreamMakerMultiplierCondition { get { int o = __p.__offset(6); return o != 0 ? (FlatDataGlobal.DreamMakerMultiplierCondition)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.DreamMakerMultiplierCondition.None; } }
  ...
  public FlatDataGlobal.ParcelType DreamMakerParcelType { get { int o = __p.__offset(16); return o != 0 ? (FlatDataGlobal.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ParcelType.None; } }
  public long DreamMakerParcelId { get { int o = __p.__offset(18); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public FlatDataGlobal.ParcelType DreamMakerDailyPointParcelType { get { int o = __p.__offset(20); return o != 0 ? (FlatDataGlobal.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ParcelType.None; } }
  ...
  public static Offset<FlatDataGlobal.MiniGameDreamInfoExcel> CreateMiniGameDreamInfoExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      FlatDataGlobal.DreamMakerMultiplierCondition dreamMakerMultiplierCondition = FlatDataGlobal.DreamMakerMultiplierCondition.None,
      long DreamMakerMultiplierConditionValue = 0,
      long DreamMakerMultiplierMax = 0,
      long DreamMakerDays = 0,
      long DreamMakerActionPoint = 0,
      FlatDataGlobal.ParcelType DreamMakerParcelType = FlatDataGlobal.ParcelType.None,
      long DreamMakerParcelId = 0,
      FlatDataGlobal.ParcelType DreamMakerDailyPointParcelType = FlatDataGlobal.ParcelType.None,
  ...
  public static void AddDreamMakerMultiplierCondition(FlatBufferBuilder builder, FlatDataGlobal.DreamMakerMultiplierCondition dreamMakerMultiplierCondition) { builder.AddInt(1, (int)dreamMakerMultiplierCondition, 0); }
  ...
  public static void AddDreamMakerParcelType(FlatBufferBuilder builder, FlatDataGlobal.ParcelType DreamMakerParcelType) { builder.AddInt(6, (int)DreamMakerParcelType, 0); }
  ...
  public static void AddDreamMakerDailyPointParcelType(FlatBufferBuilder builder, FlatDataGlobal.ParcelType DreamMakerDailyPointParcelType) { builder.AddInt(8, (int)DreamMakerDailyPointParcelType, 0); }
  ...
  public static Offset<FlatDataGlobal.MiniGameDreamInfoExcel> EndMiniGameDreamInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.MiniGameDreamInfoExcel>(o);
  }
}
