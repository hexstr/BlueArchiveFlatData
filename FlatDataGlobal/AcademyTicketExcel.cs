...
public struct AcademyTicketExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.AcademyTicketExcel> CreateAcademyTicketExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataGlobal.AcademyTicketExcel> EndAcademyTicketExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.AcademyTicketExcel>(o);
  }
}
