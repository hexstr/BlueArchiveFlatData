...
public struct CharacterPotentialStatExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.CharacterPotentialStatExcel> CreateCharacterPotentialStatExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataGlobal.CharacterPotentialStatExcel> EndCharacterPotentialStatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.CharacterPotentialStatExcel>(o);
  }
}
