...
public struct ScenarioScriptMain1Excel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_1_21(); }
  public static ScenarioScriptMain1Excel GetRootAsScenarioScriptMain1Excel(ByteBuffer _bb) { return GetRootAsScenarioScriptMain1Excel(_bb, new ScenarioScriptMain1Excel()); }
  public static ScenarioScriptMain1Excel GetRootAsScenarioScriptMain1Excel(ByteBuffer _bb, ScenarioScriptMain1Excel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ScenarioScriptMain1Excel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptMain1Excel> CreateScenarioScriptMain1Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptMain1Excel.AddBGMId(builder, BGMId);
    ScenarioScriptMain1Excel.AddSelectionGroup(builder, SelectionGroup);
    ScenarioScriptMain1Excel.AddGroupId(builder, GroupId);
    ScenarioScriptMain1Excel.AddVoiceJp(builder, VoiceJpOffset);
    ScenarioScriptMain1Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptMain1Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptMain1Excel.AddTextTh(builder, TextThOffset);
    ScenarioScriptMain1Excel.AddTextJp(builder, TextJpOffset);
    ScenarioScriptMain1Excel.AddScriptKr(builder, ScriptKrOffset);
    ScenarioScriptMain1Excel.AddPopupFileName(builder, PopupFileNameOffset);
    ScenarioScriptMain1Excel.AddBGEffect(builder, BGEffect);
    ScenarioScriptMain1Excel.AddBGName(builder, BGName);
    ScenarioScriptMain1Excel.AddTransition(builder, Transition);
    ScenarioScriptMain1Excel.AddSound(builder, SoundOffset);
    ScenarioScriptMain1Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptMain1Excel.EndScenarioScriptMain1Excel(builder);
  }

  public static void StartScenarioScriptMain1Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptMain1Excel> EndScenarioScriptMain1Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptMain1Excel>(o);
  }
}
