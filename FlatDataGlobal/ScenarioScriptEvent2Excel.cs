...
public struct ScenarioScriptEvent2Excel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_1_21(); }
  public static ScenarioScriptEvent2Excel GetRootAsScenarioScriptEvent2Excel(ByteBuffer _bb) { return GetRootAsScenarioScriptEvent2Excel(_bb, new ScenarioScriptEvent2Excel()); }
  public static ScenarioScriptEvent2Excel GetRootAsScenarioScriptEvent2Excel(ByteBuffer _bb, ScenarioScriptEvent2Excel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ScenarioScriptEvent2Excel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptEvent2Excel> CreateScenarioScriptEvent2Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptEvent2Excel.AddBGMId(builder, BGMId);
    ScenarioScriptEvent2Excel.AddSelectionGroup(builder, SelectionGroup);
    ScenarioScriptEvent2Excel.AddGroupId(builder, GroupId);
    ScenarioScriptEvent2Excel.AddVoiceJp(builder, VoiceJpOffset);
    ScenarioScriptEvent2Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptEvent2Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptEvent2Excel.AddTextTh(builder, TextThOffset);
    ScenarioScriptEvent2Excel.AddTextJp(builder, TextJpOffset);
    ScenarioScriptEvent2Excel.AddScriptKr(builder, ScriptKrOffset);
    ScenarioScriptEvent2Excel.AddPopupFileName(builder, PopupFileNameOffset);
    ScenarioScriptEvent2Excel.AddBGEffect(builder, BGEffect);
    ScenarioScriptEvent2Excel.AddBGName(builder, BGName);
    ScenarioScriptEvent2Excel.AddTransition(builder, Transition);
    ScenarioScriptEvent2Excel.AddSound(builder, SoundOffset);
    ScenarioScriptEvent2Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptEvent2Excel.EndScenarioScriptEvent2Excel(builder);
  }

  public static void StartScenarioScriptEvent2Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptEvent2Excel> EndScenarioScriptEvent2Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptEvent2Excel>(o);
  }
}
