...
public struct ScenarioScriptEvent5Excel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_3_3(); }
  public static ScenarioScriptEvent5Excel GetRootAsScenarioScriptEvent5Excel(ByteBuffer _bb) { return GetRootAsScenarioScriptEvent5Excel(_bb, new ScenarioScriptEvent5Excel()); }
  public static ScenarioScriptEvent5Excel GetRootAsScenarioScriptEvent5Excel(ByteBuffer _bb, ScenarioScriptEvent5Excel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ScenarioScriptEvent5Excel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptEvent5Excel> CreateScenarioScriptEvent5Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptEvent5Excel.AddBGMId(builder, BGMId);
    ScenarioScriptEvent5Excel.AddSelectionGroup(builder, SelectionGroup);
    ScenarioScriptEvent5Excel.AddGroupId(builder, GroupId);
    ScenarioScriptEvent5Excel.AddVoiceJp(builder, VoiceJpOffset);
    ScenarioScriptEvent5Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptEvent5Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptEvent5Excel.AddTextTh(builder, TextThOffset);
    ScenarioScriptEvent5Excel.AddTextJp(builder, TextJpOffset);
    ScenarioScriptEvent5Excel.AddScriptKr(builder, ScriptKrOffset);
    ScenarioScriptEvent5Excel.AddPopupFileName(builder, PopupFileNameOffset);
    ScenarioScriptEvent5Excel.AddBGEffect(builder, BGEffect);
    ScenarioScriptEvent5Excel.AddBGName(builder, BGName);
    ScenarioScriptEvent5Excel.AddTransition(builder, Transition);
    ScenarioScriptEvent5Excel.AddSound(builder, SoundOffset);
    ScenarioScriptEvent5Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptEvent5Excel.EndScenarioScriptEvent5Excel(builder);
  }

  public static void StartScenarioScriptEvent5Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptEvent5Excel> EndScenarioScriptEvent5Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptEvent5Excel>(o);
  }
}
