...
public struct ScenarioScriptFavor3Excel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_1_21(); }
  public static ScenarioScriptFavor3Excel GetRootAsScenarioScriptFavor3Excel(ByteBuffer _bb) { return GetRootAsScenarioScriptFavor3Excel(_bb, new ScenarioScriptFavor3Excel()); }
  public static ScenarioScriptFavor3Excel GetRootAsScenarioScriptFavor3Excel(ByteBuffer _bb, ScenarioScriptFavor3Excel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ScenarioScriptFavor3Excel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptFavor3Excel> CreateScenarioScriptFavor3Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptFavor3Excel.AddBGMId(builder, BGMId);
    ScenarioScriptFavor3Excel.AddSelectionGroup(builder, SelectionGroup);
    ScenarioScriptFavor3Excel.AddGroupId(builder, GroupId);
    ScenarioScriptFavor3Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptFavor3Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptFavor3Excel.AddTextTh(builder, TextThOffset);
    ScenarioScriptFavor3Excel.AddVoiceJp(builder, VoiceJpOffset);
    ScenarioScriptFavor3Excel.AddTextJp(builder, TextJpOffset);
    ScenarioScriptFavor3Excel.AddScriptKr(builder, ScriptKrOffset);
    ScenarioScriptFavor3Excel.AddPopupFileName(builder, PopupFileNameOffset);
    ScenarioScriptFavor3Excel.AddBGEffect(builder, BGEffect);
    ScenarioScriptFavor3Excel.AddBGName(builder, BGName);
    ScenarioScriptFavor3Excel.AddTransition(builder, Transition);
    ScenarioScriptFavor3Excel.AddSound(builder, SoundOffset);
    ScenarioScriptFavor3Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptFavor3Excel.EndScenarioScriptFavor3Excel(builder);
  }

  public static void StartScenarioScriptFavor3Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptFavor3Excel> EndScenarioScriptFavor3Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptFavor3Excel>(o);
  }
}
