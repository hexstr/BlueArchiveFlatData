...
public struct MinigameCCGCardExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.CCGCardType Type { get { int o = __p.__offset(6); return o != 0 ? (FlatDataGlobal.CCGCardType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.CCGCardType.None; } }
  ...
  public static Offset<FlatDataGlobal.MinigameCCGCardExcel> CreateMinigameCCGCardExcel(FlatBufferBuilder builder,
      long Id = 0,
      FlatDataGlobal.CCGCardType Type = FlatDataGlobal.CCGCardType.None,
  ...
  public static void AddType(FlatBufferBuilder builder, FlatDataGlobal.CCGCardType Type) { builder.AddInt(1, (int)Type, 0); }
  ...
  public static Offset<FlatDataGlobal.MinigameCCGCardExcel> EndMinigameCCGCardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.MinigameCCGCardExcel>(o);
  }
}
