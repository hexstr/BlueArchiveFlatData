...
public struct VideoExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.VideoExcel> CreateVideoExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataGlobal.VideoExcel> EndVideoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.VideoExcel>(o);
  }
}
