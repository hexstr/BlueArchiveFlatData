...
public struct ConstStrategyExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.CurrencyTypes HealCostType { get { int o = __p.__offset(14); return o != 0 ? (FlatDataGlobal.CurrencyTypes)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.CurrencyTypes.Invalid; } }
  ...
  public static Offset<FlatDataGlobal.ConstStrategyExcel> CreateConstStrategyExcel(FlatBufferBuilder builder,
      ...
      FlatDataGlobal.CurrencyTypes HealCostType = FlatDataGlobal.CurrencyTypes.Invalid,
  ...
  public static void AddHealCostType(FlatBufferBuilder builder, FlatDataGlobal.CurrencyTypes HealCostType) { builder.AddInt(5, (int)HealCostType, 0); }
