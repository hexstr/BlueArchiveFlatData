...
public struct MiniGameTBGRewardExcel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_3_3(); }
  public static MiniGameTBGRewardExcel GetRootAsMiniGameTBGRewardExcel(ByteBuffer _bb) { return GetRootAsMiniGameTBGRewardExcel(_bb, new MiniGameTBGRewardExcel()); }
  public static MiniGameTBGRewardExcel GetRootAsMiniGameTBGRewardExcel(ByteBuffer _bb, MiniGameTBGRewardExcel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public MiniGameTBGRewardExcel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.MiniGameTBGRewardExcel> CreateMiniGameTBGRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      long RewardId = 0,
      long ClearSection = 0,
    ...
    MiniGameTBGRewardExcel.AddClearSection(builder, ClearSection);
    MiniGameTBGRewardExcel.AddRewardId(builder, RewardId);
    MiniGameTBGRewardExcel.AddGroupId(builder, GroupId);
    MiniGameTBGRewardExcel.AddRewardParcelAmount(builder, RewardParcelAmountOffset);
    MiniGameTBGRewardExcel.AddRewardParcelId(builder, RewardParcelIdOffset);
    MiniGameTBGRewardExcel.AddRewardParcelType(builder, RewardParcelTypeOffset);
    return MiniGameTBGRewardExcel.EndMiniGameTBGRewardExcel(builder);
  }

  public static void StartMiniGameTBGRewardExcel(FlatBufferBuilder builder) { builder.StartTable(6); }
  ...
  public static Offset<FlatDataGlobal.MiniGameTBGRewardExcel> EndMiniGameTBGRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.MiniGameTBGRewardExcel>(o);
  }
}
