...
public struct ScenarioScriptFavor1Excel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_1_21(); }
  public static ScenarioScriptFavor1Excel GetRootAsScenarioScriptFavor1Excel(ByteBuffer _bb) { return GetRootAsScenarioScriptFavor1Excel(_bb, new ScenarioScriptFavor1Excel()); }
  public static ScenarioScriptFavor1Excel GetRootAsScenarioScriptFavor1Excel(ByteBuffer _bb, ScenarioScriptFavor1Excel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ScenarioScriptFavor1Excel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptFavor1Excel> CreateScenarioScriptFavor1Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptFavor1Excel.AddBGMId(builder, BGMId);
    ScenarioScriptFavor1Excel.AddSelectionGroup(builder, SelectionGroup);
    ScenarioScriptFavor1Excel.AddGroupId(builder, GroupId);
    ScenarioScriptFavor1Excel.AddVoiceJp(builder, VoiceJpOffset);
    ScenarioScriptFavor1Excel.AddTextEn(builder, TextEnOffset);
    ScenarioScriptFavor1Excel.AddTextTw(builder, TextTwOffset);
    ScenarioScriptFavor1Excel.AddTextTh(builder, TextThOffset);
    ScenarioScriptFavor1Excel.AddTextJp(builder, TextJpOffset);
    ScenarioScriptFavor1Excel.AddScriptKr(builder, ScriptKrOffset);
    ScenarioScriptFavor1Excel.AddPopupFileName(builder, PopupFileNameOffset);
    ScenarioScriptFavor1Excel.AddBGEffect(builder, BGEffect);
    ScenarioScriptFavor1Excel.AddBGName(builder, BGName);
    ScenarioScriptFavor1Excel.AddTransition(builder, Transition);
    ScenarioScriptFavor1Excel.AddSound(builder, SoundOffset);
    ScenarioScriptFavor1Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptFavor1Excel.EndScenarioScriptFavor1Excel(builder);
  }

  public static void StartScenarioScriptFavor1Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptFavor1Excel> EndScenarioScriptFavor1Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ScenarioScriptFavor1Excel>(o);
  }
}
