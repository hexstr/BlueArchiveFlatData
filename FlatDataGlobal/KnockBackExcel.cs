...
public struct KnockBackExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.KnockBackExcel> CreateKnockBackExcel(FlatBufferBuilder builder,
      long Index = 0,
      float Dist = 0.0f,
      float Speed = 0.0f) {
  ...
  public static Offset<FlatDataGlobal.KnockBackExcel> EndKnockBackExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.KnockBackExcel>(o);
  }
}
