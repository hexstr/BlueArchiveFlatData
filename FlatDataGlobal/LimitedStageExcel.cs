...
public struct LimitedStageExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.StrategyEnvironment StrategyEnvironment { get { int o = __p.__offset(54); return o != 0 ? (FlatDataGlobal.StrategyEnvironment)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.StrategyEnvironment.None; } }
  ...
  public static Offset<FlatDataGlobal.LimitedStageExcel> CreateLimitedStageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddStrategyEnvironment(FlatBufferBuilder builder, FlatDataGlobal.StrategyEnvironment strategyEnvironment) { builder.AddInt(25, (int)strategyEnvironment, 0); }
  ...
  public static Offset<FlatDataGlobal.LimitedStageExcel> EndLimitedStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.LimitedStageExcel>(o);
  }
}
