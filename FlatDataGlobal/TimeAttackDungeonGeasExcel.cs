...
public struct TimeAttackDungeonGeasExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.TimeAttackDungeonGeasExcel> EndTimeAttackDungeonGeasExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.TimeAttackDungeonGeasExcel>(o);
  }
}
