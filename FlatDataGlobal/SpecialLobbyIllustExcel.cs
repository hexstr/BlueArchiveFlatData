...
public struct SpecialLobbyIllustExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.SpecialLobbyIllustExcel> CreateSpecialLobbyIllustExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<FlatDataGlobal.SpecialLobbyIllustExcel> EndSpecialLobbyIllustExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.SpecialLobbyIllustExcel>(o);
  }
}
