...
public struct FavorLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.FavorLevelExcel> CreateFavorLevelExcel(FlatBufferBuilder builder,
      long Level = 0,
  ...
  public static Offset<FlatDataGlobal.FavorLevelExcel> EndFavorLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.FavorLevelExcel>(o);
  }
}
