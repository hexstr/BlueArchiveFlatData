...
public struct MiniGameDreamEndingRewardExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.DreamMakerEndingRewardType DreamMakerEndingRewardType { get { int o = __p.__offset(10); return o != 0 ? (FlatDataGlobal.DreamMakerEndingRewardType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.DreamMakerEndingRewardType.None; } }
  public FlatDataGlobal.DreamMakerEndingType DreamMakerEndingType { get { int o = __p.__offset(12); return o != 0 ? (FlatDataGlobal.DreamMakerEndingType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.DreamMakerEndingType.None; } }
  ...
  public static Offset<FlatDataGlobal.MiniGameDreamEndingRewardExcel> CreateMiniGameDreamEndingRewardExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long EndingId = 0,
      uint LocalizeEtcId = 0,
      FlatDataGlobal.DreamMakerEndingRewardType dreamMakerEndingRewardType = FlatDataGlobal.DreamMakerEndingRewardType.None,
  ...
  public static void AddDreamMakerEndingRewardType(FlatBufferBuilder builder, FlatDataGlobal.DreamMakerEndingRewardType dreamMakerEndingRewardType) { builder.AddInt(3, (int)dreamMakerEndingRewardType, 0); }
  public static void AddDreamMakerEndingType(FlatBufferBuilder builder, FlatDataGlobal.DreamMakerEndingType dreamMakerEndingType) { builder.AddInt(4, (int)dreamMakerEndingType, 0); }
  ...
  public static Offset<FlatDataGlobal.MiniGameDreamEndingRewardExcel> EndMiniGameDreamEndingRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.MiniGameDreamEndingRewardExcel>(o);
  }
}
