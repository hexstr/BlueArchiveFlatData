...
public struct PropVector3 : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.PropVector3> CreatePropVector3(FlatBufferBuilder builder,
      float X = 0.0f,
      float Y = 0.0f,
      float Z = 0.0f) {
  ...
  public static Offset<FlatDataGlobal.PropVector3> EndPropVector3(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.PropVector3>(o);
  }
}
