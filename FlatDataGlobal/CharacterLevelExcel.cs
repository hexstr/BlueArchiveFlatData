...
public struct CharacterLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.CharacterLevelExcel> CreateCharacterLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
      long Exp = 0,
      long TotalExp = 0) {
  ...
  public static Offset<FlatDataGlobal.CharacterLevelExcel> EndCharacterLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.CharacterLevelExcel>(o);
  }
}
