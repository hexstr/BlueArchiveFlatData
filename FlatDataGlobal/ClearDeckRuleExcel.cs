...
public struct ClearDeckRuleExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.ClearDeckRuleExcel> CreateClearDeckRuleExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataGlobal.ClearDeckRuleExcel> EndClearDeckRuleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ClearDeckRuleExcel>(o);
  }
}
