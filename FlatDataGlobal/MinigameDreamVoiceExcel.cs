...
public struct MinigameDreamVoiceExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.DreamMakerVoiceCondition VoiceCondition { get { int o = __p.__offset(8); return o != 0 ? (FlatDataGlobal.DreamMakerVoiceCondition)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.DreamMakerVoiceCondition.None; } }
  public uint VoiceClip { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }

  public static Offset<FlatDataGlobal.MinigameDreamVoiceExcel> CreateMinigameDreamVoiceExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      long UniqueId = 0,
      FlatDataGlobal.DreamMakerVoiceCondition VoiceCondition = FlatDataGlobal.DreamMakerVoiceCondition.None,
      uint VoiceClip = 0) {
  ...
  public static void AddVoiceCondition(FlatBufferBuilder builder, FlatDataGlobal.DreamMakerVoiceCondition VoiceCondition) { builder.AddInt(2, (int)VoiceCondition, 0); }
  public static void AddVoiceClip(FlatBufferBuilder builder, uint VoiceClip) { builder.AddUint(3, VoiceClip, 0); }
  public static Offset<FlatDataGlobal.MinigameDreamVoiceExcel> EndMinigameDreamVoiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.MinigameDreamVoiceExcel>(o);
  }
}
