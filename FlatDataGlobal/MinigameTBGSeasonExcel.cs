...
public struct MinigameTBGSeasonExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.ParcelType EventUseCostType { get { int o = __p.__offset(28); return o != 0 ? (FlatDataGlobal.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ParcelType.None; } }
  public long EventUseCostId { get { int o = __p.__offset(30); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public FlatDataGlobal.ParcelType EchelonRevivalCostType { get { int o = __p.__offset(32); return o != 0 ? (FlatDataGlobal.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ParcelType.None; } }
  ...
  public static void AddEventUseCostType(FlatBufferBuilder builder, FlatDataGlobal.ParcelType EventUseCostType) { builder.AddInt(12, (int)EventUseCostType, 0); }
  public static void AddEventUseCostId(FlatBufferBuilder builder, long EventUseCostId) { builder.AddLong(13, EventUseCostId, 0); }
  public static void AddEchelonRevivalCostType(FlatBufferBuilder builder, FlatDataGlobal.ParcelType EchelonRevivalCostType) { builder.AddInt(14, (int)EchelonRevivalCostType, 0); }
