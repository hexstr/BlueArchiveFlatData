...
public struct ToastExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.ToastType ToastType { get { int o = __p.__offset(6); return o != 0 ? (FlatDataGlobal.ToastType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ToastType.None; } }
  ...
  public static Offset<FlatDataGlobal.ToastExcel> CreateToastExcel(FlatBufferBuilder builder,
      uint Id = 0,
      FlatDataGlobal.ToastType ToastType = FlatDataGlobal.ToastType.None,
      uint MissionId = 0,
      uint TextId = 0,
      long LifeTime = 0) {
  ...
  public static void AddToastType(FlatBufferBuilder builder, FlatDataGlobal.ToastType ToastType) { builder.AddInt(1, (int)ToastType, 0); }
  ...
  public static Offset<FlatDataGlobal.ToastExcel> EndToastExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ToastExcel>(o);
  }
}
