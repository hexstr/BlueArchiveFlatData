...
public struct WorldRaidFavorBuffExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.WorldRaidFavorBuffExcel> CreateWorldRaidFavorBuffExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataGlobal.WorldRaidFavorBuffExcel> EndWorldRaidFavorBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.WorldRaidFavorBuffExcel>(o);
  }
}
