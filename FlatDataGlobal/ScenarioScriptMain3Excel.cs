...
public struct ScenarioScriptMain3Excel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptMain3Excel> CreateScenarioScriptMain3Excel(FlatBufferBuilder builder,
    ...
    ScenarioScriptMain3Excel.AddTeenMode(builder, TeenMode);
    return ScenarioScriptMain3Excel.EndScenarioScriptMain3Excel(builder);
  }

  public static void StartScenarioScriptMain3Excel(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<FlatDataGlobal.ScenarioScriptMain3Excel> EndScenarioScriptMain3Excel(FlatBufferBuilder builder) {
    ...
    return new Offset<FlatDataGlobal.ScenarioScriptMain3Excel>(o);
  }
}
