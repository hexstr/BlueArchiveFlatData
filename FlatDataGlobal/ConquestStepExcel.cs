...
public struct ConquestStepExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.StageDifficulty MapDifficulty { get { int o = __p.__offset(6); return o != 0 ? (FlatDataGlobal.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.StageDifficulty.None; } }
  ...
  public FlatDataGlobal.ParcelType StepEnterItemType { get { int o = __p.__offset(14); return o != 0 ? (FlatDataGlobal.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.ParcelType.None; } }
  ...
  public static Offset<FlatDataGlobal.ConquestStepExcel> CreateConquestStepExcel(FlatBufferBuilder builder,
      ...
      FlatDataGlobal.ParcelType StepEnterItemType = FlatDataGlobal.ParcelType.None,
  ...
  public static void AddMapDifficulty(FlatBufferBuilder builder, FlatDataGlobal.StageDifficulty MapDifficulty) { builder.AddInt(1, (int)MapDifficulty, 0); }
  ...
  public static void AddStepEnterItemType(FlatBufferBuilder builder, FlatDataGlobal.ParcelType StepEnterItemType) { builder.AddInt(5, (int)StepEnterItemType, 0); }
  ...
  public static Offset<FlatDataGlobal.ConquestStepExcel> EndConquestStepExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.ConquestStepExcel>(o);
  }
}
