...
public struct VoiceRoomExceptionExcel : IFlatbufferObject
{
  ...
  public FlatDataGlobal.CVPrintType LinkedCharacterVoicePrintType { get { int o = __p.__offset(6); return o != 0 ? (FlatDataGlobal.CVPrintType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataGlobal.CVPrintType.CharacterOverwrite; } }
  ...
  public static void AddLinkedCharacterVoicePrintType(FlatBufferBuilder builder, FlatDataGlobal.CVPrintType LinkedCharacterVoicePrintType) { builder.AddInt(1, (int)LinkedCharacterVoicePrintType, 0); }
