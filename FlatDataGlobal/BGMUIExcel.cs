...
public struct BGMUIExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataGlobal.BGMUIExcel> CreateBGMUIExcel(FlatBufferBuilder builder,
      uint UIPrefab = 0,
      long BGMId = 0,
  ...
  public static void StartBGMUIExcel(FlatBufferBuilder builder) { builder.StartTable(3); }
  ...
  public static Offset<FlatDataGlobal.BGMUIExcel> EndBGMUIExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataGlobal.BGMUIExcel>(o);
  }
}
