...
public struct MiniGameShootingGeasExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.Geas GeasType { get { int o = __p.__offset(6); return o != 0 ? (FlatDataJp.Geas)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.Geas.ForwardProjectile; } }
  ...
  public static Offset<FlatDataJp.MiniGameShootingGeasExcel> CreateMiniGameShootingGeasExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      FlatDataJp.Geas GeasType = FlatDataJp.Geas.ForwardProjectile,
  ...
  public static void AddGeasType(FlatBufferBuilder builder, FlatDataJp.Geas GeasType) { builder.AddInt(1, (int)GeasType, 0); }
  ...
  public static Offset<FlatDataJp.MiniGameShootingGeasExcel> EndMiniGameShootingGeasExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.MiniGameShootingGeasExcel>(o);
  }
}
