...
public struct FurnitureGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.FurnitureGroupExcel> CreateFurnitureGroupExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataJp.FurnitureGroupExcel> EndFurnitureGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.FurnitureGroupExcel>(o);
  }
}
