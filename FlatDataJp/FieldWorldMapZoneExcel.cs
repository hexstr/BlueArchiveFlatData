...
public struct FieldWorldMapZoneExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.FieldConditionType OpenConditionType { get { int o = __p.__offset(10); return o != 0 ? (FlatDataJp.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.FieldConditionType.Invalid; } }
  public long OpenConditionId { get { int o = __p.__offset(12); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public FlatDataJp.FieldConditionType CloseConditionType { get { int o = __p.__offset(14); return o != 0 ? (FlatDataJp.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.FieldConditionType.Invalid; } }
  ...
  public static Offset<FlatDataJp.FieldWorldMapZoneExcel> CreateFieldWorldMapZoneExcel(FlatBufferBuilder builder,
      long Id = 0,
      int GroupId = 0,
      int Date = 0,
      FlatDataJp.FieldConditionType OpenConditionType = FlatDataJp.FieldConditionType.Invalid,
      long OpenConditionId = 0,
      FlatDataJp.FieldConditionType CloseConditionType = FlatDataJp.FieldConditionType.Invalid,
  ...
  public static void AddOpenConditionType(FlatBufferBuilder builder, FlatDataJp.FieldConditionType OpenConditionType) { builder.AddInt(3, (int)OpenConditionType, 0); }
  public static void AddOpenConditionId(FlatBufferBuilder builder, long OpenConditionId) { builder.AddLong(4, OpenConditionId, 0); }
  public static void AddCloseConditionType(FlatBufferBuilder builder, FlatDataJp.FieldConditionType CloseConditionType) { builder.AddInt(5, (int)CloseConditionType, 0); }
  ...
  public static Offset<FlatDataJp.FieldWorldMapZoneExcel> EndFieldWorldMapZoneExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.FieldWorldMapZoneExcel>(o);
  }
}
