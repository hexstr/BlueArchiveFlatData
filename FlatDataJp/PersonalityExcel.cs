...
public struct PersonalityExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.PersonalityExcel> CreatePersonalityExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataJp.PersonalityExcel> EndPersonalityExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.PersonalityExcel>(o);
  }
}
