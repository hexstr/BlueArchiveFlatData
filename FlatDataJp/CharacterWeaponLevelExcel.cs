...
public struct CharacterWeaponLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.CharacterWeaponLevelExcel> CreateCharacterWeaponLevelExcel(FlatBufferBuilder builder,
      int Level = 0,
      long Exp = 0,
      long TotalExp = 0) {
  ...
  public static Offset<FlatDataJp.CharacterWeaponLevelExcel> EndCharacterWeaponLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.CharacterWeaponLevelExcel>(o);
  }
}
