...
public struct ArenaSeasonCloseRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ArenaSeasonCloseRewardExcel> CreateArenaSeasonCloseRewardExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long RankStart = 0,
      long RankEnd = 0,
  ...
  public static Offset<FlatDataJp.ArenaSeasonCloseRewardExcel> EndArenaSeasonCloseRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ArenaSeasonCloseRewardExcel>(o);
  }
}
