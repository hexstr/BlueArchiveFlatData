...
public struct FieldStoryStageExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.FieldStoryStageExcel> CreateFieldStoryStageExcel(FlatBufferBuilder builder,
      long Id = 0,
      long SeasonId = 0,
  ...
  public static Offset<FlatDataJp.FieldStoryStageExcel> EndFieldStoryStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.FieldStoryStageExcel>(o);
  }
}
