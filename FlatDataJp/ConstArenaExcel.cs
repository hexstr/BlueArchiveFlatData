...
public struct ConstArenaExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.ParcelType EnterCostType { get { int o = __p.__offset(16); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ParcelType.None; } }
  ...
  public FlatDataJp.StatType ModifiedStatType(int j) { int o = __p.__offset(34); return o != 0 ? (FlatDataJp.StatType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.StatType)0; }
  public int ModifiedStatTypeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.StatType> GetModifiedStatTypeBytes() { return __p.__vector_as_span<FlatDataJp.StatType>(34, 4); }
#else
  public ArraySegment<byte>? GetModifiedStatTypeBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public FlatDataJp.StatType[] GetModifiedStatTypeArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.StatType[] a = new FlatDataJp.StatType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.StatType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatDataJp.ConstArenaExcel> CreateConstArenaExcel(FlatBufferBuilder builder,
      ...
      FlatDataJp.ParcelType EnterCostType = FlatDataJp.ParcelType.None,
      long EnterCostId = 0,
      long TicketCost = 0,
  ...
  public static void AddEnterCostType(FlatBufferBuilder builder, FlatDataJp.ParcelType EnterCostType) { builder.AddInt(6, (int)EnterCostType, 0); }
  ...
  public static VectorOffset CreateModifiedStatTypeVector(FlatBufferBuilder builder, FlatDataJp.StatType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateModifiedStatTypeVectorBlock(FlatBufferBuilder builder, FlatDataJp.StatType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateModifiedStatTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatDataJp.StatType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateModifiedStatTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatDataJp.StatType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatDataJp.ConstArenaExcel> EndConstArenaExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ConstArenaExcel>(o);
  }
}
