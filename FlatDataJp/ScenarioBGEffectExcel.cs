...
public struct ScenarioBGEffectExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.ScenarioBGScroll Scroll { get { int o = __p.__offset(8); return o != 0 ? (FlatDataJp.ScenarioBGScroll)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ScenarioBGScroll.None; } }
  ...
  public static Offset<FlatDataJp.ScenarioBGEffectExcel> CreateScenarioBGEffectExcel(FlatBufferBuilder builder,
      uint Name = 0,
      StringOffset EffectOffset = default(StringOffset),
      FlatDataJp.ScenarioBGScroll Scroll = FlatDataJp.ScenarioBGScroll.None,
      long ScrollTime = 0,
      long ScrollFrom = 0,
      long ScrollTo = 0) {
  ...
  public static void AddScroll(FlatBufferBuilder builder, FlatDataJp.ScenarioBGScroll Scroll) { builder.AddInt(2, (int)Scroll, 0); }
  ...
  public static Offset<FlatDataJp.ScenarioBGEffectExcel> EndScenarioBGEffectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ScenarioBGEffectExcel>(o);
  }
}
