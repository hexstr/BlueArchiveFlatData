...
public struct GroundModuleRewardExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.ParcelType RewardParcelType { get { int o = __p.__offset(6); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ParcelType.None; } }
  ...
  public static Offset<FlatDataJp.GroundModuleRewardExcel> CreateGroundModuleRewardExcel(FlatBufferBuilder builder,
      uint GroupId = 0,
  ...
  public static void AddRewardParcelType(FlatBufferBuilder builder, FlatDataJp.ParcelType RewardParcelType) { builder.AddInt(1, (int)RewardParcelType, 0); }
  ...
  public static Offset<FlatDataJp.GroundModuleRewardExcel> EndGroundModuleRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.GroundModuleRewardExcel>(o);
  }
}
