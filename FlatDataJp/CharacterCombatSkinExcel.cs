...
public struct CharacterCombatSkinExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.CharacterCombatSkinExcel> CreateCharacterCombatSkinExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataJp.CharacterCombatSkinExcel> EndCharacterCombatSkinExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.CharacterCombatSkinExcel>(o);
  }
}
