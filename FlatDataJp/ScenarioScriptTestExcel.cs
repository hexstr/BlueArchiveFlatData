...
public struct ScenarioScriptTestExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ScenarioScriptTestExcel> CreateScenarioScriptTestExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static void StartScenarioScriptTestExcel(FlatBufferBuilder builder) { builder.StartTable(11); }
  ...
  public static Offset<FlatDataJp.ScenarioScriptTestExcel> EndScenarioScriptTestExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ScenarioScriptTestExcel>(o);
  }
}
