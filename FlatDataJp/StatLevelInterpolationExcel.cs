...
public struct StatLevelInterpolationExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.StatLevelInterpolationExcel> CreateStatLevelInterpolationExcel(FlatBufferBuilder builder,
      long Level = 0,
  ...
  public static Offset<FlatDataJp.StatLevelInterpolationExcel> EndStatLevelInterpolationExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.StatLevelInterpolationExcel>(o);
  }
}
