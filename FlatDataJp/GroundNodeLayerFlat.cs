...
public struct GroundNodeLayerFlat : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.GroundNodeLayerFlat> CreateGroundNodeLayerFlat(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataJp.GroundNodeLayerFlat> EndGroundNodeLayerFlat(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.GroundNodeLayerFlat>(o);
  }
}
