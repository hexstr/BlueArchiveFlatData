...
public struct FieldKeywordExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.FieldKeywordExcel> CreateFieldKeywordExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<FlatDataJp.FieldKeywordExcel> EndFieldKeywordExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.FieldKeywordExcel>(o);
  }
}
