...
public struct NormalSkillTemplateExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.NormalSkillTemplateExcel> CreateNormalSkillTemplateExcel(FlatBufferBuilder builder,
      long Index = 0,
  ...
  public static Offset<FlatDataJp.NormalSkillTemplateExcel> EndNormalSkillTemplateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.NormalSkillTemplateExcel>(o);
  }
}
