...
public struct FieldMasteryManageExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.FieldMasteryManageExcel> CreateFieldMasteryManageExcel(FlatBufferBuilder builder,
      long FieldSeason = 0,
      uint LocalizeEtc = 0,
  ...
  public static Offset<FlatDataJp.FieldMasteryManageExcel> EndFieldMasteryManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.FieldMasteryManageExcel>(o);
  }
}
