...
public struct ScenarioContentCollectionExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.CollectionUnlockType UnlockConditionType { get { int o = __p.__offset(8); return o != 0 ? (FlatDataJp.CollectionUnlockType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.CollectionUnlockType.None; } }
  ...
  public FlatDataJp.MultipleConditionCheckType MultipleConditionCheckType { get { int o = __p.__offset(12); return o != 0 ? (FlatDataJp.MultipleConditionCheckType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.MultipleConditionCheckType.And; } }
  ...
  public static Offset<FlatDataJp.ScenarioContentCollectionExcel> CreateScenarioContentCollectionExcel(FlatBufferBuilder builder,
      long Id = 0,
      long GroupId = 0,
  ...
  public static void AddUnlockConditionType(FlatBufferBuilder builder, FlatDataJp.CollectionUnlockType UnlockConditionType) { builder.AddInt(2, (int)UnlockConditionType, 0); }
  ...
  public static void AddMultipleConditionCheckType(FlatBufferBuilder builder, FlatDataJp.MultipleConditionCheckType multipleConditionCheckType) { builder.AddInt(4, (int)multipleConditionCheckType, 0); }
  ...
  public static Offset<FlatDataJp.ScenarioContentCollectionExcel> EndScenarioContentCollectionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ScenarioContentCollectionExcel>(o);
  }
}
