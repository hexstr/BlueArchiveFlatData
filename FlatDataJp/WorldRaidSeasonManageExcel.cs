...
public struct WorldRaidSeasonManageExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.CurrencyTypes EnterTicket { get { int o = __p.__offset(8); return o != 0 ? (FlatDataJp.CurrencyTypes)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.CurrencyTypes.Invalid; } }
  ...
  public long WorldRaidLobbyEnterScenario { get { int o = __p.__offset(18); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public bool CanPlayNotSeasonTime { get { int o = __p.__offset(20); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public bool WorldRaidUniqueThemeLobbyUI { get { int o = __p.__offset(22); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public string WorldRaidUniqueThemeName { get { int o = __p.__offset(24); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetWorldRaidUniqueThemeNameBytes() { return __p.__vector_as_span<byte>(24, 1); }
#else
  public ArraySegment<byte>? GetWorldRaidUniqueThemeNameBytes() { return __p.__vector_as_arraysegment(24); }
#endif
  public byte[] GetWorldRaidUniqueThemeNameArray() { return __p.__vector_as_array<byte>(24); }
  public bool CanWorldRaidGemEnter { get { int o = __p.__offset(26); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public bool HideWorldRaidTicketUI { get { int o = __p.__offset(28); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public bool UseWorldRaidCommonToast { get { int o = __p.__offset(30); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public long OpenRaidBossGroupId(int j) { int o = __p.__offset(32); return o != 0 ? __p.bb.GetLong(__p.__vector(o) + j * 8) : (long)0; }
  public int OpenRaidBossGroupIdLength { get { int o = __p.__offset(32); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<long> GetOpenRaidBossGroupIdBytes() { return __p.__vector_as_span<long>(32, 8); }
#else
  public ArraySegment<byte>? GetOpenRaidBossGroupIdBytes() { return __p.__vector_as_arraysegment(32); }
#endif
  public long[] GetOpenRaidBossGroupIdArray() { return __p.__vector_as_array<long>(32); }
  public string BossSpawnTime(int j) { int o = __p.__offset(34); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int BossSpawnTimeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
  public string EliminateTime(int j) { int o = __p.__offset(36); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int EliminateTimeLength { get { int o = __p.__offset(36); return o != 0 ? __p.__vector_len(o) : 0; } }
  public long ScenarioOutputConditionId(int j) { int o = __p.__offset(38); return o != 0 ? __p.bb.GetLong(__p.__vector(o) + j * 8) : (long)0; }
  public int ScenarioOutputConditionIdLength { get { int o = __p.__offset(38); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<long> GetScenarioOutputConditionIdBytes() { return __p.__vector_as_span<long>(38, 8); }
#else
  public ArraySegment<byte>? GetScenarioOutputConditionIdBytes() { return __p.__vector_as_arraysegment(38); }
#endif
  public long[] GetScenarioOutputConditionIdArray() { return __p.__vector_as_array<long>(38); }
  public long ConditionScenarioGroupid(int j) { int o = __p.__offset(40); return o != 0 ? __p.bb.GetLong(__p.__vector(o) + j * 8) : (long)0; }
  public int ConditionScenarioGroupidLength { get { int o = __p.__offset(40); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<long> GetConditionScenarioGroupidBytes() { return __p.__vector_as_span<long>(40, 8); }
#else
  public ArraySegment<byte>? GetConditionScenarioGroupidBytes() { return __p.__vector_as_arraysegment(40); }
#endif
  public long[] GetConditionScenarioGroupidArray() { return __p.__vector_as_array<long>(40); }
  public string WorldRaidMapEnterOperator { get { int o = __p.__offset(42); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetWorldRaidMapEnterOperatorBytes() { return __p.__vector_as_span<byte>(42, 1); }
#else
  public ArraySegment<byte>? GetWorldRaidMapEnterOperatorBytes() { return __p.__vector_as_arraysegment(42); }
#endif
  public byte[] GetWorldRaidMapEnterOperatorArray() { return __p.__vector_as_array<byte>(42); }
  public bool UseFavorRankBuff { get { int o = __p.__offset(44); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }

  public static Offset<FlatDataJp.WorldRaidSeasonManageExcel> CreateWorldRaidSeasonManageExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
      long EventContentId = 0,
      FlatDataJp.CurrencyTypes EnterTicket = FlatDataJp.CurrencyTypes.Invalid,
  ...
  public static void StartWorldRaidSeasonManageExcel(FlatBufferBuilder builder) { builder.StartTable(21); }
  ...
  public static void AddEnterTicket(FlatBufferBuilder builder, FlatDataJp.CurrencyTypes EnterTicket) { builder.AddInt(2, (int)EnterTicket, 0); }
  ...
  public static void AddWorldRaidLobbyEnterScenario(FlatBufferBuilder builder, long WorldRaidLobbyEnterScenario) { builder.AddLong(7, WorldRaidLobbyEnterScenario, 0); }
  ...
  public static void AddWorldRaidUniqueThemeLobbyUI(FlatBufferBuilder builder, bool WorldRaidUniqueThemeLobbyUI) { builder.AddBool(9, WorldRaidUniqueThemeLobbyUI, false); }
  public static void AddWorldRaidUniqueThemeName(FlatBufferBuilder builder, StringOffset WorldRaidUniqueThemeNameOffset) { builder.AddOffset(10, WorldRaidUniqueThemeNameOffset.Value, 0); }
  public static void AddCanWorldRaidGemEnter(FlatBufferBuilder builder, bool CanWorldRaidGemEnter) { builder.AddBool(11, CanWorldRaidGemEnter, false); }
  public static void AddHideWorldRaidTicketUI(FlatBufferBuilder builder, bool HideWorldRaidTicketUI) { builder.AddBool(12, HideWorldRaidTicketUI, false); }
  public static void AddUseWorldRaidCommonToast(FlatBufferBuilder builder, bool UseWorldRaidCommonToast) { builder.AddBool(13, UseWorldRaidCommonToast, false); }
  public static void AddOpenRaidBossGroupId(FlatBufferBuilder builder, VectorOffset OpenRaidBossGroupIdOffset) { builder.AddOffset(14, OpenRaidBossGroupIdOffset.Value, 0); }
  ...
  public static void AddBossSpawnTime(FlatBufferBuilder builder, VectorOffset BossSpawnTimeOffset) { builder.AddOffset(15, BossSpawnTimeOffset.Value, 0); }
  ...
  public static void AddEliminateTime(FlatBufferBuilder builder, VectorOffset EliminateTimeOffset) { builder.AddOffset(16, EliminateTimeOffset.Value, 0); }
  ...
  public static void AddScenarioOutputConditionId(FlatBufferBuilder builder, VectorOffset ScenarioOutputConditionIdOffset) { builder.AddOffset(17, ScenarioOutputConditionIdOffset.Value, 0); }
  ...
  public static void AddConditionScenarioGroupid(FlatBufferBuilder builder, VectorOffset ConditionScenarioGroupidOffset) { builder.AddOffset(18, ConditionScenarioGroupidOffset.Value, 0); }
  ...
  public static void AddWorldRaidMapEnterOperator(FlatBufferBuilder builder, StringOffset WorldRaidMapEnterOperatorOffset) { builder.AddOffset(19, WorldRaidMapEnterOperatorOffset.Value, 0); }
  public static void AddUseFavorRankBuff(FlatBufferBuilder builder, bool UseFavorRankBuff) { builder.AddBool(20, UseFavorRankBuff, false); }
  public static Offset<FlatDataJp.WorldRaidSeasonManageExcel> EndWorldRaidSeasonManageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.WorldRaidSeasonManageExcel>(o);
  }
}
