...
public struct MiniGameDreamDailyPointExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.MiniGameDreamDailyPointExcel> CreateMiniGameDreamDailyPointExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<FlatDataJp.MiniGameDreamDailyPointExcel> EndMiniGameDreamDailyPointExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.MiniGameDreamDailyPointExcel>(o);
  }
}
