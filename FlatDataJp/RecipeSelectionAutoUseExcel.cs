...
public struct RecipeSelectionAutoUseExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.RecipeSelectionAutoUseExcel> CreateRecipeSelectionAutoUseExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataJp.RecipeSelectionAutoUseExcel> EndRecipeSelectionAutoUseExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.RecipeSelectionAutoUseExcel>(o);
  }
}
