...
public struct FieldQuestExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.FieldQuestExcel> CreateFieldQuestExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<FlatDataJp.FieldQuestExcel> EndFieldQuestExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.FieldQuestExcel>(o);
  }
}
