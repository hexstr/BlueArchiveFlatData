...
public struct EventContentMeetupExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.MeetupConditionType ConditionType { get { int o = __p.__offset(12); return o != 0 ? (FlatDataJp.MeetupConditionType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.MeetupConditionType.None; } }
  ...
  public FlatDataJp.MeetupConditionPrintType ConditionPrintType { get { int o = __p.__offset(16); return o != 0 ? (FlatDataJp.MeetupConditionPrintType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.MeetupConditionPrintType.None; } }
  ...
  public static Offset<FlatDataJp.EventContentMeetupExcel> CreateEventContentMeetupExcel(FlatBufferBuilder builder,
      ...
      FlatDataJp.MeetupConditionType ConditionType = FlatDataJp.MeetupConditionType.None,
      VectorOffset ConditionParameterOffset = default(VectorOffset),
      FlatDataJp.MeetupConditionPrintType ConditionPrintType = FlatDataJp.MeetupConditionPrintType.None) {
  ...
  public static void AddConditionType(FlatBufferBuilder builder, FlatDataJp.MeetupConditionType ConditionType) { builder.AddInt(4, (int)ConditionType, 0); }
  ...
  public static void AddConditionPrintType(FlatBufferBuilder builder, FlatDataJp.MeetupConditionPrintType ConditionPrintType) { builder.AddInt(6, (int)ConditionPrintType, 0); }
