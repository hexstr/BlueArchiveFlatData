...
public struct PresetCharactersExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.PresetCharactersExcel> CreatePresetCharactersExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<FlatDataJp.PresetCharactersExcel> EndPresetCharactersExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.PresetCharactersExcel>(o);
  }
}
