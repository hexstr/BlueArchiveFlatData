...
public struct ScenarioScriptExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ScenarioScriptExcel> CreateScenarioScriptExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<FlatDataJp.ScenarioScriptExcel> EndScenarioScriptExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ScenarioScriptExcel>(o);
  }
}
