...
public struct LocalizeScenarioExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.LocalizeScenarioExcel> CreateLocalizeScenarioExcel(FlatBufferBuilder builder,
      uint Key = 0,
  ...
  public static void StartLocalizeScenarioExcel(FlatBufferBuilder builder) { builder.StartTable(3); }
  ...
  public static Offset<FlatDataJp.LocalizeScenarioExcel> EndLocalizeScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.LocalizeScenarioExcel>(o);
  }
}
