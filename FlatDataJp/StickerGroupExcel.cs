...
public struct StickerGroupExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.ParcelType PageCompleteRewardParcelType { get { int o = __p.__offset(14); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ParcelType.None; } }
  ...
  public static Offset<FlatDataJp.StickerGroupExcel> CreateStickerGroupExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      FlatDataJp.ParcelType PageCompleteRewardParcelType = FlatDataJp.ParcelType.None,
  ...
  public static void AddPageCompleteRewardParcelType(FlatBufferBuilder builder, FlatDataJp.ParcelType PageCompleteRewardParcelType) { builder.AddInt(5, (int)PageCompleteRewardParcelType, 0); }
  ...
  public static Offset<FlatDataJp.StickerGroupExcel> EndStickerGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.StickerGroupExcel>(o);
  }
}
