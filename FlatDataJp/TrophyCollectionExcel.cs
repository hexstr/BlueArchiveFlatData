...
public struct TrophyCollectionExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.TrophyCollectionExcel> CreateTrophyCollectionExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<FlatDataJp.TrophyCollectionExcel> EndTrophyCollectionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.TrophyCollectionExcel>(o);
  }
}
