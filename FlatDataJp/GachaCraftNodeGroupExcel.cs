...
public struct GachaCraftNodeGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.GachaCraftNodeGroupExcel> CreateGachaCraftNodeGroupExcel(FlatBufferBuilder builder,
      long NodeId = 0,
      long GachaGroupId = 0,
      long ProbWeight = 0) {
  ...
  public static Offset<FlatDataJp.GachaCraftNodeGroupExcel> EndGachaCraftNodeGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.GachaCraftNodeGroupExcel>(o);
  }
}
