...
public struct CostumeExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.EntityMaterialType EntityMaterialType { get { int o = __p.__offset(32); return o != 0 ? (FlatDataJp.EntityMaterialType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.EntityMaterialType.Wood; } }
  ...
  public static void AddEntityMaterialType(FlatBufferBuilder builder, FlatDataJp.EntityMaterialType entityMaterialType) { builder.AddInt(14, (int)entityMaterialType, 0); }
