...
public struct TacticTimeAttackSimulatorConfigExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.TacticTimeAttackSimulatorConfigExcel> CreateTacticTimeAttackSimulatorConfigExcel(FlatBufferBuilder builder,
      long Order = 0,
      long Repeat = 0,
  ...
  public static Offset<FlatDataJp.TacticTimeAttackSimulatorConfigExcel> EndTacticTimeAttackSimulatorConfigExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.TacticTimeAttackSimulatorConfigExcel>(o);
  }
}
