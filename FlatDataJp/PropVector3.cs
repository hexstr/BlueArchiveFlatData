...
public struct PropVector3 : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.PropVector3> CreatePropVector3(FlatBufferBuilder builder,
      float X = 0.0f,
      float Y = 0.0f,
      float Z = 0.0f) {
  ...
  public static Offset<FlatDataJp.PropVector3> EndPropVector3(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.PropVector3>(o);
  }
}
