...
public struct ScenarioScriptEvent3Excel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ScenarioScriptEvent3Excel> CreateScenarioScriptEvent3Excel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static void StartScenarioScriptEvent3Excel(FlatBufferBuilder builder) { builder.StartTable(11); }
  ...
  public static Offset<FlatDataJp.ScenarioScriptEvent3Excel> EndScenarioScriptEvent3Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ScenarioScriptEvent3Excel>(o);
  }
}
