...
public struct ConquestRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ConquestRewardExcel> CreateConquestRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<FlatDataJp.ConquestRewardExcel> EndConquestRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ConquestRewardExcel>(o);
  }
}
