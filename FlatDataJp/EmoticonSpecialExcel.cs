...
public struct EmoticonSpecialExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.EmoticonSpecialExcel> CreateEmoticonSpecialExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
  ...
  public static Offset<FlatDataJp.EmoticonSpecialExcel> EndEmoticonSpecialExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.EmoticonSpecialExcel>(o);
  }
}
