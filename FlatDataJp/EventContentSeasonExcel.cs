...
public struct EventContentSeasonExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.SubEventType SubEventType { get { int o = __p.__offset(20); return o != 0 ? (FlatDataJp.SubEventType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.SubEventType.None; } }
  ...
  public static void AddSubEventType(FlatBufferBuilder builder, FlatDataJp.SubEventType subEventType) { builder.AddInt(8, (int)subEventType, 0); }
