...
public struct ScenarioTransitionExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ScenarioTransitionExcel> CreateScenarioTransitionExcel(FlatBufferBuilder builder,
      uint Name = 0,
  ...
  public static Offset<FlatDataJp.ScenarioTransitionExcel> EndScenarioTransitionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ScenarioTransitionExcel>(o);
  }
}
