...
public struct ShopCashScenarioResourceInfoExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ShopCashScenarioResourceInfoExcel> CreateShopCashScenarioResourceInfoExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataJp.ShopCashScenarioResourceInfoExcel> EndShopCashScenarioResourceInfoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ShopCashScenarioResourceInfoExcel>(o);
  }
}
