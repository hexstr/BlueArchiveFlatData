...
public struct FavorLevelExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.FavorLevelExcel> CreateFavorLevelExcel(FlatBufferBuilder builder,
      long Level = 0,
  ...
  public static Offset<FlatDataJp.FavorLevelExcel> EndFavorLevelExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.FavorLevelExcel>(o);
  }
}
