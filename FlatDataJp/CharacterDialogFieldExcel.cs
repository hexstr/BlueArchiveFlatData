...
public struct CharacterDialogFieldExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.FieldDialogType DialogType { get { int o = __p.__offset(10); return o != 0 ? (FlatDataJp.FieldDialogType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.FieldDialogType.None; } }
  ...
  public static Offset<FlatDataJp.CharacterDialogFieldExcel> CreateCharacterDialogFieldExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      int Phase = 0,
      int TargetIndex = 0,
      FlatDataJp.FieldDialogType DialogType = FlatDataJp.FieldDialogType.None,
      long Duration = 0,
  ...
  public static void AddDialogType(FlatBufferBuilder builder, FlatDataJp.FieldDialogType DialogType) { builder.AddInt(3, (int)DialogType, 0); }
  ...
  public static Offset<FlatDataJp.CharacterDialogFieldExcel> EndCharacterDialogFieldExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.CharacterDialogFieldExcel>(o);
  }
}
