...
public struct ScenarioReplayExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.ScenarioModeReplayTypes ReplayType { get { int o = __p.__offset(8); return o != 0 ? (FlatDataJp.ScenarioModeReplayTypes)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ScenarioModeReplayTypes.None; } }
  ...
  public static Offset<FlatDataJp.ScenarioReplayExcel> CreateScenarioReplayExcel(FlatBufferBuilder builder,
      long ModeId = 0,
      long VolumeId = 0,
      FlatDataJp.ScenarioModeReplayTypes ReplayType = FlatDataJp.ScenarioModeReplayTypes.None,
      long ChapterId = 0,
      long EpisodeId = 0,
  ...
  public static void AddReplayType(FlatBufferBuilder builder, FlatDataJp.ScenarioModeReplayTypes ReplayType) { builder.AddInt(2, (int)ReplayType, 0); }
  ...
  public static Offset<FlatDataJp.ScenarioReplayExcel> EndScenarioReplayExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ScenarioReplayExcel>(o);
  }
}
