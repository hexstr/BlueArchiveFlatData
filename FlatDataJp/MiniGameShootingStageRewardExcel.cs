...
public struct MiniGameShootingStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.MiniGameShootingStageRewardExcel> CreateMiniGameShootingStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      long RewardId = 0,
      long ClearSection = 0,
  ...
  public static Offset<FlatDataJp.MiniGameShootingStageRewardExcel> EndMiniGameShootingStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.MiniGameShootingStageRewardExcel>(o);
  }
}
