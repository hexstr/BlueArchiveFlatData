...
public struct MultiFloorRaidStageExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.MultiFloorRaidStageExcel> CreateMultiFloorRaidStageExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataJp.MultiFloorRaidStageExcel> EndMultiFloorRaidStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.MultiFloorRaidStageExcel>(o);
  }
}
