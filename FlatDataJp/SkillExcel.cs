...
public struct SkillExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.BulletType BulletType { get { int o = __p.__offset(28); return o != 0 ? (FlatDataJp.BulletType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.BulletType.Normal; } }
  ...
  public static void AddBulletType(FlatBufferBuilder builder, FlatDataJp.BulletType bulletType) { builder.AddInt(12, (int)bulletType, 0); }
