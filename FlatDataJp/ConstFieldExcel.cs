...
public struct ConstFieldExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ConstFieldExcel> CreateConstFieldExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataJp.ConstFieldExcel> EndConstFieldExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ConstFieldExcel>(o);
  }
}
