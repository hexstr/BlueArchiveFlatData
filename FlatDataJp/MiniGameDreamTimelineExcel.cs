...
public struct MiniGameDreamTimelineExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.MiniGameDreamTimelineExcel> CreateMiniGameDreamTimelineExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataJp.MiniGameDreamTimelineExcel> EndMiniGameDreamTimelineExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.MiniGameDreamTimelineExcel>(o);
  }
}
