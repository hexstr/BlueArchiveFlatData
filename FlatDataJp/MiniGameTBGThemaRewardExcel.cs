...
public struct MiniGameTBGThemaRewardExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.MiniGameTBGThemaRewardType MiniGameTBGThemaRewardType { get { int o = __p.__offset(12); return o != 0 ? (FlatDataJp.MiniGameTBGThemaRewardType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.MiniGameTBGThemaRewardType.TreasureReward; } }
  ...
  public static Offset<FlatDataJp.MiniGameTBGThemaRewardExcel> CreateMiniGameTBGThemaRewardExcel(FlatBufferBuilder builder,
      long EventContentId = 0,
      int ThemaRound = 0,
      int ThemaUniqueId = 0,
      bool IsLoop = false,
      FlatDataJp.MiniGameTBGThemaRewardType miniGameTBGThemaRewardType = FlatDataJp.MiniGameTBGThemaRewardType.TreasureReward,
  ...
  public static void AddMiniGameTBGThemaRewardType(FlatBufferBuilder builder, FlatDataJp.MiniGameTBGThemaRewardType miniGameTBGThemaRewardType) { builder.AddInt(4, (int)miniGameTBGThemaRewardType, 0); }
  ...
  public static Offset<FlatDataJp.MiniGameTBGThemaRewardExcel> EndMiniGameTBGThemaRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.MiniGameTBGThemaRewardExcel>(o);
  }
}
