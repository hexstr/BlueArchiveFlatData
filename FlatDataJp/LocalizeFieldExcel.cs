...
public struct LocalizeFieldExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.LocalizeFieldExcel> CreateLocalizeFieldExcel(FlatBufferBuilder builder,
      uint Key = 0,
  ...
  public static Offset<FlatDataJp.LocalizeFieldExcel> EndLocalizeFieldExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.LocalizeFieldExcel>(o);
  }
}
