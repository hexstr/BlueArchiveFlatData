...
public struct MissionEmergencyCompleteExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.MissionEmergencyCompleteExcel> CreateMissionEmergencyCompleteExcel(FlatBufferBuilder builder,
      long MissionId = 0,
  ...
  public static Offset<FlatDataJp.MissionEmergencyCompleteExcel> EndMissionEmergencyCompleteExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.MissionEmergencyCompleteExcel>(o);
  }
}
