...
public struct CharacterStatExcel : IFlatbufferObject
{
  ...
  public long DamageRatio2Increase { get { int o = __p.__offset(112); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long DamageRatio2Decrease { get { int o = __p.__offset(114); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long DamagedRatio2Increase { get { int o = __p.__offset(116); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public long DamagedRatio2Decrease { get { int o = __p.__offset(118); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public FlatDataJp.TerrainAdaptationStat StreetBattleAdaptation { get { int o = __p.__offset(120); return o != 0 ? (FlatDataJp.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.TerrainAdaptationStat.D; } }
  public FlatDataJp.TerrainAdaptationStat OutdoorBattleAdaptation { get { int o = __p.__offset(122); return o != 0 ? (FlatDataJp.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.TerrainAdaptationStat.D; } }
  public FlatDataJp.TerrainAdaptationStat IndoorBattleAdaptation { get { int o = __p.__offset(124); return o != 0 ? (FlatDataJp.TerrainAdaptationStat)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.TerrainAdaptationStat.D; } }
  public long RegenCost { get { int o = __p.__offset(126); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  ...
  public static void StartCharacterStatExcel(FlatBufferBuilder builder) { builder.StartTable(62); }
  ...
  public static void AddDamageRatio2Increase(FlatBufferBuilder builder, long DamageRatio2Increase) { builder.AddLong(54, DamageRatio2Increase, 0); }
  public static void AddDamageRatio2Decrease(FlatBufferBuilder builder, long DamageRatio2Decrease) { builder.AddLong(55, DamageRatio2Decrease, 0); }
  public static void AddDamagedRatio2Increase(FlatBufferBuilder builder, long DamagedRatio2Increase) { builder.AddLong(56, DamagedRatio2Increase, 0); }
  public static void AddDamagedRatio2Decrease(FlatBufferBuilder builder, long DamagedRatio2Decrease) { builder.AddLong(57, DamagedRatio2Decrease, 0); }
  public static void AddStreetBattleAdaptation(FlatBufferBuilder builder, FlatDataJp.TerrainAdaptationStat StreetBattleAdaptation) { builder.AddInt(58, (int)StreetBattleAdaptation, 0); }
  public static void AddOutdoorBattleAdaptation(FlatBufferBuilder builder, FlatDataJp.TerrainAdaptationStat OutdoorBattleAdaptation) { builder.AddInt(59, (int)OutdoorBattleAdaptation, 0); }
  public static void AddIndoorBattleAdaptation(FlatBufferBuilder builder, FlatDataJp.TerrainAdaptationStat IndoorBattleAdaptation) { builder.AddInt(60, (int)IndoorBattleAdaptation, 0); }
  public static void AddRegenCost(FlatBufferBuilder builder, long RegenCost) { builder.AddLong(61, RegenCost, 0); }
