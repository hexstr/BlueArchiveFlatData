...
public struct PresetCharacterGroupSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.PresetCharacterGroupSettingExcel> CreatePresetCharacterGroupSettingExcel(FlatBufferBuilder builder,
      long CharacterId = 0,
  ...
  public static Offset<FlatDataJp.PresetCharacterGroupSettingExcel> EndPresetCharacterGroupSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.PresetCharacterGroupSettingExcel>(o);
  }
}
