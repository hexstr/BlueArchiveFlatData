...
public struct SoundUIExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.SoundUIExcel> CreateSoundUIExcel(FlatBufferBuilder builder,
      long ID = 0,
  ...
  public static Offset<FlatDataJp.SoundUIExcel> EndSoundUIExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.SoundUIExcel>(o);
  }
}
