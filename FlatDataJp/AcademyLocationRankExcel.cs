...
public struct AcademyLocationRankExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.AcademyLocationRankExcel> CreateAcademyLocationRankExcel(FlatBufferBuilder builder,
      long Rank = 0,
      long RankExp = 0,
      long TotalExp = 0) {
  ...
  public static Offset<FlatDataJp.AcademyLocationRankExcel> EndAcademyLocationRankExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.AcademyLocationRankExcel>(o);
  }
}
