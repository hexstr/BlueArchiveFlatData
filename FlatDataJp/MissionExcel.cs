...
public struct MissionExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.AccountState AccountType { get { int o = __p.__offset(30); return o != 0 ? (FlatDataJp.AccountState)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.AccountState.WaitingSignIn; } }
  public long AccountLevel { get { int o = __p.__offset(32); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public FlatDataJp.SuddenMissionContentType ContentTags(int j) { int o = __p.__offset(34); return o != 0 ? (FlatDataJp.SuddenMissionContentType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.SuddenMissionContentType)0; }
  public int ContentTagsLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.SuddenMissionContentType> GetContentTagsBytes() { return __p.__vector_as_span<FlatDataJp.SuddenMissionContentType>(34, 4); }
#else
  ...
  public FlatDataJp.MissionCompleteConditionType CompleteConditionType { get { int o = __p.__offset(38); return o != 0 ? (FlatDataJp.MissionCompleteConditionType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.MissionCompleteConditionType.None; } }
  ...
  public FlatDataJp.ParcelType MissionRewardParcelType(int j) { int o = __p.__offset(48); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.ParcelType)0; }
  public int MissionRewardParcelTypeLength { get { int o = __p.__offset(48); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.ParcelType> GetMissionRewardParcelTypeBytes() { return __p.__vector_as_span<FlatDataJp.ParcelType>(48, 4); }
#else
  public ArraySegment<byte>? GetMissionRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(48); }
#endif
  public FlatDataJp.ParcelType[] GetMissionRewardParcelTypeArray() { int o = __p.__offset(48); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.ParcelType[] a = new FlatDataJp.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static void AddAccountType(FlatBufferBuilder builder, FlatDataJp.AccountState AccountType) { builder.AddInt(13, (int)AccountType, 0); }
  ...
  public static void AddCompleteConditionType(FlatBufferBuilder builder, FlatDataJp.MissionCompleteConditionType CompleteConditionType) { builder.AddInt(17, (int)CompleteConditionType, 0); }
