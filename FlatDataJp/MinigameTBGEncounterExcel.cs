...
public struct MinigameTBGEncounterExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.TBGObjectType ObjectType { get { int o = __p.__offset(12); return o != 0 ? (FlatDataJp.TBGObjectType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.TBGObjectType.None; } }
  ...
  public static void AddObjectType(FlatBufferBuilder builder, FlatDataJp.TBGObjectType ObjectType) { builder.AddInt(4, (int)ObjectType, 0); }
