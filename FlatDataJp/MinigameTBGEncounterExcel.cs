...
public struct MinigameTBGEncounterExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.TBGThemaType ThemaType { get { int o = __p.__offset(12); return o != 0 ? (FlatDataJp.TBGThemaType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.TBGThemaType.None; } }
  public FlatDataJp.TBGObjectType ObjectType { get { int o = __p.__offset(14); return o != 0 ? (FlatDataJp.TBGObjectType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.TBGObjectType.None; } }
  ...
  public static Offset<FlatDataJp.MinigameTBGEncounterExcel> CreateMinigameTBGEncounterExcel(FlatBufferBuilder builder,
  ...
  public static void AddThemaType(FlatBufferBuilder builder, FlatDataJp.TBGThemaType ThemaType) { builder.AddInt(4, (int)ThemaType, 0); }
  public static void AddObjectType(FlatBufferBuilder builder, FlatDataJp.TBGObjectType ObjectType) { builder.AddInt(5, (int)ObjectType, 0); }
  ...
  public static Offset<FlatDataJp.MinigameTBGEncounterExcel> EndMinigameTBGEncounterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.MinigameTBGEncounterExcel>(o);
  }
}
