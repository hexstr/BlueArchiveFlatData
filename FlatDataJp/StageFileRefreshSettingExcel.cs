...
public struct StageFileRefreshSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.StageFileRefreshSettingExcel> CreateStageFileRefreshSettingExcel(FlatBufferBuilder builder,
      long GroundId = 0,
  ...
  public static Offset<FlatDataJp.StageFileRefreshSettingExcel> EndStageFileRefreshSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.StageFileRefreshSettingExcel>(o);
  }
}
