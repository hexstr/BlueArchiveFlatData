...
public struct MiniGamePlayGuideExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.MiniGamePlayGuideExcel> CreateMiniGamePlayGuideExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataJp.MiniGamePlayGuideExcel> EndMiniGamePlayGuideExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.MiniGamePlayGuideExcel>(o);
  }
}
