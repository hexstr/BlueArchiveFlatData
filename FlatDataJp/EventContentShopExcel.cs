...
public struct EventContentShopExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.ShopCategoryType CategoryType { get { int o = __p.__offset(10); return o != 0 ? (FlatDataJp.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ShopCategoryType.General; } }
  ...
  public static Offset<FlatDataJp.EventContentShopExcel> CreateEventContentShopExcel(FlatBufferBuilder builder,
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, FlatDataJp.ShopCategoryType CategoryType) { builder.AddInt(3, (int)CategoryType, 0); }
  ...
  public static Offset<FlatDataJp.EventContentShopExcel> EndEventContentShopExcel(FlatBufferBuilder builder) {
    ...
    return new Offset<FlatDataJp.EventContentShopExcel>(o);
  }
}
