...
public struct AcademyMessanger1Excel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.AcademyMessanger1Excel> CreateAcademyMessanger1Excel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataJp.AcademyMessanger1Excel> EndAcademyMessanger1Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.AcademyMessanger1Excel>(o);
  }
}
