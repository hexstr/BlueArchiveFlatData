...
public struct GuideMissionSeasonExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.ParcelType RequirementParcelType { get { int o = __p.__offset(42); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ParcelType.None; } }
  ...
  public FlatDataJp.GuideMissionTabType TabType { get { int o = __p.__offset(48); return o != 0 ? (FlatDataJp.GuideMissionTabType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.GuideMissionTabType.None; } }
  ...
  public static void AddRequirementParcelType(FlatBufferBuilder builder, FlatDataJp.ParcelType RequirementParcelType) { builder.AddInt(19, (int)RequirementParcelType, 0); }
  ...
  public static void AddTabType(FlatBufferBuilder builder, FlatDataJp.GuideMissionTabType TabType) { builder.AddInt(22, (int)TabType, 0); }
