...
public struct GuideMissionSeasonExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.AccountState AccountType { get { int o = __p.__offset(10); return o != 0 ? (FlatDataJp.AccountState)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.AccountState.WaitingSignIn; } }
  ...
  public FlatDataJp.ParcelType RequirementParcelType { get { int o = __p.__offset(38); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ParcelType.None; } }
  ...
  public FlatDataJp.GuideMissionTabType TabType { get { int o = __p.__offset(44); return o != 0 ? (FlatDataJp.GuideMissionTabType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.GuideMissionTabType.None; } }

  public static Offset<FlatDataJp.GuideMissionSeasonExcel> CreateGuideMissionSeasonExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      FlatDataJp.ParcelType RequirementParcelType = FlatDataJp.ParcelType.None,
      long RequirementParcelId = 0,
      int RequirementParcelAmount = 0,
      FlatDataJp.GuideMissionTabType TabType = FlatDataJp.GuideMissionTabType.None) {
  ...
  public static void AddAccountType(FlatBufferBuilder builder, FlatDataJp.AccountState AccountType) { builder.AddInt(3, (int)AccountType, 0); }
  ...
  public static void AddRequirementParcelType(FlatBufferBuilder builder, FlatDataJp.ParcelType RequirementParcelType) { builder.AddInt(17, (int)RequirementParcelType, 0); }
  ...
  public static void AddTabType(FlatBufferBuilder builder, FlatDataJp.GuideMissionTabType TabType) { builder.AddInt(20, (int)TabType, 0); }
  public static Offset<FlatDataJp.GuideMissionSeasonExcel> EndGuideMissionSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.GuideMissionSeasonExcel>(o);
  }
}
