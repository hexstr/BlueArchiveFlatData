...
public struct FieldContentStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.FieldContentStageRewardExcel> CreateFieldContentStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<FlatDataJp.FieldContentStageRewardExcel> EndFieldContentStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.FieldContentStageRewardExcel>(o);
  }
}
