...
public struct LocalizeSkillExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.LocalizeSkillExcel> CreateLocalizeSkillExcel(FlatBufferBuilder builder,
      uint Key = 0,
  ...
  public static Offset<FlatDataJp.LocalizeSkillExcel> EndLocalizeSkillExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.LocalizeSkillExcel>(o);
  }
}
