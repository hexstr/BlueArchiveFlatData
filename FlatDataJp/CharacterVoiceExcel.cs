...
public struct CharacterVoiceExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.CVCollectionType CVCollectionType { get { int o = __p.__offset(18); return o != 0 ? (FlatDataJp.CVCollectionType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.CVCollectionType.CVNormal; } }
  ...
  public FlatDataJp.Nation Nation(int j) { int o = __p.__offset(24); return o != 0 ? (FlatDataJp.Nation)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.Nation)0; }
  public int NationLength { get { int o = __p.__offset(24); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.Nation> GetNationBytes() { return __p.__vector_as_span<FlatDataJp.Nation>(24, 4); }
#else
  public ArraySegment<byte>? GetNationBytes() { return __p.__vector_as_arraysegment(24); }
#endif
  public FlatDataJp.Nation[] GetNationArray() { int o = __p.__offset(24); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.Nation[] a = new FlatDataJp.Nation[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.Nation)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatDataJp.CharacterVoiceExcel> CreateCharacterVoiceExcel(FlatBufferBuilder builder,
  ...
  public static void AddCVCollectionType(FlatBufferBuilder builder, FlatDataJp.CVCollectionType cVCollectionType) { builder.AddInt(7, (int)cVCollectionType, 0); }
  ...
  public static Offset<FlatDataJp.CharacterVoiceExcel> EndCharacterVoiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.CharacterVoiceExcel>(o);
  }
}
