...
public struct GoodsExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.ConsumeCondition ConsumeCondition(int j) { int o = __p.__offset(18); return o != 0 ? (FlatDataJp.ConsumeCondition)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.ConsumeCondition)0; }
  public int ConsumeConditionLength { get { int o = __p.__offset(18); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.ConsumeCondition> GetConsumeConditionBytes() { return __p.__vector_as_span<FlatDataJp.ConsumeCondition>(18, 4); }
#else
  public ArraySegment<byte>? GetConsumeConditionBytes() { return __p.__vector_as_arraysegment(18); }
#endif
  public FlatDataJp.ConsumeCondition[] GetConsumeConditionArray() { int o = __p.__offset(18); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.ConsumeCondition[] a = new FlatDataJp.ConsumeCondition[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.ConsumeCondition)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public FlatDataJp.ParcelType ParcelType(int j) { int o = __p.__offset(34); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.ParcelType)0; }
  public int ParcelTypeLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.ParcelType> GetParcelTypeBytes() { return __p.__vector_as_span<FlatDataJp.ParcelType>(34, 4); }
#else
  public ArraySegment<byte>? GetParcelTypeBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public FlatDataJp.ParcelType[] GetParcelTypeArray() { int o = __p.__offset(34); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.ParcelType[] a = new FlatDataJp.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static VectorOffset CreateConsumeConditionVector(FlatBufferBuilder builder, FlatDataJp.ConsumeCondition[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateConsumeConditionVectorBlock(FlatBufferBuilder builder, FlatDataJp.ConsumeCondition[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatDataJp.ConsumeCondition> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConsumeConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatDataJp.ConsumeCondition>(dataPtr, sizeInBytes); return builder.EndVector(); }
