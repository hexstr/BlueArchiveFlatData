...
public struct MultiFloorRaidStatChangeExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.StatType StatType(int j) { int o = __p.__offset(6); return o != 0 ? (FlatDataJp.StatType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.StatType)0; }
  public int StatTypeLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.StatType> GetStatTypeBytes() { return __p.__vector_as_span<FlatDataJp.StatType>(6, 4); }
#else
  public ArraySegment<byte>? GetStatTypeBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public FlatDataJp.StatType[] GetStatTypeArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.StatType[] a = new FlatDataJp.StatType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.StatType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatDataJp.MultiFloorRaidStatChangeExcel> CreateMultiFloorRaidStatChangeExcel(FlatBufferBuilder builder,
      long StatChangeId = 0,
  ...
  public static VectorOffset CreateStatTypeVector(FlatBufferBuilder builder, FlatDataJp.StatType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, FlatDataJp.StatType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatDataJp.StatType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStatTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatDataJp.StatType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatDataJp.MultiFloorRaidStatChangeExcel> EndMultiFloorRaidStatChangeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.MultiFloorRaidStatChangeExcel>(o);
  }
}
