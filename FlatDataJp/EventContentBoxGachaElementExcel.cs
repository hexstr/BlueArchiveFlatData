...
public struct EventContentBoxGachaElementExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.EventContentBoxGachaElementExcel> CreateEventContentBoxGachaElementExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataJp.EventContentBoxGachaElementExcel> EndEventContentBoxGachaElementExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.EventContentBoxGachaElementExcel>(o);
  }
}
