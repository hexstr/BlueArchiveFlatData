...
public struct EventContentPlayGuideExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.EventContentPlayGuideExcel> CreateEventContentPlayGuideExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataJp.EventContentPlayGuideExcel> EndEventContentPlayGuideExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.EventContentPlayGuideExcel>(o);
  }
}
