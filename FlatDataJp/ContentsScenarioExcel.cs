...
public struct ContentsScenarioExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.ScenarioContentType ScenarioContentType { get { int o = __p.__offset(10); return o != 0 ? (FlatDataJp.ScenarioContentType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ScenarioContentType.Prologue; } }
  ...
  public static void AddScenarioContentType(FlatBufferBuilder builder, FlatDataJp.ScenarioContentType scenarioContentType) { builder.AddInt(3, (int)scenarioContentType, 0); }
