...
public struct LimitedStageSeasonExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.LimitedStageSeasonExcel> CreateLimitedStageSeasonExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataJp.LimitedStageSeasonExcel> EndLimitedStageSeasonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.LimitedStageSeasonExcel>(o);
  }
}
