...
public struct ShopFreeRecruitExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.ShopFreeRecruitType FreeRecruitType { get { int o = __p.__offset(10); return o != 0 ? (FlatDataJp.ShopFreeRecruitType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ShopFreeRecruitType.None; } }
  ...
  public static Offset<FlatDataJp.ShopFreeRecruitExcel> CreateShopFreeRecruitExcel(FlatBufferBuilder builder,
      long Id = 0,
      StringOffset FreeRecruitPeriodFromOffset = default(StringOffset),
      StringOffset FreeRecruitPeriodToOffset = default(StringOffset),
      FlatDataJp.ShopFreeRecruitType FreeRecruitType = FlatDataJp.ShopFreeRecruitType.None,
  ...
  public static void AddFreeRecruitType(FlatBufferBuilder builder, FlatDataJp.ShopFreeRecruitType FreeRecruitType) { builder.AddInt(3, (int)FreeRecruitType, 0); }
  ...
  public static Offset<FlatDataJp.ShopFreeRecruitExcel> EndShopFreeRecruitExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ShopFreeRecruitExcel>(o);
  }
}
