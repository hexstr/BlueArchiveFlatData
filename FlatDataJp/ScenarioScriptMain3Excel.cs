...
public struct ScenarioScriptMain3Excel : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_3_3(); }
  public static ScenarioScriptMain3Excel GetRootAsScenarioScriptMain3Excel(ByteBuffer _bb) { return GetRootAsScenarioScriptMain3Excel(_bb, new ScenarioScriptMain3Excel()); }
  public static ScenarioScriptMain3Excel GetRootAsScenarioScriptMain3Excel(ByteBuffer _bb, ScenarioScriptMain3Excel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ScenarioScriptMain3Excel __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlatDataJp.ScenarioScriptMain3Excel> CreateScenarioScriptMain3Excel(FlatBufferBuilder builder,
      long GroupId = 0,
    ...
    ScenarioScriptMain3Excel.AddBGEffect(builder, BGEffect);
    ScenarioScriptMain3Excel.AddBGName(builder, BGName);
    ScenarioScriptMain3Excel.AddTransition(builder, Transition);
    ScenarioScriptMain3Excel.AddSound(builder, SoundOffset);
    return ScenarioScriptMain3Excel.EndScenarioScriptMain3Excel(builder);
  }

  public static void StartScenarioScriptMain3Excel(FlatBufferBuilder builder) { builder.StartTable(11); }
  ...
  public static Offset<FlatDataJp.ScenarioScriptMain3Excel> EndScenarioScriptMain3Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ScenarioScriptMain3Excel>(o);
  }
}
