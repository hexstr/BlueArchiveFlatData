...
public struct GuideMissionExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.Tag CompleteConditionParameterTag(int j) { int o = __p.__offset(30); return o != 0 ? (FlatDataJp.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.Tag)0; }
  public int CompleteConditionParameterTagLength { get { int o = __p.__offset(30); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.Tag> GetCompleteConditionParameterTagBytes() { return __p.__vector_as_span<FlatDataJp.Tag>(30, 4); }
#else
  public ArraySegment<byte>? GetCompleteConditionParameterTagBytes() { return __p.__vector_as_arraysegment(30); }
#endif
  public FlatDataJp.Tag[] GetCompleteConditionParameterTagArray() { int o = __p.__offset(30); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.Tag[] a = new FlatDataJp.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.Tag)__p.bb.GetInt(p + i * 4); } return a; }
