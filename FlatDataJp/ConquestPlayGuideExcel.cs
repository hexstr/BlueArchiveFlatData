...
public struct ConquestPlayGuideExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ConquestPlayGuideExcel> CreateConquestPlayGuideExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataJp.ConquestPlayGuideExcel> EndConquestPlayGuideExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ConquestPlayGuideExcel>(o);
  }
}
