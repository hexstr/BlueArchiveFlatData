...
public struct ScenarioEffectExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ScenarioEffectExcel> CreateScenarioEffectExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataJp.ScenarioEffectExcel> EndScenarioEffectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ScenarioEffectExcel>(o);
  }
}
