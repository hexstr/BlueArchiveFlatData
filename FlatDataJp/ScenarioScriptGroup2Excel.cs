...
public struct ScenarioScriptGroup2Excel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ScenarioScriptGroup2Excel> CreateScenarioScriptGroup2Excel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static void StartScenarioScriptGroup2Excel(FlatBufferBuilder builder) { builder.StartTable(11); }
  ...
  public static Offset<FlatDataJp.ScenarioScriptGroup2Excel> EndScenarioScriptGroup2Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ScenarioScriptGroup2Excel>(o);
  }
}
