...
public struct CafeProductionExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.ParcelType CafeProductionParcelType { get { int o = __p.__offset(8); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ParcelType.None; } }
  ...
  public static Offset<FlatDataJp.CafeProductionExcel> CreateCafeProductionExcel(FlatBufferBuilder builder,
      long CafeId = 0,
      long Rank = 0,
      FlatDataJp.ParcelType CafeProductionParcelType = FlatDataJp.ParcelType.None,
  ...
  public static void AddCafeProductionParcelType(FlatBufferBuilder builder, FlatDataJp.ParcelType CafeProductionParcelType) { builder.AddInt(2, (int)CafeProductionParcelType, 0); }
  ...
  public static Offset<FlatDataJp.CafeProductionExcel> EndCafeProductionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.CafeProductionExcel>(o);
  }
}
