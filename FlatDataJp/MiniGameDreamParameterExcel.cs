...
public struct MiniGameDreamParameterExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.DreamMakerParameterType ParameterType { get { int o = __p.__offset(8); return o != 0 ? (FlatDataJp.DreamMakerParameterType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.DreamMakerParameterType.None; } }
  ...
  public static Offset<FlatDataJp.MiniGameDreamParameterExcel> CreateMiniGameDreamParameterExcel(FlatBufferBuilder builder,
      long Id = 0,
      long EventContentId = 0,
      FlatDataJp.DreamMakerParameterType ParameterType = FlatDataJp.DreamMakerParameterType.None,
  ...
  public static void AddParameterType(FlatBufferBuilder builder, FlatDataJp.DreamMakerParameterType ParameterType) { builder.AddInt(2, (int)ParameterType, 0); }
  ...
  public static Offset<FlatDataJp.MiniGameDreamParameterExcel> EndMiniGameDreamParameterExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.MiniGameDreamParameterExcel>(o);
  }
}
