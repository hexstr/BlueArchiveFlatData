...
public struct VoiceSpineExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.VoiceSpineExcel> CreateVoiceSpineExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      uint Id = 0,
  ...
  public static Offset<FlatDataJp.VoiceSpineExcel> EndVoiceSpineExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.VoiceSpineExcel>(o);
  }
}
