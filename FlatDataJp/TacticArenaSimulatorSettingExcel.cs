...
public struct TacticArenaSimulatorSettingExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.ArenaSimulatorServer AttackerFrom { get { int o = __p.__offset(8); return o != 0 ? (FlatDataJp.ArenaSimulatorServer)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ArenaSimulatorServer.Preset; } }
  ...
  public FlatDataJp.ArenaSimulatorServer DefenderFrom { get { int o = __p.__offset(20); return o != 0 ? (FlatDataJp.ArenaSimulatorServer)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ArenaSimulatorServer.Preset; } }
  ...
  public static Offset<FlatDataJp.TacticArenaSimulatorSettingExcel> CreateTacticArenaSimulatorSettingExcel(FlatBufferBuilder builder,
      long Order = 0,
      long Repeat = 0,
      FlatDataJp.ArenaSimulatorServer AttackerFrom = FlatDataJp.ArenaSimulatorServer.Preset,
      ...
      FlatDataJp.ArenaSimulatorServer DefenderFrom = FlatDataJp.ArenaSimulatorServer.Preset,
  ...
  public static void AddAttackerFrom(FlatBufferBuilder builder, FlatDataJp.ArenaSimulatorServer AttackerFrom) { builder.AddInt(2, (int)AttackerFrom, 0); }
  ...
  public static void AddDefenderFrom(FlatBufferBuilder builder, FlatDataJp.ArenaSimulatorServer DefenderFrom) { builder.AddInt(8, (int)DefenderFrom, 0); }
  ...
  public static Offset<FlatDataJp.TacticArenaSimulatorSettingExcel> EndTacticArenaSimulatorSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.TacticArenaSimulatorSettingExcel>(o);
  }
}
