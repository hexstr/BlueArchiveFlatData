...
public struct EventContentFortuneGachaExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.EventContentFortuneGachaExcel> CreateEventContentFortuneGachaExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataJp.EventContentFortuneGachaExcel> EndEventContentFortuneGachaExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.EventContentFortuneGachaExcel>(o);
  }
}
