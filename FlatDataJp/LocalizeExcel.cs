...
public struct LocalizeExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.LocalizeExcel> CreateLocalizeExcel(FlatBufferBuilder builder,
      uint Key = 0,
  ...
  public static Offset<FlatDataJp.LocalizeExcel> EndLocalizeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.LocalizeExcel>(o);
  }
}
