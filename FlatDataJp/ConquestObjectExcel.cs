...
public struct ConquestObjectExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.ParcelType ConquestRewardParcelType { get { int o = __p.__offset(16); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ParcelType.None; } }
  ...
  public static Offset<FlatDataJp.ConquestObjectExcel> CreateConquestObjectExcel(FlatBufferBuilder builder,
      ...
      FlatDataJp.ParcelType ConquestRewardParcelType = FlatDataJp.ParcelType.None,
  ...
  public static void AddConquestRewardParcelType(FlatBufferBuilder builder, FlatDataJp.ParcelType ConquestRewardParcelType) { builder.AddInt(6, (int)ConquestRewardParcelType, 0); }
  ...
  public static Offset<FlatDataJp.ConquestObjectExcel> EndConquestObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ConquestObjectExcel>(o);
  }
}
