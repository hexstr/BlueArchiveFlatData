...
public struct ConquestCameraSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ConquestCameraSettingExcel> CreateConquestCameraSettingExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataJp.ConquestCameraSettingExcel> EndConquestCameraSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ConquestCameraSettingExcel>(o);
  }
}
