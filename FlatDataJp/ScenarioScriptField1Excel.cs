...
public struct ScenarioScriptField1Excel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ScenarioScriptField1Excel> CreateScenarioScriptField1Excel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<FlatDataJp.ScenarioScriptField1Excel> EndScenarioScriptField1Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ScenarioScriptField1Excel>(o);
  }
}
