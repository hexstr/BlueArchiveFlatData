...
public struct FieldTutorialExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.FieldTutorialType TutorialType(int j) { int o = __p.__offset(6); return o != 0 ? (FlatDataJp.FieldTutorialType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.FieldTutorialType)0; }
  public int TutorialTypeLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.FieldTutorialType> GetTutorialTypeBytes() { return __p.__vector_as_span<FlatDataJp.FieldTutorialType>(6, 4); }
#else
  public ArraySegment<byte>? GetTutorialTypeBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public FlatDataJp.FieldTutorialType[] GetTutorialTypeArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.FieldTutorialType[] a = new FlatDataJp.FieldTutorialType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.FieldTutorialType)__p.bb.GetInt(p + i * 4); } return a; }
  public FlatDataJp.FieldConditionType ConditionType(int j) { int o = __p.__offset(8); return o != 0 ? (FlatDataJp.FieldConditionType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.FieldConditionType)0; }
  public int ConditionTypeLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.FieldConditionType> GetConditionTypeBytes() { return __p.__vector_as_span<FlatDataJp.FieldConditionType>(8, 4); }
#else
  public ArraySegment<byte>? GetConditionTypeBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public FlatDataJp.FieldConditionType[] GetConditionTypeArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.FieldConditionType[] a = new FlatDataJp.FieldConditionType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.FieldConditionType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatDataJp.FieldTutorialExcel> CreateFieldTutorialExcel(FlatBufferBuilder builder,
      long SeasonId = 0,
  ...
  public static VectorOffset CreateTutorialTypeVector(FlatBufferBuilder builder, FlatDataJp.FieldTutorialType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateTutorialTypeVectorBlock(FlatBufferBuilder builder, FlatDataJp.FieldTutorialType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTutorialTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatDataJp.FieldTutorialType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTutorialTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatDataJp.FieldTutorialType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatDataJp.FieldTutorialExcel> EndFieldTutorialExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.FieldTutorialExcel>(o);
  }
}
