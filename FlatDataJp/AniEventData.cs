...
public struct AniEventData : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.AniEventData> CreateAniEventData(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataJp.AniEventData> EndAniEventData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.AniEventData>(o);
  }
}
