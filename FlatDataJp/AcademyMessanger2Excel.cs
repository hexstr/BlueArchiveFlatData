...
public struct AcademyMessanger2Excel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.AcademyMessanger2Excel> CreateAcademyMessanger2Excel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataJp.AcademyMessanger2Excel> EndAcademyMessanger2Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.AcademyMessanger2Excel>(o);
  }
}
