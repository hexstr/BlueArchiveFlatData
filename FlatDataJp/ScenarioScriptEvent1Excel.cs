...
public struct ScenarioScriptEvent1Excel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ScenarioScriptEvent1Excel> CreateScenarioScriptEvent1Excel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static void StartScenarioScriptEvent1Excel(FlatBufferBuilder builder) { builder.StartTable(11); }
  ...
  public static Offset<FlatDataJp.ScenarioScriptEvent1Excel> EndScenarioScriptEvent1Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ScenarioScriptEvent1Excel>(o);
  }
}
