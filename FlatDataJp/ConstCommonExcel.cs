...
public struct ConstCommonExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.ParcelType AcademyEnterCostType { get { int o = __p.__offset(84); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ParcelType.None; } }
  ...
  public FlatDataJp.ShopCategoryType TutorialShopCategoryType { get { int o = __p.__offset(136); return o != 0 ? (FlatDataJp.ShopCategoryType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ShopCategoryType.General; } }
  ...
  public FlatDataJp.ParcelType RaidEnterCostType { get { int o = __p.__offset(244); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ParcelType.None; } }
  ...
  public FlatDataJp.ParcelType TimeAttackDungeonEnterCostType { get { int o = __p.__offset(254); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ParcelType.None; } }
  ...
  public FlatDataJp.Tag CommonFavorItemTags(int j) { int o = __p.__offset(264); return o != 0 ? (FlatDataJp.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.Tag)0; }
  public int CommonFavorItemTagsLength { get { int o = __p.__offset(264); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.Tag> GetCommonFavorItemTagsBytes() { return __p.__vector_as_span<FlatDataJp.Tag>(264, 4); }
#else
  public ArraySegment<byte>? GetCommonFavorItemTagsBytes() { return __p.__vector_as_arraysegment(264); }
#endif
  public FlatDataJp.Tag[] GetCommonFavorItemTagsArray() { int o = __p.__offset(264); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.Tag[] a = new FlatDataJp.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public int CharProfileRowIntervalKr { get { int o = __p.__offset(312); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public int CharProfileRowIntervalJp { get { int o = __p.__offset(314); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public int CharProfilePopupRowIntervalKr { get { int o = __p.__offset(316); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public int CharProfilePopupRowIntervalJp { get { int o = __p.__offset(318); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  public static void AddAcademyEnterCostType(FlatBufferBuilder builder, FlatDataJp.ParcelType AcademyEnterCostType) { builder.AddInt(40, (int)AcademyEnterCostType, 0); }
  ...
  public static void AddTutorialShopCategoryType(FlatBufferBuilder builder, FlatDataJp.ShopCategoryType TutorialShopCategoryType) { builder.AddInt(66, (int)TutorialShopCategoryType, 0); }
  ...
  public static void AddRaidEnterCostType(FlatBufferBuilder builder, FlatDataJp.ParcelType RaidEnterCostType) { builder.AddInt(120, (int)RaidEnterCostType, 0); }
  ...
  public static void AddTimeAttackDungeonEnterCostType(FlatBufferBuilder builder, FlatDataJp.ParcelType TimeAttackDungeonEnterCostType) { builder.AddInt(125, (int)TimeAttackDungeonEnterCostType, 0); }
  ...
  public static void AddCharProfileRowIntervalKr(FlatBufferBuilder builder, int CharProfileRowIntervalKr) { builder.AddInt(154, CharProfileRowIntervalKr, 0); }
  public static void AddCharProfileRowIntervalJp(FlatBufferBuilder builder, int CharProfileRowIntervalJp) { builder.AddInt(155, CharProfileRowIntervalJp, 0); }
  public static void AddCharProfilePopupRowIntervalKr(FlatBufferBuilder builder, int CharProfilePopupRowIntervalKr) { builder.AddInt(156, CharProfilePopupRowIntervalKr, 0); }
  public static void AddCharProfilePopupRowIntervalJp(FlatBufferBuilder builder, int CharProfilePopupRowIntervalJp) { builder.AddInt(157, CharProfilePopupRowIntervalJp, 0); }
