...
public struct MinigameTBGSeasonExcel : IFlatbufferObject
{
  ...
  public long DefaultItemId { get { int o = __p.__offset(10); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  ...
  public FlatDataJp.ParcelType EchelonRevivalCostType { get { int o = __p.__offset(20); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ParcelType.None; } }
  ...
  public string MapImagePath { get { int o = __p.__offset(34); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetMapImagePathBytes() { return __p.__vector_as_span<byte>(34, 1); }
#else
  public ArraySegment<byte>? GetMapImagePathBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public byte[] GetMapImagePathArray() { return __p.__vector_as_array<byte>(34); }
  public string MapNameLocalize { get { int o = __p.__offset(36); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetMapNameLocalizeBytes() { return __p.__vector_as_span<byte>(36, 1); }
#else
  public ArraySegment<byte>? GetMapNameLocalizeBytes() { return __p.__vector_as_arraysegment(36); }
#endif
  public byte[] GetMapNameLocalizeArray() { return __p.__vector_as_array<byte>(36); }
  ...
  public static Offset<FlatDataJp.MinigameTBGSeasonExcel> CreateMinigameTBGSeasonExcel(FlatBufferBuilder builder,
    ...
    MinigameTBGSeasonExcel.AddDefaultItemId(builder, DefaultItemId);
  ...
  public static void StartMinigameTBGSeasonExcel(FlatBufferBuilder builder) { builder.StartTable(17); }
  ...
  public static void AddDefaultItemId(FlatBufferBuilder builder, long DefaultItemId) { builder.AddLong(3, DefaultItemId, 0); }
  ...
  public static void AddEchelonRevivalCostType(FlatBufferBuilder builder, FlatDataJp.ParcelType EchelonRevivalCostType) { builder.AddInt(8, (int)EchelonRevivalCostType, 0); }
  ...
  public static void AddMapImagePath(FlatBufferBuilder builder, StringOffset MapImagePathOffset) { builder.AddOffset(15, MapImagePathOffset.Value, 0); }
  public static void AddMapNameLocalize(FlatBufferBuilder builder, StringOffset MapNameLocalizeOffset) { builder.AddOffset(16, MapNameLocalizeOffset.Value, 0); }
