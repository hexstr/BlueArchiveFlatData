...
public struct RecipeSelectionGroupExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.RecipeSelectionGroupExcel> CreateRecipeSelectionGroupExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataJp.RecipeSelectionGroupExcel> EndRecipeSelectionGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.RecipeSelectionGroupExcel>(o);
  }
}
