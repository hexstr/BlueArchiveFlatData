...
public struct TacticSimulatorSettingExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.TacticSimulatorSettingExcel> CreateTacticSimulatorSettingExcel(FlatBufferBuilder builder,
      long GroundId = 0,
      long GetExp = 0,
      long GetStarGrade = 0,
      long Equipment = 0) {
  ...
  public static Offset<FlatDataJp.TacticSimulatorSettingExcel> EndTacticSimulatorSettingExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.TacticSimulatorSettingExcel>(o);
  }
}
