...
public struct StickerPageContentExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.StickerGetConditionType StickerGetConditionType { get { int o = __p.__offset(12); return o != 0 ? (FlatDataJp.StickerGetConditionType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.StickerGetConditionType.None; } }
  public FlatDataJp.StickerCheckPassType StickerCheckPassType { get { int o = __p.__offset(14); return o != 0 ? (FlatDataJp.StickerCheckPassType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.StickerCheckPassType.None; } }
  public FlatDataJp.GetStickerConditionType GetStickerConditionType { get { int o = __p.__offset(16); return o != 0 ? (FlatDataJp.GetStickerConditionType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.GetStickerConditionType.None; } }
  ...
  public FlatDataJp.Tag StickerGetConditionParameterTag(int j) { int o = __p.__offset(22); return o != 0 ? (FlatDataJp.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.Tag)0; }
  public int StickerGetConditionParameterTagLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.Tag> GetStickerGetConditionParameterTagBytes() { return __p.__vector_as_span<FlatDataJp.Tag>(22, 4); }
#else
  public ArraySegment<byte>? GetStickerGetConditionParameterTagBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public FlatDataJp.Tag[] GetStickerGetConditionParameterTagArray() { int o = __p.__offset(22); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.Tag[] a = new FlatDataJp.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatDataJp.StickerPageContentExcel> CreateStickerPageContentExcel(FlatBufferBuilder builder,
      long Id = 0,
      long StickerGroupId = 0,
      long StickerPageId = 0,
      long StickerSlot = 0,
      FlatDataJp.StickerGetConditionType stickerGetConditionType = FlatDataJp.StickerGetConditionType.None,
      FlatDataJp.StickerCheckPassType stickerCheckPassType = FlatDataJp.StickerCheckPassType.None,
      FlatDataJp.GetStickerConditionType getStickerConditionType = FlatDataJp.GetStickerConditionType.None,
  ...
  public static void AddStickerGetConditionType(FlatBufferBuilder builder, FlatDataJp.StickerGetConditionType stickerGetConditionType) { builder.AddInt(4, (int)stickerGetConditionType, 0); }
  public static void AddStickerCheckPassType(FlatBufferBuilder builder, FlatDataJp.StickerCheckPassType stickerCheckPassType) { builder.AddInt(5, (int)stickerCheckPassType, 0); }
  public static void AddGetStickerConditionType(FlatBufferBuilder builder, FlatDataJp.GetStickerConditionType getStickerConditionType) { builder.AddInt(6, (int)getStickerConditionType, 0); }
  ...
  public static VectorOffset CreateStickerGetConditionParameterTagVector(FlatBufferBuilder builder, FlatDataJp.Tag[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateStickerGetConditionParameterTagVectorBlock(FlatBufferBuilder builder, FlatDataJp.Tag[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStickerGetConditionParameterTagVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatDataJp.Tag> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateStickerGetConditionParameterTagVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatDataJp.Tag>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatDataJp.StickerPageContentExcel> EndStickerPageContentExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.StickerPageContentExcel>(o);
  }
}
