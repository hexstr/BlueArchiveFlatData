...
public struct EventContentStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.EventContentStageRewardExcel> CreateEventContentStageRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static Offset<FlatDataJp.EventContentStageRewardExcel> EndEventContentStageRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.EventContentStageRewardExcel>(o);
  }
}
