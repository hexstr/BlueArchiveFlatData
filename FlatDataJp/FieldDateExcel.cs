...
public struct FieldDateExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.FieldConditionType StartConditionType { get { int o = __p.__offset(14); return o != 0 ? (FlatDataJp.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.FieldConditionType.Invalid; } }
  public long StartConditionId { get { int o = __p.__offset(16); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }
  public FlatDataJp.FieldConditionType EndConditionType { get { int o = __p.__offset(18); return o != 0 ? (FlatDataJp.FieldConditionType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.FieldConditionType.Invalid; } }
  ...
  public static Offset<FlatDataJp.FieldDateExcel> CreateFieldDateExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long SeasonId = 0,
      long OpenDate = 0,
      StringOffset DateLocalizeKeyOffset = default(StringOffset),
      long EntrySceneId = 0,
      FlatDataJp.FieldConditionType StartConditionType = FlatDataJp.FieldConditionType.Invalid,
      long StartConditionId = 0,
      FlatDataJp.FieldConditionType EndConditionType = FlatDataJp.FieldConditionType.Invalid,
  ...
  public static void AddStartConditionType(FlatBufferBuilder builder, FlatDataJp.FieldConditionType StartConditionType) { builder.AddInt(5, (int)StartConditionType, 0); }
  ...
  public static void AddEndConditionType(FlatBufferBuilder builder, FlatDataJp.FieldConditionType EndConditionType) { builder.AddInt(7, (int)EndConditionType, 0); }
  ...
  public static Offset<FlatDataJp.FieldDateExcel> EndFieldDateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.FieldDateExcel>(o);
  }
}
