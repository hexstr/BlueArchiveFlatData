...
public struct FurnitureTemplateExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.FurnitureTemplateExcel> CreateFurnitureTemplateExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataJp.FurnitureTemplateExcel> EndFurnitureTemplateExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.FurnitureTemplateExcel>(o);
  }
}
