...
public struct ArenaNPCExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.Rarity ExceptionCharacterRarities(int j) { int o = __p.__offset(18); return o != 0 ? (FlatDataJp.Rarity)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.Rarity)0; }
  public int ExceptionCharacterRaritiesLength { get { int o = __p.__offset(18); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.Rarity> GetExceptionCharacterRaritiesBytes() { return __p.__vector_as_span<FlatDataJp.Rarity>(18, 4); }
#else
  public ArraySegment<byte>? GetExceptionCharacterRaritiesBytes() { return __p.__vector_as_arraysegment(18); }
#endif
  public FlatDataJp.Rarity[] GetExceptionCharacterRaritiesArray() { int o = __p.__offset(18); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.Rarity[] a = new FlatDataJp.Rarity[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.Rarity)__p.bb.GetInt(p + i * 4); } return a; }
