...
public struct MiniGameDreamScheduleExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.MiniGameDreamScheduleExcel> CreateMiniGameDreamScheduleExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataJp.MiniGameDreamScheduleExcel> EndMiniGameDreamScheduleExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.MiniGameDreamScheduleExcel>(o);
  }
}
