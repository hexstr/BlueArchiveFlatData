...
public struct VideoExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.Nation Nation(int j) { int o = __p.__offset(6); return o != 0 ? (FlatDataJp.Nation)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.Nation)0; }
  public int NationLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.Nation> GetNationBytes() { return __p.__vector_as_span<FlatDataJp.Nation>(6, 4); }
#else
  public ArraySegment<byte>? GetNationBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public FlatDataJp.Nation[] GetNationArray() { int o = __p.__offset(6); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.Nation[] a = new FlatDataJp.Nation[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.Nation)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatDataJp.VideoExcel> CreateVideoExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataJp.VideoExcel> EndVideoExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.VideoExcel>(o);
  }
}
