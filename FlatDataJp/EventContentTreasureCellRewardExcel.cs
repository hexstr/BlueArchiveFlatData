...
public struct EventContentTreasureCellRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.EventContentTreasureCellRewardExcel> CreateEventContentTreasureCellRewardExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataJp.EventContentTreasureCellRewardExcel> EndEventContentTreasureCellRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.EventContentTreasureCellRewardExcel>(o);
  }
}
