...
public struct CharacterDialogEventExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.CVCollectionType CVCollectionType { get { int o = __p.__offset(40); return o != 0 ? (FlatDataJp.CVCollectionType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.CVCollectionType.CVNormal; } }
  ...
  public static void AddCVCollectionType(FlatBufferBuilder builder, FlatDataJp.CVCollectionType cVCollectionType) { builder.AddInt(18, (int)cVCollectionType, 0); }
