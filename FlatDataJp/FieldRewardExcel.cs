...
public struct FieldRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.FieldRewardExcel> CreateFieldRewardExcel(FlatBufferBuilder builder,
      long GroupId = 0,
      int RewardProb = 0,
  ...
  public static Offset<FlatDataJp.FieldRewardExcel> EndFieldRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.FieldRewardExcel>(o);
  }
}
