...
public struct ArenaMapExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ArenaMapExcel> CreateArenaMapExcel(FlatBufferBuilder builder,
      long UniqueId = 0,
      long TerrainType = 0,
  ...
  public static Offset<FlatDataJp.ArenaMapExcel> EndArenaMapExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ArenaMapExcel>(o);
  }
}
