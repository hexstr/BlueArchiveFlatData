...
public struct LocalizeCodeExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.LocalizeCodeExcel> CreateLocalizeCodeExcel(FlatBufferBuilder builder,
      uint Key = 0,
  ...
  public static void StartLocalizeCodeExcel(FlatBufferBuilder builder) { builder.StartTable(3); }
  ...
  public static Offset<FlatDataJp.LocalizeCodeExcel> EndLocalizeCodeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.LocalizeCodeExcel>(o);
  }
}
