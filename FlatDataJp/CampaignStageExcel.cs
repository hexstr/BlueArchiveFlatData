...
public struct CampaignStageExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.ContentType ContentType { get { int o = __p.__offset(50); return o != 0 ? (FlatDataJp.ContentType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ContentType.None; } }
  ...
  public static void StartCampaignStageExcel(FlatBufferBuilder builder) { builder.StartTable(28); }
  ...
  public static void AddContentType(FlatBufferBuilder builder, FlatDataJp.ContentType contentType) { builder.AddInt(23, (int)contentType, 0); }
