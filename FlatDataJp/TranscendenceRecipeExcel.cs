...
public struct TranscendenceRecipeExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.CurrencyTypes CostCurrencyType { get { int o = __p.__offset(8); return o != 0 ? (FlatDataJp.CurrencyTypes)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.CurrencyTypes.Invalid; } }
  ...
  public static Offset<FlatDataJp.TranscendenceRecipeExcel> CreateTranscendenceRecipeExcel(FlatBufferBuilder builder,
      long Id = 0,
      StringOffset DevNameOffset = default(StringOffset),
      FlatDataJp.CurrencyTypes CostCurrencyType = FlatDataJp.CurrencyTypes.Invalid,
  ...
  public static void AddCostCurrencyType(FlatBufferBuilder builder, FlatDataJp.CurrencyTypes CostCurrencyType) { builder.AddInt(2, (int)CostCurrencyType, 0); }
  ...
  public static Offset<FlatDataJp.TranscendenceRecipeExcel> EndTranscendenceRecipeExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.TranscendenceRecipeExcel>(o);
  }
}
