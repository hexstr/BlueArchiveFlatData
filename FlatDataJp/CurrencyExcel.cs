...
public struct CurrencyExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.DailyRefillType DailyRefillType { get { int o = __p.__offset(30); return o != 0 ? (FlatDataJp.DailyRefillType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.DailyRefillType.None; } }
  ...
  public static Offset<FlatDataJp.CurrencyExcel> CreateCurrencyExcel(FlatBufferBuilder builder,
      ...
      FlatDataJp.DailyRefillType dailyRefillType = FlatDataJp.DailyRefillType.None,
  ...
  public static void AddDailyRefillType(FlatBufferBuilder builder, FlatDataJp.DailyRefillType dailyRefillType) { builder.AddInt(13, (int)dailyRefillType, 0); }
