...
public struct MinigameTBGDiceExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.TBGProbModifyCondition ProbModifyCondition(int j) { int o = __p.__offset(14); return o != 0 ? (FlatDataJp.TBGProbModifyCondition)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.TBGProbModifyCondition)0; }
  public int ProbModifyConditionLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.TBGProbModifyCondition> GetProbModifyConditionBytes() { return __p.__vector_as_span<FlatDataJp.TBGProbModifyCondition>(14, 4); }
#else
  public ArraySegment<byte>? GetProbModifyConditionBytes() { return __p.__vector_as_arraysegment(14); }
#endif
  public FlatDataJp.TBGProbModifyCondition[] GetProbModifyConditionArray() { int o = __p.__offset(14); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.TBGProbModifyCondition[] a = new FlatDataJp.TBGProbModifyCondition[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.TBGProbModifyCondition)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatDataJp.MinigameTBGDiceExcel> CreateMinigameTBGDiceExcel(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateProbModifyConditionVector(FlatBufferBuilder builder, FlatDataJp.TBGProbModifyCondition[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateProbModifyConditionVectorBlock(FlatBufferBuilder builder, FlatDataJp.TBGProbModifyCondition[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateProbModifyConditionVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatDataJp.TBGProbModifyCondition> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateProbModifyConditionVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatDataJp.TBGProbModifyCondition>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatDataJp.MinigameTBGDiceExcel> EndMinigameTBGDiceExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.MinigameTBGDiceExcel>(o);
  }
}
