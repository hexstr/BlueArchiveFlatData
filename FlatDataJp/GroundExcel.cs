...
public struct GroundExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.TacticSpeed ForcedTacticSpeed { get { int o = __p.__offset(82); return o != 0 ? (FlatDataJp.TacticSpeed)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.TacticSpeed.None; } }
  public FlatDataJp.TacticSkillUse ForcedSkillUse { get { int o = __p.__offset(84); return o != 0 ? (FlatDataJp.TacticSkillUse)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.TacticSkillUse.None; } }
  public FlatDataJp.ShowSkillCutIn ShowNPCSkillCutIn { get { int o = __p.__offset(86); return o != 0 ? (FlatDataJp.ShowSkillCutIn)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ShowSkillCutIn.None; } }
  ...
  public static void AddForcedTacticSpeed(FlatBufferBuilder builder, FlatDataJp.TacticSpeed ForcedTacticSpeed) { builder.AddInt(39, (int)ForcedTacticSpeed, 0); }
  public static void AddForcedSkillUse(FlatBufferBuilder builder, FlatDataJp.TacticSkillUse ForcedSkillUse) { builder.AddInt(40, (int)ForcedSkillUse, 0); }
  public static void AddShowNPCSkillCutIn(FlatBufferBuilder builder, FlatDataJp.ShowSkillCutIn ShowNPCSkillCutIn) { builder.AddInt(41, (int)ShowNPCSkillCutIn, 0); }
