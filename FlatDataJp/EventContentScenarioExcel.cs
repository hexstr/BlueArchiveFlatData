...
public struct EventContentScenarioExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.EventContentScenarioConditionType ScenarioConditionType { get { int o = __p.__offset(22); return o != 0 ? (FlatDataJp.EventContentScenarioConditionType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.EventContentScenarioConditionType.None; } }
  ...
  public FlatDataJp.ParcelType CostParcelType { get { int o = __p.__offset(36); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ParcelType.None; } }
  ...
  public static void AddScenarioConditionType(FlatBufferBuilder builder, FlatDataJp.EventContentScenarioConditionType ScenarioConditionType) { builder.AddInt(9, (int)ScenarioConditionType, 0); }
  ...
  public static void AddCostParcelType(FlatBufferBuilder builder, FlatDataJp.ParcelType CostParcelType) { builder.AddInt(16, (int)CostParcelType, 0); }
