...
public struct EventContentScenarioExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.EventContentScenarioConditionType ScenarioConditionType { get { int o = __p.__offset(20); return o != 0 ? (FlatDataJp.EventContentScenarioConditionType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.EventContentScenarioConditionType.None; } }
  ...
  public FlatDataJp.ParcelType CostParcelType { get { int o = __p.__offset(34); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ParcelType.None; } }
  ...
  public static Offset<FlatDataJp.EventContentScenarioExcel> CreateEventContentScenarioExcel(FlatBufferBuilder builder,
      long Id = 0,
      ...
      FlatDataJp.EventContentScenarioConditionType ScenarioConditionType = FlatDataJp.EventContentScenarioConditionType.None,
      ...
      FlatDataJp.ParcelType CostParcelType = FlatDataJp.ParcelType.None,
      long CostId = 0,
      int CostAmount = 0,
  ...
  public static void AddScenarioConditionType(FlatBufferBuilder builder, FlatDataJp.EventContentScenarioConditionType ScenarioConditionType) { builder.AddInt(8, (int)ScenarioConditionType, 0); }
  ...
  public static void AddCostParcelType(FlatBufferBuilder builder, FlatDataJp.ParcelType CostParcelType) { builder.AddInt(15, (int)CostParcelType, 0); }
  ...
  public static Offset<FlatDataJp.EventContentScenarioExcel> EndEventContentScenarioExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.EventContentScenarioExcel>(o);
  }
}
