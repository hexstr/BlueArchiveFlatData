...
public struct ShopCashExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.ProductCategory CategoryType { get { int o = __p.__offset(16); return o != 0 ? (FlatDataJp.ProductCategory)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ProductCategory.None; } }
  public FlatDataJp.ProductDisplayTag DisplayTag { get { int o = __p.__offset(18); return o != 0 ? (FlatDataJp.ProductDisplayTag)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ProductDisplayTag.None; } }
  ...
  public static void StartShopCashExcel(FlatBufferBuilder builder) { builder.StartTable(16); }
  ...
  public static void AddCategoryType(FlatBufferBuilder builder, FlatDataJp.ProductCategory CategoryType) { builder.AddInt(6, (int)CategoryType, 0); }
  public static void AddDisplayTag(FlatBufferBuilder builder, FlatDataJp.ProductDisplayTag DisplayTag) { builder.AddInt(7, (int)DisplayTag, 0); }
