...
public struct WorldRaidFavorBuffExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.WorldRaidFavorBuffExcel> CreateWorldRaidFavorBuffExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataJp.WorldRaidFavorBuffExcel> EndWorldRaidFavorBuffExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.WorldRaidFavorBuffExcel>(o);
  }
}
