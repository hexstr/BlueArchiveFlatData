...
public struct ConstMinigameTBGExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ConstMinigameTBGExcel> CreateConstMinigameTBGExcel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatDataJp.ConstMinigameTBGExcel> EndConstMinigameTBGExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ConstMinigameTBGExcel>(o);
  }
}
