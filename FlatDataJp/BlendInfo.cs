...
public struct BlendInfo : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.BlendInfo> CreateBlendInfo(FlatBufferBuilder builder,
      int From = 0,
      int To = 0,
      float Blend = 0.0f) {
  ...
  public static Offset<FlatDataJp.BlendInfo> EndBlendInfo(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.BlendInfo>(o);
  }
}
