...
public struct PresetCharacterGroupExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.PotentialStatBonusRateType PotentialType01 { get { int o = __p.__offset(58); return o != 0 ? (FlatDataJp.PotentialStatBonusRateType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.PotentialStatBonusRateType.None; } }
  public int PotentialLevel01 { get { int o = __p.__offset(60); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public FlatDataJp.PotentialStatBonusRateType PotentialType02 { get { int o = __p.__offset(62); return o != 0 ? (FlatDataJp.PotentialStatBonusRateType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.PotentialStatBonusRateType.None; } }
  public int PotentialLevel02 { get { int o = __p.__offset(64); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public FlatDataJp.PotentialStatBonusRateType PotentialType03 { get { int o = __p.__offset(66); return o != 0 ? (FlatDataJp.PotentialStatBonusRateType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.PotentialStatBonusRateType.None; } }
  public int PotentialLevel03 { get { int o = __p.__offset(68); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }

  public static Offset<FlatDataJp.PresetCharacterGroupExcel> CreatePresetCharacterGroupExcel(FlatBufferBuilder builder,
      ...
      FlatDataJp.PotentialStatBonusRateType PotentialType01 = FlatDataJp.PotentialStatBonusRateType.None,
      int PotentialLevel01 = 0,
      FlatDataJp.PotentialStatBonusRateType PotentialType02 = FlatDataJp.PotentialStatBonusRateType.None,
      int PotentialLevel02 = 0,
      FlatDataJp.PotentialStatBonusRateType PotentialType03 = FlatDataJp.PotentialStatBonusRateType.None,
  ...
  public static void AddPotentialType01(FlatBufferBuilder builder, FlatDataJp.PotentialStatBonusRateType PotentialType01) { builder.AddInt(27, (int)PotentialType01, 0); }
  ...
  public static void AddPotentialType02(FlatBufferBuilder builder, FlatDataJp.PotentialStatBonusRateType PotentialType02) { builder.AddInt(29, (int)PotentialType02, 0); }
  ...
  public static void AddPotentialType03(FlatBufferBuilder builder, FlatDataJp.PotentialStatBonusRateType PotentialType03) { builder.AddInt(31, (int)PotentialType03, 0); }
  ...
  public static Offset<FlatDataJp.PresetCharacterGroupExcel> EndPresetCharacterGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.PresetCharacterGroupExcel>(o);
  }
}
