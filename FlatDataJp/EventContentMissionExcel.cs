...
public struct EventContentMissionExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.MissionCompleteConditionType CompleteConditionType { get { int o = __p.__offset(36); return o != 0 ? (FlatDataJp.MissionCompleteConditionType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.MissionCompleteConditionType.None; } }
  ...
  public FlatDataJp.Tag CompleteConditionParameterTag(int j) { int o = __p.__offset(44); return o != 0 ? (FlatDataJp.Tag)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.Tag)0; }
  public int CompleteConditionParameterTagLength { get { int o = __p.__offset(44); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.Tag> GetCompleteConditionParameterTagBytes() { return __p.__vector_as_span<FlatDataJp.Tag>(44, 4); }
#else
  public ArraySegment<byte>? GetCompleteConditionParameterTagBytes() { return __p.__vector_as_arraysegment(44); }
#endif
  public FlatDataJp.Tag[] GetCompleteConditionParameterTagArray() { int o = __p.__offset(44); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.Tag[] a = new FlatDataJp.Tag[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.Tag)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public FlatDataJp.ParcelType MissionRewardParcelType(int j) { int o = __p.__offset(52); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.ParcelType)0; }
  public int MissionRewardParcelTypeLength { get { int o = __p.__offset(52); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.ParcelType> GetMissionRewardParcelTypeBytes() { return __p.__vector_as_span<FlatDataJp.ParcelType>(52, 4); }
#else
  public ArraySegment<byte>? GetMissionRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(52); }
#endif
  public FlatDataJp.ParcelType[] GetMissionRewardParcelTypeArray() { int o = __p.__offset(52); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.ParcelType[] a = new FlatDataJp.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public FlatDataJp.ParcelType ConditionRewardParcelType(int j) { int o = __p.__offset(58); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (FlatDataJp.ParcelType)0; }
  public int ConditionRewardParcelTypeLength { get { int o = __p.__offset(58); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatDataJp.ParcelType> GetConditionRewardParcelTypeBytes() { return __p.__vector_as_span<FlatDataJp.ParcelType>(58, 4); }
#else
  public ArraySegment<byte>? GetConditionRewardParcelTypeBytes() { return __p.__vector_as_arraysegment(58); }
#endif
  public FlatDataJp.ParcelType[] GetConditionRewardParcelTypeArray() { int o = __p.__offset(58); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatDataJp.ParcelType[] a = new FlatDataJp.ParcelType[l]; for (int i = 0; i < l; i++) { a[i] = (FlatDataJp.ParcelType)__p.bb.GetInt(p + i * 4); } return a; }
  ...
  public static Offset<FlatDataJp.EventContentMissionExcel> CreateEventContentMissionExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static void AddCompleteConditionType(FlatBufferBuilder builder, FlatDataJp.MissionCompleteConditionType CompleteConditionType) { builder.AddInt(16, (int)CompleteConditionType, 0); }
  ...
  public static VectorOffset CreateConditionRewardParcelTypeVector(FlatBufferBuilder builder, FlatDataJp.ParcelType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateConditionRewardParcelTypeVectorBlock(FlatBufferBuilder builder, FlatDataJp.ParcelType[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConditionRewardParcelTypeVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatDataJp.ParcelType> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateConditionRewardParcelTypeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatDataJp.ParcelType>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FlatDataJp.EventContentMissionExcel> EndEventContentMissionExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.EventContentMissionExcel>(o);
  }
}
