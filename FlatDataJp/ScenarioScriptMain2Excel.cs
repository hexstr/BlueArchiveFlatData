...
public struct ScenarioScriptMain2Excel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ScenarioScriptMain2Excel> CreateScenarioScriptMain2Excel(FlatBufferBuilder builder,
      long GroupId = 0,
  ...
  public static void StartScenarioScriptMain2Excel(FlatBufferBuilder builder) { builder.StartTable(11); }
  ...
  public static Offset<FlatDataJp.ScenarioScriptMain2Excel> EndScenarioScriptMain2Excel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ScenarioScriptMain2Excel>(o);
  }
}
