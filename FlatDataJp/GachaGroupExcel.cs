...
public struct GachaGroupExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.GachaGroupType GroupType { get { int o = __p.__offset(10); return o != 0 ? (FlatDataJp.GachaGroupType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.GachaGroupType.None; } }

  public static Offset<FlatDataJp.GachaGroupExcel> CreateGachaGroupExcel(FlatBufferBuilder builder,
      long ID = 0,
      StringOffset NameKrOffset = default(StringOffset),
      bool IsRecursive = false,
      FlatDataJp.GachaGroupType GroupType = FlatDataJp.GachaGroupType.None) {
  ...
  public static void AddGroupType(FlatBufferBuilder builder, FlatDataJp.GachaGroupType GroupType) { builder.AddInt(3, (int)GroupType, 0); }
  public static Offset<FlatDataJp.GachaGroupExcel> EndGachaGroupExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.GachaGroupExcel>(o);
  }
}
