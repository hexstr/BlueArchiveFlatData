...
public struct VoiceCommonExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.VoiceEvent VoiceEvent { get { int o = __p.__offset(4); return o != 0 ? (FlatDataJp.VoiceEvent)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.VoiceEvent.OnTSA; } }
  ...
  public static Offset<FlatDataJp.VoiceCommonExcel> CreateVoiceCommonExcel(FlatBufferBuilder builder,
      FlatDataJp.VoiceEvent voiceEvent = FlatDataJp.VoiceEvent.OnTSA,
      long Rate = 0,
  ...
  public static void AddVoiceEvent(FlatBufferBuilder builder, FlatDataJp.VoiceEvent voiceEvent) { builder.AddInt(0, (int)voiceEvent, 0); }
  ...
  public static Offset<FlatDataJp.VoiceCommonExcel> EndVoiceCommonExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.VoiceCommonExcel>(o);
  }
}
