...
public struct ObstacleStatExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.ObstacleStatExcel> CreateObstacleStatExcel(FlatBufferBuilder builder,
      uint StringID = 0,
  ...
  public static Offset<FlatDataJp.ObstacleStatExcel> EndObstacleStatExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.ObstacleStatExcel>(o);
  }
}
