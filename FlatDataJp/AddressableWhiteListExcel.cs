...
public struct AddressableWhiteListExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.AddressableWhiteListExcel> CreateAddressableWhiteListExcel(FlatBufferBuilder builder,
      long Id = 0,
  ...
  public static Offset<FlatDataJp.AddressableWhiteListExcel> EndAddressableWhiteListExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.AddressableWhiteListExcel>(o);
  }
}
