...
public struct CampaignStrategyObjectExcel : IFlatbufferObject
{
  ...
  public static Offset<FlatDataJp.CampaignStrategyObjectExcel> CreateCampaignStrategyObjectExcel(FlatBufferBuilder builder,
      long Id = 0,
      uint Key = 0,
  ...
  public static Offset<FlatDataJp.CampaignStrategyObjectExcel> EndCampaignStrategyObjectExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.CampaignStrategyObjectExcel>(o);
  }
}
