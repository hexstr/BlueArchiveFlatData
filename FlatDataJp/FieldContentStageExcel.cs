...
public struct FieldContentStageExcel : IFlatbufferObject
{
  ...
  public FlatDataJp.StageDifficulty StageDifficulty { get { int o = __p.__offset(12); return o != 0 ? (FlatDataJp.StageDifficulty)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.StageDifficulty.None; } }
  ...
  public FlatDataJp.ParcelType StageEnterCostType { get { int o = __p.__offset(18); return o != 0 ? (FlatDataJp.ParcelType)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.ParcelType.None; } }
  ...
  public FlatDataJp.StageTopography StageTopography { get { int o = __p.__offset(24); return o != 0 ? (FlatDataJp.StageTopography)__p.bb.GetInt(o + __p.bb_pos) : FlatDataJp.StageTopography.Street; } }
  ...
  public static Offset<FlatDataJp.FieldContentStageExcel> CreateFieldContentStageExcel(FlatBufferBuilder builder,
      long Id = 0,
      long SeasonId = 0,
      long AreaId = 0,
      long GroupId = 0,
  ...
  public static void AddStageDifficulty(FlatBufferBuilder builder, FlatDataJp.StageDifficulty stageDifficulty) { builder.AddInt(4, (int)stageDifficulty, 0); }
  ...
  public static void AddStageEnterCostType(FlatBufferBuilder builder, FlatDataJp.ParcelType StageEnterCostType) { builder.AddInt(7, (int)StageEnterCostType, 0); }
  ...
  public static void AddStageTopography(FlatBufferBuilder builder, FlatDataJp.StageTopography stageTopography) { builder.AddInt(10, (int)stageTopography, 0); }
  ...
  public static Offset<FlatDataJp.FieldContentStageExcel> EndFieldContentStageExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatDataJp.FieldContentStageExcel>(o);
  }
}
